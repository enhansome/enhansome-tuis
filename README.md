...
There's a lot of cool projects here that I have no association with. Run them at your own risk. If you have a cool tool you'd like to share please [open a PR](https://github.com/rothgar/awesome-tuis/pulls) ⭐ 20,393 | 🐛 96 | 📅 2026-08-11.
...
* [btop++](https://github.com/aristocratos/btop) ⭐ 34,302 | 🐛 528 | 🌐 C++ | 📅 2026-08-29 Resource monitor with extras
* [Glances](https://github.com/nicolargo/glances) ⭐ 33,475 | 🐛 100 | 🌐 Python | 📅 2026-08-29 Glances an Eye on your system. A top/htop alternative.
* [Goaccess](https://github.com/allinurl/goaccess) ⭐ 20,880 | 🐛 459 | 🌐 C | 📅 2026-08-20 GoAccess is a real-time web log analyzer and interactive viewer that runs in a terminal in nix systems or through your browser.
* [WTF](https://github.com/senorprogrammer/wtf) ⭐ 17,066 | 🐛 102 | 🌐 Go | 📅 2026-08-05 The personal information dashboard for your terminal.
* [bottom](https://github.com/ClementTsang/bottom) ⭐ 13,948 | 🐛 108 | 🌐 Rust | 📅 2026-08-29 A customizable graphical process/system monitor for the terminal.
* [TermUI](https://github.com/gizak/termui) ⭐ 13,583 | 🐛 106 | 🌐 Go | 📅 2025-07-10 Golang terminal dashboard
* [gping](https://github.com/orf/gping) ⭐ 12,658 | 🐛 52 | 🌐 Rust | 📅 2026-08-24 Ping, but with a graph
* [gh-dash](https://github.com/dlvhdr/gh-dash) ⭐ 12,437 | 🐛 98 | 🌐 Go | 📅 2026-08-01 A rich terminal UI for GitHub PRs and Issues
...
* [talos linux](https://github.com/siderolabs/talos) ⭐ 11,048 | 🐛 227 | 🌐 Go | 📅 2026-08-28 A Linux distro with a TUI dashboard for local and remote usage
...
* [htop](https://github.com/htop-dev/htop) ⭐ 8,290 | 🐛 353 | 🌐 C | 📅 2026-08-26 Interactive text-mode process viewer for Unix systems. It aims to be a better 'top'
* [trippy](https://github.com/fujiapple852/trippy) ⭐ 7,564 | 🐛 78 | 🌐 Rust | 📅 2026-08-27 A network diagnostic tool that includes functionality like mtr and more
* [Backlog.md](https://github.com/MrLesk/Backlog.md) ⭐ 6,569 | 🐛 46 | 🌐 TypeScript | 📅 2026-08-29 A tool for managing project collaboration between humans and AI Agents in a git ecosystem
* [ticker](https://github.com/achannarasappa/ticker) ⭐ 6,222 | 🐛 33 | 🌐 Go | 📅 2026-06-28 Track stocks, crypto, and derivatives prices and positions in real time from your terminal
* [s-tui](https://github.com/amanusk/s-tui) ⭐ 5,076 | 🐛 41 | 🌐 Python | 📅 2026-08-27 CPU stress and monitoring utility
* [Kyanos](https://github.com/hengyoush/kyanos) ⭐ 5,069 | 🐛 32 | 🌐 C | 📅 2026-08-27 Linux network analysis tool based on eBPF
* [rustnet](https://github.com/domcyrus/rustnet) ⭐ 4,969 | 🐛 16 | 🌐 Rust | 📅 2026-08-29 A cross-platform network monitoring tool with deep packet inspection
* [binsider](https://github.com/orhun/binsider) ⭐ 4,410 | 🐛 38 | 🌐 Rust | 📅 2026-08-23 A TUI for analyzing Linux binaries.
...
* [psmux](https://github.com/marlocarlo/psmux) ⭐ 3,382 | 🐛 29 | 🌐 PowerShell | 📅 2026-08-29 tmux-compatible terminal multiplexer for Windows built in Rust with ratatui.
...
* [zenith](https://github.com/bvaisvil/zenith) ⭐ 3,045 | 🐛 40 | 🌐 Rust | 📅 2026-08-25 In terminal graphical metrics for your \*nix system written in Rust
* [kmon](https://github.com/orhun/kmon) ⭐ 2,940 | 🐛 23 | 🌐 Rust | 📅 2026-07-31 Linux Kernel Manager and Activity Monitor
* [gonzo](https://github.com/control-theory/gonzo) ⭐ 2,757 | 🐛 18 | 🌐 Go | 📅 2026-07-15 A powerful, real-time log analysis terminal UI inspired by k9s.
* [process-compose](https://github.com/F1bonacc1/process-compose) ⭐ 2,731 | 🐛 16 | 🌐 Go | 📅 2026-08-29 TUI for running apps and processes
* [oryx](https://github.com/pythops/oryx) ⭐ 2,573 | 🐛 5 | 🌐 Rust | 📅 2026-08-28 A TUI for sniffing network traffic using eBPF
...
* [macmon](https://github.com/vladkens/macmon) ⭐ 1,850 | 🐛 14 | 🌐 Rust | 📅 2026-08-04 Sudoless performance monitoring for Apple Silicon processors written in Rust
* [cgdb](https://github.com/cgdb/cgdb) ⭐ 1,841 | 🐛 45 | 🌐 C | 📅 2026-02-27 Console front-end to the GNU debugger
* [netscanner](https://github.com/Chleba/netscanner) ⭐ 1,825 | 🐛 6 | 🌐 Rust | 📅 2026-07-06 Network scanner
...
* [nerdlog](https://github.com/dimonomid/nerdlog) ⭐ 1,550 | 🐛 16 | 🌐 Go | 📅 2025-06-22 fast, remote-first, multi-host TUI log viewer
...
* [atop](https://github.com/Atoptool/atop/) ⭐ 1,057 | 🐛 62 | 🌐 C | 📅 2026-08-15 root level system and process monitor for Linux
...
* [framework-tool-tui](https://github.com/grouzen/framework-tool-tui) ⭐ 351 | 🐛 9 | 🌐 Rust | 📅 2026-08-29 TUI for controlling and monitoring Framework Computers hardware built in Rust
...
* [claws](https://github.com/clawscli/claws) ⭐ 153 | 🐛 6 | 🌐 Go | 📅 2026-07-25 A terminal UI for AWS resource management with vim-style keybindings, command-mode navigation, and optional read-only mode.
...
* [opencode](https://github.com/sst/opencode) ⭐ 202,370 | 🐛 5,670 | 🌐 TypeScript | 📅 2026-08-29 AI coding agent, built for the terminal
* [codex](https://github.com/openai/codex) ⭐ 119,789 | 🐛 14,389 | 🌐 Rust | 📅 2026-08-29 Lightweight coding agent that runs in your terminal
* [lazygit](https://github.com/jesseduffield/lazygit) ⭐ 81,760 | 🐛 1,024 | 🌐 Go | 📅 2026-08-29 Simple terminal UI for git commands
* [delta](https://github.com/dandavison/delta) ⭐ 31,963 | 🐛 431 | 🌐 Rust | 📅 2026-08-02 A syntax-highlighting pager for git, diff, and grep output
* [crush](https://github.com/charmbracelet/crush) ⭐ 27,786 | 🐛 673 | 🌐 Go | 📅 2026-08-29 The glamourous AI coding agent
* [gitui](https://github.com/extrawurst/gitui) ⭐ 22,446 | 🐛 343 | 🌐 Rust | 📅 2026-08-04 blazing fast terminal-ui for git written in rust
...
* [posting](https://github.com/darrenburns/posting) ⭐ 12,331 | 🐛 83 | 🌐 Python | 📅 2026-03-25 A powerful HTTP client that lives in your terminal
* [Claude Code Usage Monitor](https://github.com/Maciek-roboblog/Claude-Code-Usage-Monitor) ⭐ 8,661 | 🐛 37 | 🌐 Python | 📅 2026-07-05 Monitor Claude token usage
...
* [rainfrog](https://github.com/achristmascarl/rainfrog) ⭐ 5,303 | 🐛 14 | 🌐 Rust | 📅 2026-08-25 A database management TUI for Postgres, MySQL, and SQLite written in Rust
* [sqlit](https://github.com/Maxteabag/sqlit) ⭐ 4,747 | 🐛 14 | 🌐 Python | 📅 2026-08-27 A lightweight TUI for SQL databases inspired by lazygit
* [lazysql](https://github.com/jorgerojas26/lazysql) ⭐ 4,244 | 🐛 48 | 🌐 Go | 📅 2026-08-22 A cross-platform TUI database management tool written in Go.
...
* [Claude Code Bridge](https://github.com/bfly123/claude_code_bridge) ⭐ 3,464 | 🐛 100 | 🌐 Python | 📅 2026-08-27 Real-time multi-AI collaboration between Claude, Codex and Gemini in terminal
* [Toad](https://github.com/batrachianai/toad) ⭐ 3,409 | 🐛 6 | 🌐 Python | 📅 2026-05-26 A unified interface for AI
...
* [runme](https://github.com/stateful/runme) ⭐ 2,157 | 🐛 152 | 🌐 Go | 📅 2026-08-23 Discover and run code snippets directly from your README.md or other markdowns
* [serie](https://github.com/lusingander/serie) ⭐ 2,064 | 🐛 23 | 🌐 Rust | 📅 2026-08-21 A rich git commit graph
* [resterm](https://github.com/unkn0wn-root/resterm) ⭐ 1,883 | 🐛 0 | 🌐 Go | 📅 2026-08-29 A terminal client for HTTP/GraphQL/gRPC with support for WebSockets, SSE, workflows, profiling, OpenAPI and response diffs.
* [termdbms](https://github.com/mathaou/termdbms) ⭐ 1,820 | 🐛 6 | 🌐 Go | 📅 2022-06-11 A TUI for viewing and editing database files.
* [lazyjournal](https://github.com/Lifailon/lazyjournal) ⭐ 1,392 | 🐛 8 | 🌐 Go | 📅 2026-08-01 TUI for journalctl, file system logs, as well Docker and Podman containers for quick viewing and filtering
...
* [VT Code](https://github.com/vinhnx/vtcode) ⭐ 826 | 🐛 1 | 🌐 Rust | 📅 2026-08-29 VT Code - Semantic Coding Agent
...
* [models](https://github.com/arimxyer/models) ⭐ 502 | 🐛 0 | 🌐 Rust | 📅 2026-08-29 TUI for browsing AI models and coding agents
* [Froggit](https://github.com/thewizardshell/froggit) ⭐ 482 | 🐛 3 | 🌐 Go | 📅 2026-03-20 Minimalist Git TUI with GitHub CLI integration
* [Feluda](https://github.com/anistark/feluda) ⭐ 469 | 🐛 11 | 🌐 Rust | 📅 2026-08-29 Detect restrictive and incompatible licesenses in all dependencies of your project.
...
* [sabiql](https://github.com/riii111/sabiql) ⭐ 259 | 🐛 7 | 🌐 Rust | 📅 2026-08-29 A fast, driver-less TUI to browse, query, and edit PostgreSQL databases, written in Rust
...
* [Twig](https://github.com/workdone0/twig) ⭐ 174 | 🐛 6 | 🌐 Rust | 📅 2026-08-29 Terminal UI for interactively exploring JSON and YAML files.
...
* [qrypad](https://github.com/wheelibin/qrypad) ⭐ 42 | 🐛 0 | 🌐 Go | 📅 2026-07-23 A terminal SQL client for Postgres, MySQL and SQLite.
...
* [lazydocker](https://github.com/jesseduffield/lazydocker) ⭐ 52,652 | 🐛 297 | 🌐 Go | 📅 2026-04-19 The lazier way to manage everything docker
* [k9s](https://github.com/derailed/k9s) ⭐ 34,461 | 🐛 94 | 🌐 Go | 📅 2026-08-29 TUI for managing a Kubernetes cluster
...
* [kftui](https://github.com/hcavarsan/kftray) ⭐ 1,556 | 🐛 19 | 🌐 Rust | 📅 2026-08-29 A TUI to manage multiple kubectl port-forward commands, with support for UDP and K8s proxy.
* [dtop](https://github.com/amir20/dtop) ⭐ 1,360 | 🐛 1 | 🌐 Rust | 📅 2026-08-29 Terminal dashboard for Docker monitoring across multiple hosts
...
* [ducker](https://github.com/robertpsoane/ducker) ⭐ 920 | 🐛 15 | 🌐 Rust | 📅 2026-08-03 A slightly quackers Docker TUI based on k9s
...
* [micro](https://github.com/zyedidia/micro) ⭐ 29,464 | 🐛 986 | 🌐 Go | 📅 2026-08-29 A modern and intuitive terminal-based text editor
* [Edit](https://github.com/microsoft/edit) ⭐ 14,512 | 🐛 172 | 🌐 Rust | 📅 2026-08-27 A simple text editor. Pays homage to the classic MS-DOS Editor.
* [kilo](https://github.com/antirez/kilo) ⭐ 9,095 | 🐛 63 | 🌐 C | 📅 2025-01-04 A minimal but complete editor in \~1000 lines of C code.
* [Fresh](https://github.com/sinelaw/fresh) ⭐ 8,573 | 🐛 308 | 🌐 Rust | 📅 2026-08-29 An easy-to-use, powerful and fast terminal-based text editor.
* [slap](https://github.com/slap-editor/slap) ⭐ 6,188 | 🐛 115 | 🌐 JavaScript | 📅 2021-11-01 Sublime-like terminal-based text editor
* [vis](https://github.com/martanne/vis) ⭐ 4,703 | 🐛 149 | 🌐 C | 📅 2026-08-20 A vi-like editor based on Plan 9's structural regular expressions
...
* [flow-control](https://github.com/neurocyte/flow) ⭐ 2,197 | 🐛 77 | 🌐 Zig | 📅 2026-08-29 A lightning-fast, feature-rich text editor written in Zig
* [Durdraw](https://github.com/cmang/durdraw) ⭐ 1,804 | 🐛 4 | 🌐 Python | 📅 2026-08-26 An ASCII, Unicode and ANSI art editor
* [zee](https://github.com/zee-editor/zee) ⭐ 1,801 | 🐛 44 | 🌐 Rust | 📅 2025-02-06 A modern text editor for the terminal written in Rust
* [orbiton](https://github.com/xyproto/orbiton) ⭐ 697 | 🐛 1 | 🌐 Go | 📅 2026-08-29 Text editor limited by VT100, suitable for programming, writing git commit messages and editing Markdown
* [treemd](https://github.com/Epistates/treemd) ⭐ 683 | 🐛 2 | 🌐 Rust | 📅 2026-08-27 A markdown navigator with tree-based structural navigation
...
* [yazi](https://github.com/sxyazi/yazi) ⭐ 41,789 | 🐛 72 | 🌐 Rust | 📅 2026-08-26 Blazing fast terminal file manager written in Rust, based on async I/O.
* [superfile](https://github.com/MHNightCat/superfile) ⭐ 22,963 | 🐛 261 | 🌐 Go | 📅 2026-08-28 Pretty fancy and modern terminal file manager.
* [nnn](https://github.com/jarun/nnn) ⭐ 21,845 | 🐛 4 | 🌐 C | 📅 2026-08-29 n³ The unorthodox terminal file manager.
* [ranger](https://github.com/ranger/ranger) ⭐ 17,376 | 🐛 899 | 🌐 Python | 📅 2026-08-15 A VIM-inspired file manager for the console.
* [broot](https://github.com/Canop/broot) ⭐ 12,924 | 🐛 231 | 🌐 Rust | 📅 2026-08-29 A new way to see and navigate directory trees
* [lf](https://github.com/gokcehan/lf) ⭐ 9,485 | 🐛 81 | 🌐 Go | 📅 2026-08-25 A terminal file manager written in Go with heavy inspiration from ranger file manager.
...
* [far2l](https://github.com/elfmz/far2l) ⭐ 2,210 | 🐛 468 | 🌐 C++ | 📅 2026-08-29 Linux port of Far v2 file manager
* [mc](https://github.com/MidnightCommander/mc) ⭐ 961 | 🐛 689 | 🌐 C | 📅 2026-08-16 GNU Midnight Commander. A free cross-platform orthodox file manager.
...
* [rovr](https://github.com/NSPC911/rovr) ⭐ 406 | 🐛 8 | 🌐 Python | 📅 2026-08-29 A post-modern terminal file manager.
...
* [ytreenova](https://github.com/robkam/ytreenova) ⭐ 14 | 🐛 2 | 🌐 C | 📅 2026-08-29 The XTree™ style file manager Unix should have had all along.
...
* [NetHack](https://github.com/NetHack/NetHack) ⭐ 3,885 | 🐛 141 | 🌐 C | 📅 2026-08-28 Dungeon exploration game
...
* [BrogueCE](https://github.com/tmewett/BrogueCE) ⭐ 1,450 | 🐛 214 | 🌐 C | 📅 2026-08-05 Beautiful roguelike dungeon crawler
...
* [tty-solitaire](https://github.com/mpereira/tty-solitaire) ⭐ 359 | 🐛 24 | 🌐 C | 📅 2025-05-03 Solitaire runs in your terminal!
...
* [textual](https://github.com/willmcgugan/textual) ⭐ 37,081 | 🐛 352 | 🌐 Python | 📅 2026-07-11 is a TUI (Text User Interface) framework for **Python** inspired by modern web development.
...
* [notcurses](https://github.com/dankamongmen/notcurses) ⭐ 4,681 | 🐛 328 | 🌐 C | 📅 2026-05-18 blingful character graphics/TUI library for **C** and **Python**. definitely not curses.
...
* [blessed](https://github.com/jquast/blessed) ⭐ 1,495 | 🐛 3 | 🌐 Python | 📅 2026-08-29 Blessed is an easy, practical library for making **Python** terminal apps
...
* [xnano](https://github.com/hsaeed3/xnano) ⭐ 16 | 🐛 6 | 🌐 Python | 📅 2026-08-26 A modern, lightweight and declarative **Python** TUI framework built on top of the Rust ratatui and tachyonfx libraries. ([docs](https://xnano.hammad.app))

<h3>GO</h3>

* [bubbletea](https://github.com/charmbracelet/bubbletea) ⭐ 44,677 | 🐛 206 | 🌐 Go | 📅 2026-08-19 A **Go** framework based on Elm to build functional and fun terminal apps
* [tview](https://github.com/rivo/tview/) ⭐ 14,066 | 🐛 95 | 🌐 Go | 📅 2026-08-11 Terminal UI library with rich, interactive widgets — written in **Go**
...
* [tcell](https://github.com/gdamore/tcell) ⭐ 5,216 | 🐛 11 | 🌐 Go | 📅 2026-08-24 Tcell is an alternate **Go** terminal package, similar in some ways to termbox, but better in others.
...
* [libuv](https://github.com/libuv/libuv) ⭐ 27,144 | 🐛 234 | 🌐 C | 📅 2026-08-20 Cross-platform asynchronous I/O library - written in **C**
...
* [FTXUI](https://github.com/ArthurSonzogni/FTXUI) ⭐ 10,611 | 🐛 99 | 🌐 C++ | 📅 2026-08-23 💻 **C++** Functional Terminal User Interface. ❤️
...
* [tvision](https://github.com/magiblot/tvision) ⭐ 3,140 | 🐛 41 | 🌐 C++ | 📅 2026-08-27 A modern port of **C++** Turbo Vision 2.0, cross-platform and Unicode support.
...
* [xtd](https://github.com/gammasoft71/xtd) ⭐ 1,160 | 🐛 98 | 🌐 C++ | 📅 2026-08-29 Free open-source modern **C++** framework to create console (CLI), forms (GUI like WinForms) and unit test (xUnit) applications and libraries on Windows, macOS, Linux, iOS, Android, FreeBSD, and Haiku.
* [ConsoleCraftEngine](https://github.com/ural89/ConsoleCraftEngine) ⭐ 97 | 🐛 2 | 🌐 C++ | 📅 2026-08-28 A terminal-based 2D game engine written in **C++**.
...
* [GGUI](https://github.com/Gabidal/GGUI) ⭐ 9 | 🐛 2 | 🌐 C++ | 📅 2026-08-29 **C++17** Structured Terminal User Interface. 🐧/🪟
...
* [casciian](https://github.com/crramirez/casciian) ⭐ 50 | 🐛 1 | 🌐 Java | 📅 2026-08-29 A Text User Interface Library for **Java** based on "Jexer" without the AWT/Swing dependencies, tailored for GraalVM AOT native compilation with a focus on performance over remote connections and maximum terminal compatibility.
...
* [Spectre.Console](https://github.com/spectreconsole/spectre.console) ⭐ 11,602 | 🐛 184 | 🌐 C# | 📅 2026-08-27 A **.NET** library for creating beautiful console applications
* [Terminal.Gui](https://github.com/gui-cs/Terminal.Gui) ⭐ 11,186 | 🐛 51 | 🌐 C# | 📅 2026-08-27 Cross-platform terminal UI toolkit for **.NET**
* [Consolonia](https://github.com/jinek/Consolonia) ⭐ 821 | 🐛 52 | 🌐 C# | 📅 2026-08-27 A **.NET** terminal-based GUI framework with support of XAML
* [SharpConsoleUI](https://github.com/nickprotop/ConsoleEx) ⭐ 267 | 🐛 1 | 🌐 C# | 📅 2026-08-25 Multi-window TUI framework for **.NET** with overlapping windows, compositor effects, and Spectre.Console integration
...
* [Ratatui](https://github.com/tui-rs-revival/ratatui) ⭐ 22,436 | 🐛 221 | 🌐 Rust | 📅 2026-08-27 A **Rust** crate for building Terminal UIs (actively maintained fork of tui-rs).
...
* [iocraft](https://github.com/ccbrown/iocraft) ⭐ 1,528 | 🐛 28 | 🌐 Rust | 📅 2026-08-20 **Rust** crate for beautiful, artisanally crafted TUIs and text-based IO, with a declarative, React-like API inspired by Ink.
...
* [ink](https://github.com/vadimdemedes/ink) ⭐ 39,758 | 🐛 32 | 🌐 TypeScript | 📅 2026-08-25 React for **Node.js** interactive command-line apps
* [gum](https://github.com/charmbracelet/gum) ⭐ 24,305 | 🐛 198 | 🌐 Go | 📅 2026-08-20 A tool for glamorous **shell** scripts
* [OpenTUI](https://github.com/sst/opentui) ⭐ 13,177 | 🐛 138 | 🌐 TypeScript | 📅 2026-08-29 A **TypeScript** library for building terminal user interfaces (TUIs)
...
* [discordo](https://github.com/ayntgl/discordo) ⭐ 5,746 | 🐛 56 | 🌐 Go | 📅 2026-08-29 A lightweight, secure, and feature-rich Discord terminal client
...
* [nomadnet](https://github.com/markqvist/NomadNet) ⭐ 2,462 | 🐛 0 | 🌐 Python | 📅 2026-05-28 Secure messaging network built on Reticulum
...
* [nchat](https://github.com/d99kris/nchat) ⭐ 1,930 | 🐛 15 | 🌐 C++ | 📅 2026-08-29 Telegram/WhatsApp client
* [gomuks](https://github.com/tulir/gomuks) ⭐ 1,720 | 🐛 73 | 🌐 Go | 📅 2026-08-29 Matrix client
* [gurk-rs](https://github.com/boxdot/gurk-rs) ⭐ 1,366 | 🐛 100 | 🌐 Rust | 📅 2026-07-29 Signal Messenger client for terminal
* [basalt](https://github.com/erikjuhani/basalt) ⭐ 1,324 | 🐛 44 | 🌐 Rust | 📅 2026-08-25 TUI Application to manage Obsidian vaults and notes directly from the terminal.
* [toot](https://github.com/ihabunek/toot) ⭐ 1,323 | 🐛 128 | 🌐 Python | 📅 2026-07-04 Mastodon CLI & TUI
* [concord](https://github.com/chojs23/concord) ⭐ 1,287 | 🐛 43 | 🌐 Rust | 📅 2026-08-27 A feature-rich TUI client for Discord
* [matterhorn](https://github.com/matterhorn-chat/matterhorn) ⭐ 1,152 | 🐛 22 | 🌐 Haskell | 📅 2026-08-25 A Mattermost terminal client.
* [matcha](https://github.com/floatpane/matcha) ⭐ 1,075 | 🐛 77 | 🌐 Go | 📅 2026-08-27 Email client
...
* [endcord](https://github.com/mzivic7/endcord) ⭐ 968 | 🐛 4 | 🌐 Python | 📅 2026-08-29 Feature rich Discord TUI client.
...
* [marchat](https://github.com/Cod-e-Codes/marchat) ⭐ 134 | 🐛 6 | 🌐 Go | 📅 2026-08-29 Self-hosted terminal chat with WebSocket client/server, optional shared-key encryption, and plugins.
...
* [fzf](https://github.com/junegunn/fzf) ⭐ 82,716 | 🐛 327 | 🌐 Go | 📅 2026-08-26 A general-purpose command-line fuzzy finder
* [wttr.in](https://github.com/chubin/wttr.in) ⭐ 30,444 | 🐛 330 | 🌐 Go | 📅 2026-08-02 The right way to check the weather
* [oha](https://github.com/hatoo/oha) ⭐ 10,517 | 🐛 57 | 🌐 Rust | 📅 2026-08-23 HTTP load generator
* [termshark](https://github.com/gcla/termshark) ⭐ 9,974 | 🐛 51 | 🌐 Go | 📅 2024-04-30 Terminal UI for tshark
* [mapscii](https://github.com/rastapasta/mapscii) ⭐ 9,230 | 🐛 52 | 🌐 JavaScript | 📅 2024-11-03 Braille & ASCII world map renderer for your console
* [wego](https://github.com/schachmat/wego) ⭐ 8,542 | 🐛 16 | 🌐 Go | 📅 2026-08-01 Weather app
* [term.everything](https://github.com/mmulet/term.everything) ⭐ 8,083 | 🐛 10 | 🌐 Go | 📅 2026-03-18 Run any GUI app in the terminal
* [cava](https://github.com/karlstav/cava) ⭐ 6,378 | 🐛 18 | 🌐 C | 📅 2026-08-18 Cross-platform Audio Visualizer
* [gdu](https://github.com/dundee/gdu) ⭐ 5,943 | 🐛 56 | 🌐 Go | 📅 2026-08-27 Fast disk usage analyzer with console interface written in Go
...
* [x-cmd](https://github.com/x-cmd/x-cmd) ⭐ 4,621 | 🐛 97 | 🌐 Awk | 📅 2026-08-29 A vast and interesting collection of tools that can then bootstrap lots of other programs / functions in a consistent and structured way.
* [csvlens](https://github.com/YS-L/csvlens) ⭐ 3,947 | 🐛 59 | 🌐 Rust | 📅 2026-07-04 TUI CSV file viewer. It is like less but made for CSV.
...
* [bluetui](https://github.com/pythops/bluetui) ⭐ 2,978 | 🐛 16 | 🌐 Rust | 📅 2026-08-28 A TUI for managing bluetooth devices.
* [gif-for-cli](https://github.com/google/gif-for-cli) ⚠️ Archived Convert a gif into ASCII
* [impala](https://github.com/pythops/impala) ⭐ 2,811 | 🐛 0 | 🌐 Rust | 📅 2026-08-27 TUI for managing wifi
* [tweakcc](https://github.com/Piebald-AI/tweakcc) ⭐ 2,469 | 🐛 54 | 🌐 TypeScript | 📅 2026-08-28 TUI to customize your Claude Code themes, thinking verbs, and more.
* [Caligula](https://github.com/ifd3f/caligula) ⭐ 2,268 | 🐛 52 | 🌐 Rust | 📅 2026-08-27 A user-friendly, lightweight TUI for imaging disks.
...
* [gpg-tui](https://github.com/orhun/gpg-tui) ⭐ 1,755 | 🐛 14 | 🌐 Rust | 📅 2026-08-26 A terminal user interface for GnuPG
...
* [arttime](https://github.com/reportaman/arttime) ⭐ 1,381 | 🐛 6 | 🌐 Shell | 📅 2026-08-18 An app that brings beauty of text-art together with functionality of clock, timer, and pattern-based time manager.
...
* [vortix](https://github.com/Harry-kp/vortix) ⭐ 643 | 🐛 31 | 🌐 Rust | 📅 2026-08-29 Terminal UI for WireGuard and OpenVPN with real-time telemetry, leak detection, and kill switch.
...
* [vlc](https://github.com/videolan/vlc) ⭐ 19,476 | 🐛 2 | 🌐 C | 📅 2026-08-29 VLC includes an ncurses interface, `vlc --intf ncurses`
...
* [spotify-player](https://github.com/aome510/spotify-player) ⭐ 7,149 | 🐛 173 | 🌐 Rust | 📅 2026-07-20 A Spotify player in the terminal with full feature parity
...
* [kew](https://github.com/ravachol/kew) ⭐ 2,999 | 🐛 3 | 🌐 C | 📅 2026-08-29 A terminal music player for Linux
...
* [tdf](https://github.com/itsjunetime/tdf) ⭐ 1,950 | 🐛 41 | 🌐 Rust | 📅 2026-08-16 A tui-based PDF viewer
...
* [spotatui](https://github.com/LargeModGames/spotatui) ⭐ 1,275 | 🐛 36 | 🌐 Rust | 📅 2026-08-29 Spotify client with native streaming, synced lyrics, and real-time audio visualization
* [textual-paint](https://github.com/1j01/textual-paint) ⭐ 1,122 | 🐛 10 | 🌐 Python | 📅 2026-02-21 MS Paint in your terminal
* [bookokrat](https://github.com/bugzmanov/bookokrat) ⭐ 1,106 | 🐛 47 | 📅 2026-08-28 Full-featured EPUB books reader with Vim keybindings.
...
* [wiremix](https://github.com/tsowell/wiremix) ⭐ 1,040 | 🐛 38 | 🌐 Rust | 📅 2026-07-12 TUI audio mixer for PipeWire similar to pavucontrol to adjust volumes, change input/output devices and their profiles
* [manga-tui](https://github.com/josueBarretogit/manga-tui) ⭐ 926 | 🐛 23 | 🌐 Rust | 📅 2026-07-13 Terminal-based manga reader and downloader with image rendering support
...
* [xytz](https://github.com/xdagiz/xytz) ⭐ 614 | 🐛 9 | 🌐 Go | 📅 2026-08-29 Beautiful TUI for downloading YouTube videos/playlists/channels.
* [jellyfin-tui](https://github.com/dhonus/jellyfin-tui) ⭐ 582 | 🐛 28 | 🌐 Rust | 📅 2026-08-29 Jellyfin client
...
* [mpvc](https://github.com/gmt4/mpvc) ⭐ 158 | 🐛 1 | 🌐 Shell | 📅 2026-08-29 A mpc-like control interface for mpv
...
* [tmux](https://github.com/tmux/tmux) ⭐ 48,901 | 🐛 38 | 🌐 C | 📅 2026-08-28 Terminal multiplexer
* [zellij](https://github.com/zellij-org/zellij) ⭐ 35,175 | 🐛 1,876 | 🌐 Rust | 📅 2026-08-28 A terminal workspace with batteries included
* [Glow](https://github.com/charmbracelet/glow) ⭐ 27,116 | 🐛 225 | 🌐 Go | 📅 2026-08-16 A markdown reader, designed from the ground up to showcase the elegance and capabilities of TUI.
* [slides](https://github.com/maaslalani/slides) ⭐ 11,639 | 🐛 77 | 🌐 Go | 📅 2026-07-08 A terminal based presentation tool, supporting markdown syntax.
...
* [presenterm](https://github.com/mfontanini/presenterm) ⭐ 8,804 | 🐛 76 | 🌐 Rust | 📅 2026-05-22 A markdown terminal slideshow tool
...
* [television](https://github.com/alexpasmantier/television) ⭐ 6,221 | 🐛 83 | 🌐 Rust | 📅 2026-08-16 A fast and versatile fuzzy finder TUI
...
* [hledger-ui](https://github.com/simonmichael/hledger) ⭐ 4,677 | 🐛 345 | 🌐 Haskell | 📅 2026-08-27 A fast TUI for browsing double entry bookkeeping data
...
* [termscp](https://github.com/veeso/termscp) ⭐ 3,061 | 🐛 8 | 🌐 Rust | 📅 2026-08-29 A TUI file transfer and explorer, with support for SCP/SFTP/FTP/S3.
* [khal](https://github.com/pimutils/khal) ⭐ 3,045 | 🐛 260 | 🌐 Python | 📅 2026-08-28 A standards based CLI calendar program, able to synchronize with CalDAV servers
* [Bagels](https://github.com/EnhancedJax/Bagels) ⭐ 2,889 | 🐛 18 | 🌐 Python | 📅 2025-07-06 TUI expense tracker
...
* [calcure](https://github.com/anufrievroman/calcure) ⭐ 2,345 | 🐛 6 | 🌐 Python | 📅 2026-08-29 Modern TUI calendar and task manager with minimal and customizable UI.
...
* [sshm](https://github.com/gu1llaum-3/sshm) ⭐ 1,372 | 🐛 30 | 🌐 Go | 📅 2026-07-27 SSH made easy and fast: browse, connect, and control from your terminal with a modern TUI
...
* [Desktop-TUI](https://github.com/Julien-cpsn/desktop-tui) ⭐ 1,212 | 🐛 5 | 🌐 Rust | 📅 2026-03-01 A desktop environment without graphics
* [clipse](https://github.com/savedra1/clipse) ⭐ 1,033 | 🐛 44 | 🌐 Go | 📅 2026-06-09 TUI-based clipboard manager application
* [longbridge-terminal](https://github.com/longbridge/longbridge-terminal) ⭐ 989 | 🐛 11 | 🌐 Rust | 📅 2026-08-28 AI-native TUI for Longbridge Securities: real-time quotes, portfolio management, and trading for HK/US/A-share/SG markets.
* [ekphos](https://github.com/hanebox/ekphos) ⭐ 976 | 🐛 7 | 🌐 Rust | 📅 2026-08-29 A fast, lightweight, markdown research tool written in rust
...
* [agent-deck](https://github.com/asheshgoplani/agent-deck) ⭐ 812 | 🐛 45 | 🌐 Go | 📅 2026-08-24 Terminal dashboard for managing multiple AI coding agent sessions
...
* [Tock](https://github.com/kriuchkov/tock) ⭐ 473 | 🐛 5 | 🌐 Go | 📅 2026-08-26 The powerful time tracking tool for the command line with a beautiful interactive TUI.
...
* [kanban](https://github.com/fulsomenko/kanban) ⭐ 163 | 🐛 8 | 🌐 Rust | 📅 2026-08-29 TUI kanban board for projects management with sprint tracking and task prioritization.
...
* [drako](https://github.com/lucky7xz/drako) ⭐ 41 | 🐛 0 | 🌐 Go | 📅 2026-08-23 A grid-based, customizable and extendable command- and TUI-Deck launcher
* [hnjobs](https://github.com/mwinters0/hnjobs) ⭐ 41 | 🐛 0 | 🌐 Go | 📅 2025-09-10 Find your next job on Who's Hiring
* [tuiserial](https://github.com/Horldsence/tuiserial) ⭐ 41 | 🐛 0 | 🌐 Rust | 📅 2026-08-06 TUI Serial Port Tool for Edge Computing Devices
* [Chronos](https://github.com/samuelstranges/chronos) ⭐ 40 | 🐛 2 | 🌐 Go | 📅 2026-04-23 A Vimlike Calendar TUI
...
* [gitlogue](https://github.com/unhappychoice/gitlogue) ⭐ 4,943 | 🐛 13 | 🌐 Rust | 📅 2026-08-26 A TUI screensaver that visualizes Git commit history in your terminal
* [weathr](https://github.com/veirt/weathr) ⭐ 3,034 | 🐛 20 | 🌐 Rust | 📅 2026-08-12 A terminal weather app with ASCII animations for weather visualization
...
* [neo](https://github.com/st3w/neo) ⭐ 954 | 🐛 16 | 🌐 C++ | 📅 2024-04-02 Simulates the digital rain from "The Matrix"
...
* [rtorrent](https://github.com/rakshasa/rtorrent) ⭐ 4,852 | 🐛 396 | 🌐 C++ | 📅 2026-08-29 A text-based BitTorrent client written in C++
...
* [newsboat](https://github.com/newsboat/newsboat) ⭐ 3,888 | 🐛 410 | 🌐 C++ | 📅 2026-08-22 An RSS/Atom feed reader for the text console
* [surge](https://github.com/surge-downloader/surge) ⭐ 3,493 | 🐛 53 | 🌐 Go | 📅 2026-08-29 A blazing fast, beautiful TUI download manager built in Go.
* [textual-web](https://github.com/Textualize/textual-web) ⭐ 1,459 | 🐛 23 | 🌐 Python | 📅 2024-08-30 Run TUIs and terminals in your browser
...
* [cloudflare-speed-cli](https://github.com/kavehtehrani/cloudflare-speed-cli) ⭐ 1,010 | 🐛 0 | 🌐 Rust | 📅 2026-07-27 Internet speed test via Cloudflare
* [eilmeldung](https://github.com/christo-auer/eilmeldung) ⭐ 953 | 🐛 0 | 🌐 Rust | 📅 2026-08-28 RSS reader, supporting many RSS providers, bulk-operations and configuration options.
...
* [omaro](https://github.com/Rolv-Apneseth/omaro) ⭐ 21 | 🐛 4 | 🌐 Rust | 📅 2026-08-29 TUI to browse posts and comments on lobste.rs

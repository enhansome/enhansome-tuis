...
There's a lot of cool projects here that I have no association with. Run them at your own risk. If you have a cool tool you'd like to share please [open a PR](https://github.com/rothgar/awesome-tuis/pulls) ⭐ 20,719 | 🐛 45 | 📅 2026-09-22.
...
* [btop++](https://github.com/aristocratos/btop) ⭐ 34,739 | 🐛 549 | 🌐 C++ | 📅 2026-09-19 Resource monitor with extras
* [Glances](https://github.com/nicolargo/glances) ⭐ 33,671 | 🐛 106 | 🌐 Python | 📅 2026-09-24 Glances an Eye on your system. A top/htop alternative.
* [Goaccess](https://github.com/allinurl/goaccess) ⭐ 20,949 | 🐛 448 | 🌐 C | 📅 2026-09-24 GoAccess is a real-time web log analyzer and interactive viewer that runs in a terminal in nix systems or through your browser.
* [WTF](https://github.com/senorprogrammer/wtf) ⭐ 17,100 | 🐛 108 | 🌐 Go | 📅 2026-09-17 The personal information dashboard for your terminal.
* [bottom](https://github.com/ClementTsang/bottom) ⭐ 14,056 | 🐛 106 | 🌐 Rust | 📅 2026-09-23 A customizable graphical process/system monitor for the terminal.
* [TermUI](https://github.com/gizak/termui) ⭐ 13,588 | 🐛 106 | 🌐 Go | 📅 2025-07-10 Golang terminal dashboard
* [gping](https://github.com/orf/gping) ⭐ 12,692 | 🐛 42 | 🌐 Rust | 📅 2026-09-23 Ping, but with a graph
* [gh-dash](https://github.com/dlvhdr/gh-dash) ⭐ 12,551 | 🐛 101 | 🌐 Go | 📅 2026-09-22 A rich terminal UI for GitHub PRs and Issues
* [bandwhich](https://github.com/imsnif/bandwhich) ⭐ 11,986 | 🐛 54 | 🌐 Rust | 📅 2026-08-01 Terminal bandwidth utilization tool
* [talos linux](https://github.com/siderolabs/talos) ⭐ 11,234 | 🐛 254 | 🌐 Go | 📅 2026-09-24 A Linux distro with a TUI dashboard for local and remote usage
...
* [htop](https://github.com/htop-dev/htop) ⭐ 8,347 | 🐛 355 | 🌐 C | 📅 2026-09-22 Interactive text-mode process viewer for Unix systems. It aims to be a better 'top'
...
* [trippy](https://github.com/fujiapple852/trippy) ⭐ 7,957 | 🐛 85 | 🌐 Rust | 📅 2026-09-15 A network diagnostic tool that includes functionality like mtr and more
* [Backlog.md](https://github.com/MrLesk/Backlog.md) ⭐ 6,833 | 🐛 71 | 🌐 TypeScript | 📅 2026-09-24 A tool for managing project collaboration between humans and AI Agents in a git ecosystem
* [ticker](https://github.com/achannarasappa/ticker) ⭐ 6,238 | 🐛 34 | 🌐 Go | 📅 2026-06-28 Track stocks, crypto, and derivatives prices and positions in real time from your terminal
...
* [rustnet](https://github.com/domcyrus/rustnet) ⭐ 5,052 | 🐛 28 | 🌐 Rust | 📅 2026-09-24 A cross-platform network monitoring tool with deep packet inspection
* [binsider](https://github.com/orhun/binsider) ⭐ 4,441 | 🐛 38 | 🌐 Rust | 📅 2026-09-20 A TUI for analyzing Linux binaries.
...
* [psmux](https://github.com/marlocarlo/psmux) ⭐ 3,549 | 🐛 41 | 🌐 PowerShell | 📅 2026-09-24 tmux-compatible terminal multiplexer for Windows built in Rust with ratatui.
...
* [process-compose](https://github.com/F1bonacc1/process-compose) ⭐ 2,798 | 🐛 26 | 🌐 Go | 📅 2026-09-21 TUI for running apps and processes
* [gonzo](https://github.com/control-theory/gonzo) ⭐ 2,772 | 🐛 17 | 🌐 Go | 📅 2026-09-23 A powerful, real-time log analysis terminal UI inspired by k9s.
...
* [macmon](https://github.com/vladkens/macmon) ⭐ 1,899 | 🐛 18 | 🌐 Rust | 📅 2026-08-04 Sudoless performance monitoring for Apple Silicon processors written in Rust
* [sysz](https://github.com/joehillen/sysz) ⭐ 1,881 | 🐛 5 | 🌐 Shell | 📅 2024-04-22 An fzf terminal UI for systemctl
* [netscanner](https://github.com/Chleba/netscanner) ⭐ 1,860 | 🐛 6 | 🌐 Rust | 📅 2026-07-06 Network scanner
...
* [nerdlog](https://github.com/dimonomid/nerdlog) ⭐ 1,563 | 🐛 12 | 🌐 Go | 📅 2026-09-24 fast, remote-first, multi-host TUI log viewer
...
* [atop](https://github.com/Atoptool/atop/) ⭐ 1,066 | 🐛 60 | 🌐 C | 📅 2026-09-23 root level system and process monitor for Linux
...
* [ServerHub](https://github.com/nickprotop/ServerHub) ⭐ 48 | 🐛 0 | 🌐 C# | 📅 2026-07-18 A TUI server monitoring dashboard for Linux with real-time metrics, scriptable widgets, and remote management
* [trek](https://github.com/franckverrot/trek) ⭐ 32 | 🐛 1 | 🌐 Go | 📅 2023-08-30 ncurses explorer for Hashicorp Nomad clusters
* [Servonaut](https://github.com/zb-ss/servonaut) ⭐ 28 | 🐛 7 | 🌐 Python | 📅 2026-09-24 A TUI for managing AWS, Hetzner, OVH and custom SSH servers with log viewing, CloudWatch/CloudTrail browsing, IP banning, AI log analysis and a built-in MCP server
...
* [opencode](https://github.com/sst/opencode) ⭐ 209,880 | 🐛 6,265 | 🌐 TypeScript | 📅 2026-09-24 AI coding agent, built for the terminal
* [codex](https://github.com/openai/codex) ⭐ 126,344 | 🐛 18,628 | 🌐 Rust | 📅 2026-09-24 Lightweight coding agent that runs in your terminal
* [lazygit](https://github.com/jesseduffield/lazygit) ⭐ 82,650 | 🐛 1,054 | 🌐 Go | 📅 2026-09-24 Simple terminal UI for git commands
* [delta](https://github.com/dandavison/delta) ⭐ 32,326 | 🐛 451 | 🌐 Rust | 📅 2026-09-19 A syntax-highlighting pager for git, diff, and grep output
* [crush](https://github.com/charmbracelet/crush) ⭐ 28,284 | 🐛 794 | 🌐 Go | 📅 2026-09-24 The glamourous AI coding agent
* [gitui](https://github.com/extrawurst/gitui) ⭐ 22,518 | 🐛 346 | 🌐 Rust | 📅 2026-08-04 blazing fast terminal-ui for git written in rust
...
* [posting](https://github.com/darrenburns/posting) ⭐ 12,445 | 🐛 87 | 🌐 Python | 📅 2026-03-25 A powerful HTTP client that lives in your terminal
* [Claude Code Usage Monitor](https://github.com/Maciek-roboblog/Claude-Code-Usage-Monitor) ⭐ 8,723 | 🐛 38 | 🌐 Python | 📅 2026-07-05 Monitor Claude token usage
...
* [soft-serve](https://github.com/charmbracelet/soft-serve) ⭐ 7,230 | 🐛 82 | 🌐 Go | 📅 2026-09-01 A tasty, self-hostable Git server for the command lineicecream
* [harlequin](https://github.com/tconbeer/harlequin) ⭐ 6,418 | 🐛 32 | 🌐 Python | 📅 2026-09-21 The SQL IDE for Your Terminal
* [rainfrog](https://github.com/achristmascarl/rainfrog) ⭐ 5,346 | 🐛 13 | 🌐 Rust | 📅 2026-09-24 A database management TUI for Postgres, MySQL, and SQLite written in Rust
* [sqlit](https://github.com/Maxteabag/sqlit) ⭐ 4,854 | 🐛 18 | 🌐 Python | 📅 2026-09-10 A lightweight TUI for SQL databases inspired by lazygit
* [lazysql](https://github.com/jorgerojas26/lazysql) ⭐ 4,323 | 🐛 39 | 🌐 Go | 📅 2026-09-22 A cross-platform TUI database management tool written in Go.
...
* [Toad](https://github.com/batrachianai/toad) ⭐ 3,446 | 🐛 7 | 🌐 Python | 📅 2026-05-26 A unified interface for AI
...
* [jqp](https://github.com/noahgorstein/jqp) ⭐ 2,846 | 🐛 24 | 🌐 Go | 📅 2026-02-06 A TUI playground to experiment with jq
* [euporie](https://github.com/joouha/euporie) ⭐ 2,666 | 🐛 15 | 🌐 Python | 📅 2026-09-18 Jupyter notebooks in the terminal
* [nap](https://github.com/maaslalani/nap) ⭐ 2,216 | 🐛 17 | 🌐 Go | 📅 2024-05-18 Code snippets in your terminal
* [runme](https://github.com/stateful/runme) ⭐ 2,176 | 🐛 152 | 🌐 Go | 📅 2026-09-17 Discover and run code snippets directly from your README.md or other markdowns
* [serie](https://github.com/lusingander/serie) ⭐ 2,116 | 🐛 25 | 🌐 Rust | 📅 2026-09-22 A rich git commit graph
* [resterm](https://github.com/unkn0wn-root/resterm) ⭐ 1,947 | 🐛 0 | 🌐 Go | 📅 2026-09-24 A terminal client for HTTP/GraphQL/gRPC with support for WebSockets, SSE, workflows, profiling, OpenAPI and response diffs.
* [termdbms](https://github.com/mathaou/termdbms) ⭐ 1,825 | 🐛 6 | 🌐 Go | 📅 2022-06-11 A TUI for viewing and editing database files.
...
* [VT Code](https://github.com/vinhnx/vtcode) ⭐ 855 | 🐛 1 | 🌐 Rust | 📅 2026-09-24 VT Code - Semantic Coding Agent
...
* [hcom](https://github.com/aannoo/hcom) ⭐ 517 | 🐛 37 | 🌐 Rust | 📅 2026-09-13 CLI and TUI for real-time messaging, observation, and orchestration between AI coding agents (Claude Code, Antigravity, Codex, OpenCode, Kilo, Cursor) across terminals
* [models](https://github.com/arimxyer/models) ⭐ 510 | 🐛 0 | 🌐 Rust | 📅 2026-09-24 TUI for browsing AI models and coding agents
* [Froggit](https://github.com/thewizardshell/froggit) ⭐ 484 | 🐛 3 | 🌐 Go | 📅 2026-03-20 Minimalist Git TUI with GitHub CLI integration
* [Feluda](https://github.com/anistark/feluda) ⭐ 472 | 🐛 15 | 🌐 Rust | 📅 2026-09-24 Detect restrictive and incompatible licesenses in all dependencies of your project.
...
* [chiko](https://github.com/felangga/chiko) ⭐ 355 | 🐛 1 | 🌐 Go | 📅 2026-04-15 The Ultimate Beauty TUI gRPC Client
...
* [Quorum](https://github.com/Detrol/quorum-cli) ⭐ 117 | 🐛 1 | 🌐 Python | 📅 2026-09-24 Multi-agent AI discussion system for structured debates between LLMs
...
* [gitwig](https://github.com/tareqmy/gitwig) ⭐ 88 | 🐛 0 | 🌐 Rust | 📅 2026-09-24 - A mouse-drivable git TUI and multi-repo dashboard built in Rust.
...
* [scope](https://github.com/matheuswhite/scope-rs) ⭐ 69 | 🐛 20 | 🌐 Rust | 📅 2026-09-24 Cross-platform serial-port & RTT monitor with colored timestamped I/O, hex/@tag input macros, search, session recording, auto-reconnect and Lua plugins
...
* [lazydocker](https://github.com/jesseduffield/lazydocker) ⭐ 52,945 | 🐛 301 | 🌐 Go | 📅 2026-04-19 The lazier way to manage everything docker
* [k9s](https://github.com/derailed/k9s) ⭐ 34,672 | 🐛 78 | 🌐 Go | 📅 2026-09-24 TUI for managing a Kubernetes cluster
...
* [kftui](https://github.com/hcavarsan/kftray) ⭐ 1,563 | 🐛 4 | 🌐 Rust | 📅 2026-09-24 A TUI to manage multiple kubectl port-forward commands, with support for UDP and K8s proxy.
* [dtop](https://github.com/amir20/dtop) ⭐ 1,431 | 🐛 1 | 🌐 Rust | 📅 2026-09-10 Terminal dashboard for Docker monitoring across multiple hosts
...
* [micro](https://github.com/zyedidia/micro) ⭐ 29,637 | 🐛 914 | 🌐 Go | 📅 2026-09-24 A modern and intuitive terminal-based text editor
* [Edit](https://github.com/microsoft/edit) ⭐ 14,606 | 🐛 167 | 🌐 Rust | 📅 2026-09-23 A simple text editor. Pays homage to the classic MS-DOS Editor.
* [kilo](https://github.com/antirez/kilo) ⭐ 9,140 | 🐛 64 | 🌐 C | 📅 2025-01-04 A minimal but complete editor in \~1000 lines of C code.
* [Fresh](https://github.com/sinelaw/fresh) ⭐ 9,021 | 🐛 366 | 🌐 Rust | 📅 2026-09-24 An easy-to-use, powerful and fast terminal-based text editor.
* [slap](https://github.com/slap-editor/slap) ⭐ 6,188 | 🐛 115 | 🌐 JavaScript | 📅 2021-11-01 Sublime-like terminal-based text editor
* [vis](https://github.com/martanne/vis) ⭐ 4,729 | 🐛 153 | 🌐 C | 📅 2026-09-23 A vi-like editor based on Plan 9's structural regular expressions
...
* [flow-control](https://github.com/neurocyte/flow) ⭐ 2,435 | 🐛 78 | 🌐 Zig | 📅 2026-09-24 A lightning-fast, feature-rich text editor written in Zig
...
* [orbiton](https://github.com/xyproto/orbiton) ⭐ 705 | 🐛 0 | 🌐 Go | 📅 2026-09-24 Text editor limited by VT100, suitable for programming, writing git commit messages and editing Markdown
...
* [yazi](https://github.com/sxyazi/yazi) ⭐ 42,402 | 🐛 64 | 🌐 Rust | 📅 2026-09-21 Blazing fast terminal file manager written in Rust, based on async I/O.
* [superfile](https://github.com/MHNightCat/superfile) ⭐ 23,374 | 🐛 271 | 🌐 Go | 📅 2026-09-23 Pretty fancy and modern terminal file manager.
* [nnn](https://github.com/jarun/nnn) ⭐ 22,008 | 🐛 1 | 🌐 C | 📅 2026-09-21 n³ The unorthodox terminal file manager.
* [ranger](https://github.com/ranger/ranger) ⭐ 17,414 | 🐛 897 | 🌐 Python | 📅 2026-09-09 A VIM-inspired file manager for the console.
* [broot](https://github.com/Canop/broot) ⭐ 12,960 | 🐛 100 | 🌐 Rust | 📅 2026-09-23 A new way to see and navigate directory trees
* [lf](https://github.com/gokcehan/lf) ⭐ 9,521 | 🐛 85 | 🌐 Go | 📅 2026-09-15 A terminal file manager written in Go with heavy inspiration from ranger file manager.
...
* [mc](https://github.com/MidnightCommander/mc) ⭐ 988 | 🐛 696 | 🌐 C | 📅 2026-09-24 GNU Midnight Commander. A free cross-platform orthodox file manager.
...
* [rovr](https://github.com/NSPC911/rovr) ⭐ 411 | 🐛 7 | 🌐 Python | 📅 2026-09-24 A post-modern terminal file manager.
...
* [NetHack](https://github.com/NetHack/NetHack) ⭐ 3,920 | 🐛 150 | 🌐 C | 📅 2026-09-23 Dungeon exploration game
...
* [BrogueCE](https://github.com/tmewett/BrogueCE) ⭐ 1,473 | 🐛 201 | 🌐 C | 📅 2026-09-20 Beautiful roguelike dungeon crawler
* [chess-tui](https://github.com/thomas-mauran/chess-tui) ⭐ 1,184 | 🐛 36 | 🌐 Rust | 📅 2026-09-24 Play Chess in your terminal, built in rust
...
* [LeTrain](https://github.com/antoniovazquezaraujo/LeTrain) ⭐ 19 | 🐛 38 | 🌐 Java | 📅 2026-09-24 - Open-source procedural train simulator using Java 17, LibGDX and Lanterna.
...
* [Rich](https://github.com/willmcgugan/rich) ⭐ 57,430 | 🐛 381 | 🌐 Python | 📅 2026-06-23 is a **Python** library for rich text and beautiful formatting in the terminal.
* [textual](https://github.com/willmcgugan/textual) ⭐ 37,325 | 🐛 358 | 🌐 Python | 📅 2026-07-11 is a TUI (Text User Interface) framework for **Python** inspired by modern web development.
* [Python Prompt Toolkit](https://github.com/prompt-toolkit/python-prompt-toolkit) ⭐ 10,585 | 🐛 722 | 🌐 Python | 📅 2026-07-26 Library for building powerful interactive command line applications in **Python**
...
* [bubbletea](https://github.com/charmbracelet/bubbletea) ⭐ 45,109 | 🐛 230 | 🌐 Go | 📅 2026-09-24 A **Go** framework based on Elm to build functional and fun terminal apps
* [tview](https://github.com/rivo/tview/) ⭐ 14,111 | 🐛 97 | 🌐 Go | 📅 2026-08-11 Terminal UI library with rich, interactive widgets — written in **Go**
...
* [libuv](https://github.com/libuv/libuv) ⭐ 27,196 | 🐛 242 | 🌐 C | 📅 2026-09-24 Cross-platform asynchronous I/O library - written in **C**
...
* [FTXUI](https://github.com/ArthurSonzogni/FTXUI) ⭐ 10,725 | 🐛 51 | 🌐 C++ | 📅 2026-09-24 💻 **C++** Functional Terminal User Interface. ❤️
...
* [xtd](https://github.com/gammasoft71/xtd) ⭐ 1,165 | 🐛 98 | 🌐 C++ | 📅 2026-09-24 Free open-source modern **C++** framework to create console (CLI), forms (GUI like WinForms) and unit test (xUnit) applications and libraries on Windows, macOS, Linux, iOS, Android, FreeBSD, and Haiku.
...
* [Lanterna](https://github.com/mabe02/lanterna) ⭐ 2,620 | 🐛 96 | 🌐 Java | 📅 2026-07-07 A **Java** library for creating text-based UIs, very similar to the C library curses but with more functionality.
...
* [Spectre.Console](https://github.com/spectreconsole/spectre.console) ⭐ 11,636 | 🐛 185 | 🌐 C# | 📅 2026-09-24 A **.NET** library for creating beautiful console applications
* [Terminal.Gui](https://github.com/gui-cs/Terminal.Gui) ⭐ 11,222 | 🐛 48 | 🌐 C# | 📅 2026-09-23 Cross-platform terminal UI toolkit for **.NET**
...
* [Hex1b](https://github.com/mitchdenny/hex1b) ⭐ 175 | 🐛 142 | 🌐 C# | 📅 2026-09-24 A **.NET** library for building rich, interactive TUIs with a React-inspired declarative API
...
* [Ratatui](https://github.com/tui-rs-revival/ratatui) ⭐ 22,731 | 🐛 214 | 🌐 Rust | 📅 2026-09-23 A **Rust** crate for building Terminal UIs (actively maintained fork of tui-rs).
...
* [iocraft](https://github.com/ccbrown/iocraft) ⭐ 1,546 | 🐛 26 | 🌐 Rust | 📅 2026-09-07 **Rust** crate for beautiful, artisanally crafted TUIs and text-based IO, with a declarative, React-like API inspired by Ink.
...
* [ink](https://github.com/vadimdemedes/ink) ⭐ 39,940 | 🐛 35 | 🌐 TypeScript | 📅 2026-09-21 React for **Node.js** interactive command-line apps
* [gum](https://github.com/charmbracelet/gum) ⭐ 24,417 | 🐛 208 | 🌐 Go | 📅 2026-09-24 A tool for glamorous **shell** scripts
* [OpenTUI](https://github.com/sst/opentui) ⭐ 13,381 | 🐛 155 | 🌐 TypeScript | 📅 2026-09-23 A **TypeScript** library for building terminal user interfaces (TUIs)
* [blessed](https://github.com/chjj/blessed) ⭐ 11,888 | 🐛 255 | 🌐 JavaScript | 📅 2024-03-22 A high-level terminal interface library for **Node.js**
  stateful TUI apps.
* [termbox2](https://github.com/termbox/termbox2) ⭐ 772 | 🐛 18 | 🌐 C | 📅 2026-09-03 A terminal rendering library for creating TUIs.
...
* [TermDOM](https://github.com/bikeshaving/termdom) ⭐ 312 | 🐛 16 | 🌐 TypeScript | 📅 2026-09-24 A **JavaScript** library that displays HTML and CSS in the terminal, with a real DOM
...
* [Raxol](https://github.com/DROOdotFOO/raxol) ⭐ 79 | 🐛 55 | 🌐 Elixir | 📅 2026-09-24 A multi-surface runtime for **Elixir**: one application renders to the terminal, browser, SSH, and agent surfaces, with per-component crash isolation and hot reload from the BEAM.
...
* [Devzat](https://github.com/quackduck/devzat) ⭐ 4,070 | 🐛 25 | 🌐 Go | 📅 2026-07-23 Chat over SSH, written in Golang with self-hosting ability.
* [nomadnet](https://github.com/markqvist/NomadNet) ⭐ 2,549 | 🐛 0 | 🌐 Python | 📅 2026-05-28 Secure messaging network built on Reticulum
* [sclack](https://github.com/haskellcamargo/sclack) ⭐ 2,478 | 🐛 44 | 🌐 Python | 📅 2022-12-08 Slack terminal client
* [instagram-cli](https://github.com/supreme-gg-gg/instagram-cli) ⭐ 2,155 | 🐛 42 | 🌐 TypeScript | 📅 2026-09-03 Use Instagram from your terminal, the end of brainrot is here
...
* [concord](https://github.com/chojs23/concord) ⭐ 1,551 | 🐛 46 | 🌐 Rust | 📅 2026-09-23 A feature-rich TUI client for Discord
* [gurk-rs](https://github.com/boxdot/gurk-rs) ⭐ 1,381 | 🐛 98 | 🌐 Rust | 📅 2026-09-15 Signal Messenger client for terminal
* [basalt](https://github.com/erikjuhani/basalt) ⭐ 1,359 | 🐛 37 | 🌐 Rust | 📅 2026-09-24 TUI Application to manage Obsidian vaults and notes directly from the terminal.
...
* [matcha](https://github.com/floatpane/matcha) ⭐ 1,106 | 🐛 69 | 🌐 Go | 📅 2026-09-21 Email client
* [tgt](https://github.com/FedericoBruzzone/tgt) ⭐ 1,015 | 🐛 15 | 🌐 Rust | 📅 2026-09-21 A TUI for Telegram written in Rust
* [endcord](https://github.com/mzivic7/endcord) ⭐ 995 | 🐛 1 | 🌐 Python | 📅 2026-09-22 Feature rich Discord TUI client.
...
* [fzf](https://github.com/junegunn/fzf) ⭐ 83,238 | 🐛 331 | 🌐 Go | 📅 2026-09-21 A general-purpose command-line fuzzy finder
* [wttr.in](https://github.com/chubin/wttr.in) ⭐ 30,582 | 🐛 331 | 🌐 Go | 📅 2026-09-07 The right way to check the weather
* [oha](https://github.com/hatoo/oha) ⭐ 10,557 | 🐛 58 | 🌐 Rust | 📅 2026-09-10 HTTP load generator
* [termshark](https://github.com/gcla/termshark) ⭐ 10,021 | 🐛 51 | 🌐 Go | 📅 2024-04-30 Terminal UI for tshark
...
* [wego](https://github.com/schachmat/wego) ⭐ 8,557 | 🐛 16 | 🌐 Go | 📅 2026-08-01 Weather app
* [term.everything](https://github.com/mmulet/term.everything) ⭐ 8,101 | 🐛 10 | 🌐 Go | 📅 2026-03-18 Run any GUI app in the terminal
* [cava](https://github.com/karlstav/cava) ⭐ 6,436 | 🐛 18 | 🌐 C | 📅 2026-09-21 Cross-platform Audio Visualizer
* [dua-cli](https://github.com/byron/dua-cli) ⭐ 6,297 | 🐛 1 | 🌐 Rust | 📅 2026-09-24 View disk space usage and delete unwanted data, fast.
* [gdu](https://github.com/dundee/gdu) ⭐ 6,005 | 🐛 49 | 🌐 Go | 📅 2026-09-23 Fast disk usage analyzer with console interface written in Go
...
* [x-cmd](https://github.com/x-cmd/x-cmd) ⭐ 4,680 | 🐛 108 | 🌐 Awk | 📅 2026-09-24 A vast and interesting collection of tools that can then bootstrap lots of other programs / functions in a consistent and structured way.
* [csvlens](https://github.com/YS-L/csvlens) ⭐ 3,985 | 🐛 59 | 🌐 Rust | 📅 2026-07-04 TUI CSV file viewer. It is like less but made for CSV.
* [cfdisk](https://github.com/util-linux/util-linux) ⭐ 3,232 | 🐛 435 | 🌐 C | 📅 2026-09-22 TUI partition editor included in util-linux
...
* [impala](https://github.com/pythops/impala) ⭐ 2,863 | 🐛 0 | 🌐 Rust | 📅 2026-09-19 TUI for managing wifi
* [tweakcc](https://github.com/Piebald-AI/tweakcc) ⭐ 2,524 | 🐛 58 | 🌐 TypeScript | 📅 2026-09-24 TUI to customize your Claude Code themes, thinking verbs, and more.
* [Caligula](https://github.com/ifd3f/caligula) ⭐ 2,354 | 🐛 54 | 🌐 Rust | 📅 2026-09-17 A user-friendly, lightweight TUI for imaging disks.
...
* [Systemd-manager-tui](https://github.com/matheus-git/systemd-manager-tui) ⭐ 1,583 | 🐛 6 | 🌐 Rust | 📅 2026-09-21 A program for managing systemd services through a TUI.
* [bluetuith](https://github.com/darkhz/bluetuith) ⭐ 1,410 | 🐛 15 | 🌐 Go | 📅 2026-07-01 A TUI-based bluetooth connection manager, which can interact with bluetooth adapters and devices.
...
* [vortix](https://github.com/Harry-kp/vortix) ⭐ 651 | 🐛 33 | 🌐 Rust | 📅 2026-09-24 Terminal UI for WireGuard and OpenVPN with real-time telemetry, leak detection, and kill switch.
...
* [linecast](https://github.com/ashuttl/linecast) ⭐ 522 | 🐛 19 | 🌐 Python | 📅 2026-09-24 Interactive weather, radar, tides, sun and moon views, a planetarium with stars and constellations, and maps with a rotatable globe for the terminal.
...
* [wifitui](https://github.com/shazow/wifitui) ⭐ 335 | 🐛 34 | 🌐 Go | 📅 2026-09-24 Fast featureful friendly wifi terminal UI, supports NetworkManager and iwd over dbus.
...
* [packemon](https://github.com/ddddddO/packemon) ⭐ 308 | 🐛 36 | 🌐 Go | 📅 2026-09-19 Packet generator and monitor.
...
* [vlc](https://github.com/videolan/vlc) ⭐ 19,758 | 🐛 2 | 🌐 C | 📅 2026-09-24 VLC includes an ncurses interface, `vlc --intf ncurses`
...
* [kew](https://github.com/ravachol/kew) ⭐ 3,107 | 🐛 1 | 🌐 C | 📅 2026-09-24 A terminal music player for Linux
* [timg](https://github.com/hzeller/timg) ⭐ 2,763 | 🐛 36 | 🌐 C++ | 📅 2026-08-05 A terminal image viewer
* [termusic](https://github.com/tramhao/termusic) ⭐ 2,217 | 🐛 49 | 🌐 Rust | 📅 2026-09-22 Music Player TUI written in Rust
* [tdf](https://github.com/itsjunetime/tdf) ⭐ 1,978 | 🐛 42 | 🌐 Rust | 📅 2026-08-16 A tui-based PDF viewer
* [tizonia-openmax-il](https://github.com/tizonia/tizonia-openmax-il) ⭐ 1,741 | 🐛 168 | 🌐 C | 📅 2026-09-24 Command-line cloud music player for Linux with support for Spotify, Google Play Music, YouTube, SoundCloud, Dirble, Plex servers and Chromecast devices
* [soundcloud2000](https://github.com/grobie/soundcloud2000) ⚠️ Archived A terminal client for soundcloud
* [spotatui](https://github.com/LargeModGames/spotatui) ⭐ 1,380 | 🐛 37 | 🌐 Rust | 📅 2026-09-24 Spotify client with native streaming, synced lyrics, and real-time audio visualization
...
* [manga-tui](https://github.com/josueBarretogit/manga-tui) ⭐ 935 | 🐛 24 | 🌐 Rust | 📅 2026-07-13 Terminal-based manga reader and downloader with image rendering support
...
* [jellyfin-tui](https://github.com/dhonus/jellyfin-tui) ⭐ 599 | 🐛 19 | 🌐 Rust | 📅 2026-09-20 Jellyfin client
* [spotui](https://github.com/ceuk/spotui) ⭐ 577 | 🐛 8 | 🌐 Python | 📅 2023-07-25 Spotify client written in Python
* [fancy-cat](https://github.com/freref/fancy-cat) ⭐ 564 | 🐛 20 | 🌐 Zig | 📅 2026-08-03 A Lightweight terminal-based PDF reader with Vim keybindings
...
* [mpvc](https://github.com/gmt4/mpvc) ⭐ 160 | 🐛 1 | 🌐 Shell | 📅 2026-09-24 A mpc-like control interface for mpv
...
* [tmux](https://github.com/tmux/tmux) ⭐ 49,477 | 🐛 33 | 🌐 C | 📅 2026-09-24 Terminal multiplexer
* [zellij](https://github.com/zellij-org/zellij) ⭐ 35,529 | 🐛 1,940 | 🌐 Rust | 📅 2026-09-24 A terminal workspace with batteries included
* [Glow](https://github.com/charmbracelet/glow) ⭐ 27,458 | 🐛 235 | 🌐 Go | 📅 2026-09-22 A markdown reader, designed from the ground up to showcase the elegance and capabilities of TUI.
* [slides](https://github.com/maaslalani/slides) ⭐ 11,666 | 🐛 77 | 🌐 Go | 📅 2026-07-08 A terminal based presentation tool, supporting markdown syntax.
* [Visidata](https://github.com/saulpw/visidata) ⭐ 9,295 | 🐛 88 | 🌐 Python | 📅 2026-09-23 A terminal spreadsheet multitool for discovering and arranging data
* [presenterm](https://github.com/mfontanini/presenterm) ⭐ 8,874 | 🐛 78 | 🌐 Rust | 📅 2026-05-22 A markdown terminal slideshow tool
...
* [television](https://github.com/alexpasmantier/television) ⭐ 6,289 | 🐛 79 | 🌐 Rust | 📅 2026-09-23 A fast and versatile fuzzy finder TUI
* [sc-im](https://github.com/andmarti1424/sc-im) ⭐ 5,697 | 🐛 117 | 🌐 C | 📅 2026-09-24 An ncurses spreadsheet program for terminal. Reignited version of sc
* [hledger-ui](https://github.com/simonmichael/hledger) ⭐ 4,731 | 🐛 324 | 🌐 Haskell | 📅 2026-09-24 A fast TUI for browsing double entry bookkeeping data
...
* [TUIOS](https://github.com/Gaurav-Gosain/tuios) ⭐ 3,715 | 🐛 20 | 🌐 Go | 📅 2026-09-24 A TUI window manager for managing multiple terminal sessions
* [Tabiew](https://github.com/shshemi/tabiew) ⭐ 3,121 | 🐛 17 | 🌐 Rust | 📅 2026-09-24 A lightweight app to view and query tabular data files, such as CSV, TSV, and parquet.
...
* [khal](https://github.com/pimutils/khal) ⭐ 3,055 | 🐛 264 | 🌐 Python | 📅 2026-09-23 A standards based CLI calendar program, able to synchronize with CalDAV servers
* [Bagels](https://github.com/EnhancedJax/Bagels) ⭐ 2,907 | 🐛 18 | 🌐 Python | 📅 2025-07-06 TUI expense tracker
...
* [calcure](https://github.com/anufrievroman/calcure) ⭐ 2,361 | 🐛 7 | 🌐 Python | 📅 2026-08-29 Modern TUI calendar and task manager with minimal and customizable UI.
...
* [jiratui](https://github.com/whyisdifficult/jiratui) ⭐ 1,699 | 🐛 15 | 🌐 Python | 📅 2026-09-24 A TUI for interacting with Atlassian Jira directly from your shell
* [sshm](https://github.com/gu1llaum-3/sshm) ⭐ 1,397 | 🐛 34 | 🌐 Go | 📅 2026-07-27 SSH made easy and fast: browse, connect, and control from your terminal with a modern TUI
...
* [longbridge-terminal](https://github.com/longbridge/longbridge-terminal) ⭐ 1,008 | 🐛 12 | 🌐 Rust | 📅 2026-09-20 AI-native TUI for Longbridge Securities: real-time quotes, portfolio management, and trading for HK/US/A-share/SG markets.
* [dvtm](https://github.com/martanne/dvtm) ⭐ 965 | 🐛 77 | 🌐 C | 📅 2024-05-18 A terminal multiplexer with dwm like window management
* [agent-deck](https://github.com/asheshgoplani/agent-deck) ⭐ 948 | 🐛 32 | 🌐 Go | 📅 2026-09-21 Terminal dashboard for managing multiple AI coding agent sessions
...
* [Tock](https://github.com/kriuchkov/tock) ⭐ 484 | 🐛 5 | 🌐 Go | 📅 2026-08-26 The powerful time tracking tool for the command line with a beautiful interactive TUI.
...
* [hygg](https://github.com/kruserr/hygg) ⭐ 359 | 🐛 14 | 🌐 Rust | 📅 2026-09-18 📚 Simplifying the way you read. Minimalistic Vim-like TUI document reader.
...
* [budget-tracker-tui](https://github.com/Feromond/budget-tracker-tui) ⭐ 338 | 🐛 8 | 🌐 Rust | 📅 2026-09-16 A TUI budget tracker app designed to track income, expenses, investments, budget goals and visualize / gather insights.
...
* [kanban](https://github.com/fulsomenko/kanban) ⭐ 171 | 🐛 12 | 🌐 Rust | 📅 2026-09-24 TUI kanban board for projects management with sprint tracking and task prioritization.
...
* [gitlogue](https://github.com/unhappychoice/gitlogue) ⭐ 4,997 | 🐛 13 | 🌐 Rust | 📅 2026-09-24 A TUI screensaver that visualizes Git commit history in your terminal
* [weathr](https://github.com/veirt/weathr) ⭐ 3,059 | 🐛 20 | 🌐 Rust | 📅 2026-08-12 A terminal weather app with ASCII animations for weather visualization
...
* [browsh](https://github.com/browsh-org/browsh) ⭐ 19,064 | 🐛 241 | 🌐 JavaScript | 📅 2025-07-11 A fully-modern text-based browser, rendering to TTY and browsers
* [rtorrent](https://github.com/rakshasa/rtorrent) ⭐ 4,866 | 🐛 388 | 🌐 C++ | 📅 2026-09-24 A text-based BitTorrent client written in C++
...
* [newsboat](https://github.com/newsboat/newsboat) ⭐ 3,914 | 🐛 417 | 🌐 C++ | 📅 2026-09-20 An RSS/Atom feed reader for the text console
* [surge](https://github.com/surge-downloader/surge) ⭐ 3,544 | 🐛 57 | 🌐 Go | 📅 2026-09-24 A blazing fast, beautiful TUI download manager built in Go.
...
* [cloudflare-speed-cli](https://github.com/kavehtehrani/cloudflare-speed-cli) ⭐ 1,044 | 🐛 0 | 🌐 Rust | 📅 2026-07-27 Internet speed test via Cloudflare
* [eilmeldung](https://github.com/christo-auer/eilmeldung) ⭐ 1,012 | 🐛 2 | 🌐 Rust | 📅 2026-09-23 RSS reader, supporting many RSS providers, bulk-operations and configuration options.

...
There's a lot of cool projects here that I have no association with. Run them at your own risk. If you have a cool tool you'd like to share please [open a PR](https://github.com/rothgar/awesome-tuis/pulls) ⭐ 20,252 | 🐛 74 | 📅 2026-08-11.
...
* [btop++](https://github.com/aristocratos/btop) ⭐ 34,122 | 🐛 529 | 🌐 C++ | 📅 2026-08-08 Resource monitor with extras
* [Glances](https://github.com/nicolargo/glances) ⭐ 33,387 | 🐛 108 | 🌐 Python | 📅 2026-08-18 Glances an Eye on your system. A top/htop alternative.
* [Goaccess](https://github.com/allinurl/goaccess) ⭐ 20,828 | 🐛 455 | 🌐 C | 📅 2026-08-20 GoAccess is a real-time web log analyzer and interactive viewer that runs in a terminal in nix systems or through your browser.
* [WTF](https://github.com/senorprogrammer/wtf) ⭐ 17,056 | 🐛 102 | 🌐 Go | 📅 2026-08-05 The personal information dashboard for your terminal.
* [bottom](https://github.com/ClementTsang/bottom) ⭐ 13,915 | 🐛 107 | 🌐 Rust | 📅 2026-08-20 A customizable graphical process/system monitor for the terminal.
...
* [gh-dash](https://github.com/dlvhdr/gh-dash) ⭐ 12,330 | 🐛 98 | 🌐 Go | 📅 2026-08-01 A rich terminal UI for GitHub PRs and Issues
...
* [talos linux](https://github.com/siderolabs/talos) ⭐ 10,987 | 🐛 220 | 🌐 Go | 📅 2026-08-20 A Linux distro with a TUI dashboard for local and remote usage
* [nvtop](https://github.com/Syllo/nvtop) ⭐ 10,931 | 🐛 144 | 🌐 C | 📅 2026-05-06 GPUs process monitoring for AMD, Intel and NVIDIA
...
* [csysdig](https://github.com/draios/sysdig) ⭐ 8,287 | 🐛 116 | 🌐 C++ | 📅 2026-04-13 root level Ncurses interface for sysdig, Linux system exploration and troubleshooting tool with first class support for containers
* [htop](https://github.com/htop-dev/htop) ⭐ 8,270 | 🐛 351 | 🌐 C | 📅 2026-08-16 Interactive text-mode process viewer for Unix systems. It aims to be a better 'top'
* [trippy](https://github.com/fujiapple852/trippy) ⭐ 7,508 | 🐛 78 | 🌐 Rust | 📅 2026-08-13 A network diagnostic tool that includes functionality like mtr and more
* [Backlog.md](https://github.com/MrLesk/Backlog.md) ⭐ 6,507 | 🐛 25 | 🌐 TypeScript | 📅 2026-08-20 A tool for managing project collaboration between humans and AI Agents in a git ecosystem
* [ticker](https://github.com/achannarasappa/ticker) ⭐ 6,213 | 🐛 36 | 🌐 Go | 📅 2026-06-28 Track stocks, crypto, and derivatives prices and positions in real time from your terminal
* [s-tui](https://github.com/amanusk/s-tui) ⭐ 5,067 | 🐛 38 | 🌐 Python | 📅 2026-08-19 CPU stress and monitoring utility
* [Kyanos](https://github.com/hengyoush/kyanos) ⭐ 5,066 | 🐛 33 | 🌐 C | 📅 2026-08-20 Linux network analysis tool based on eBPF
* [rustnet](https://github.com/domcyrus/rustnet) ⭐ 4,872 | 🐛 13 | 🌐 Rust | 📅 2026-08-20 A cross-platform network monitoring tool with deep packet inspection
...
* [binsider](https://github.com/orhun/binsider) ⭐ 4,391 | 🐛 35 | 🌐 Rust | 📅 2026-08-16 A TUI for analyzing Linux binaries.
...
* [psmux](https://github.com/marlocarlo/psmux) ⭐ 3,306 | 🐛 14 | 🌐 PowerShell | 📅 2026-08-20 tmux-compatible terminal multiplexer for Windows built in Rust with ratatui.
...
* [process-compose](https://github.com/F1bonacc1/process-compose) ⭐ 2,695 | 🐛 17 | 🌐 Go | 📅 2026-08-17 TUI for running apps and processes
* [oryx](https://github.com/pythops/oryx) ⭐ 2,559 | 🐛 5 | 🌐 Rust | 📅 2026-07-17 A TUI for sniffing network traffic using eBPF
...
* [macmon](https://github.com/vladkens/macmon) ⭐ 1,816 | 🐛 14 | 🌐 Rust | 📅 2026-08-04 Sudoless performance monitoring for Apple Silicon processors written in Rust
...
* [dolphie](https://github.com/charles-001/dolphie) ⭐ 1,190 | 🐛 2 | 🌐 Python | 📅 2026-08-20 Your single pane of glass for real-time analytics into MySQL/MariaDB & ProxySQL
...
* [updo](https://github.com/Owloops/updo) ⭐ 1,119 | 🐛 6 | 🌐 Go | 📅 2026-05-26 Website monitoring tool with uptime tracking, response time metrics, and SSL certificate monitoring.
* [otel-tui](https://github.com/ymtdzzz/otel-tui) ⭐ 1,067 | 🐛 29 | 🌐 Go | 📅 2026-08-10 A terminal OpenTelemetry viewer
...
* [atop](https://github.com/Atoptool/atop/) ⭐ 1,049 | 🐛 61 | 🌐 C | 📅 2026-08-15 root level system and process monitor for Linux
...
* [pstop](https://github.com/marlocarlo/pstop) ⭐ 235 | 🐛 6 | 🌐 Rust | 📅 2026-07-18 htop-style system monitor for Windows with per-core CPU bars, tree view, and 7 color schemes.
...
* [sockttop](https://github.com/jasonwitty/socktop) ⭐ 188 | 🐛 2 | 🌐 Rust | 📅 2026-08-20 socktop is a remote system monitor with a rich TUI, inspired by top/btop, talking to a lightweight agent over WebSockets.
...
* [claws](https://github.com/clawscli/claws) ⭐ 149 | 🐛 6 | 🌐 Go | 📅 2026-07-25 A terminal UI for AWS resource management with vim-style keybindings, command-mode navigation, and optional read-only mode.
* [psnet](https://github.com/marlocarlo/psnet) ⭐ 139 | 🐛 3 | 🌐 Rust | 📅 2026-08-10 Real-time TUI network monitor for Windows with speed graphs, DNS resolution, and packet inspection.
...
* [opencode](https://github.com/sst/opencode) ⭐ 199,502 | 🐛 5,283 | 🌐 TypeScript | 📅 2026-08-20 AI coding agent, built for the terminal
* [codex](https://github.com/openai/codex) ⭐ 107,095 | 🐛 13,251 | 🌐 Rust | 📅 2026-08-20 Lightweight coding agent that runs in your terminal
* [lazygit](https://github.com/jesseduffield/lazygit) ⭐ 81,496 | 🐛 1,024 | 🌐 Go | 📅 2026-08-20 Simple terminal UI for git commands
* [delta](https://github.com/dandavison/delta) ⭐ 31,813 | 🐛 427 | 🌐 Rust | 📅 2026-08-02 A syntax-highlighting pager for git, diff, and grep output
* [crush](https://github.com/charmbracelet/crush) ⭐ 27,526 | 🐛 654 | 🌐 Go | 📅 2026-08-20 The glamourous AI coding agent
* [gitui](https://github.com/extrawurst/gitui) ⭐ 22,407 | 🐛 339 | 🌐 Rust | 📅 2026-08-04 blazing fast terminal-ui for git written in rust
* [fx](https://github.com/antonmedv/fx) ⭐ 20,586 | 🐛 25 | 🌐 Go | 📅 2026-07-28 Terminal JSON viewer & processor
* [tig](https://github.com/jonas/tig) ⭐ 13,311 | 🐛 228 | 🌐 C | 📅 2026-07-27 Text-mode interface for git
* [posting](https://github.com/darrenburns/posting) ⭐ 12,288 | 🐛 83 | 🌐 Python | 📅 2026-03-25 A powerful HTTP client that lives in your terminal
* [Claude Code Usage Monitor](https://github.com/Maciek-roboblog/Claude-Code-Usage-Monitor) ⭐ 8,646 | 🐛 36 | 🌐 Python | 📅 2026-07-05 Monitor Claude token usage
...
* [soft-serve](https://github.com/charmbracelet/soft-serve) ⭐ 7,184 | 🐛 78 | 🌐 Go | 📅 2026-08-12 A tasty, self-hostable Git server for the command lineicecream
* [harlequin](https://github.com/tconbeer/harlequin) ⭐ 6,334 | 🐛 45 | 🌐 Python | 📅 2026-08-20 The SQL IDE for Your Terminal
* [rainfrog](https://github.com/achristmascarl/rainfrog) ⭐ 5,285 | 🐛 19 | 🌐 Rust | 📅 2026-08-17 A database management TUI for Postgres, MySQL, and SQLite written in Rust
* [sqlit](https://github.com/Maxteabag/sqlit) ⭐ 4,694 | 🐛 29 | 🌐 Python | 📅 2026-08-07 A lightweight TUI for SQL databases inspired by lazygit
* [lazysql](https://github.com/jorgerojas26/lazysql) ⭐ 4,231 | 🐛 50 | 🌐 Go | 📅 2026-08-20 A cross-platform TUI database management tool written in Go.
...
* [Claude Code Bridge](https://github.com/bfly123/claude_code_bridge) ⭐ 3,428 | 🐛 100 | 🌐 Python | 📅 2026-08-20 Real-time multi-AI collaboration between Claude, Codex and Gemini in terminal
* [Toad](https://github.com/batrachianai/toad) ⭐ 3,379 | 🐛 6 | 🌐 Python | 📅 2026-05-26 A unified interface for AI
* [pudb](https://github.com/inducer/pudb) ⭐ 3,251 | 🐛 164 | 🌐 Python | 📅 2026-08-16 A console-based visual debugger for Python
* [dblab](https://github.com/danvergara/dblab) ⭐ 3,186 | 🐛 15 | 🌐 Go | 📅 2026-08-18 The database client every command line junkie deserves
* [jqp](https://github.com/noahgorstein/jqp) ⭐ 2,830 | 🐛 24 | 🌐 Go | 📅 2026-02-06 A TUI playground to experiment with jq
* [euporie](https://github.com/joouha/euporie) ⭐ 2,636 | 🐛 15 | 🌐 Python | 📅 2026-08-20 Jupyter notebooks in the terminal
* [nap](https://github.com/maaslalani/nap) ⭐ 2,218 | 🐛 17 | 🌐 Go | 📅 2024-05-18 Code snippets in your terminal
* [runme](https://github.com/stateful/runme) ⭐ 2,142 | 🐛 155 | 🌐 Go | 📅 2026-08-18 Discover and run code snippets directly from your README.md or other markdowns
* [serie](https://github.com/lusingander/serie) ⭐ 2,041 | 🐛 22 | 🌐 Rust | 📅 2026-08-19 A rich git commit graph
* [resterm](https://github.com/unkn0wn-root/resterm) ⭐ 1,850 | 🐛 0 | 🌐 Go | 📅 2026-08-19 A terminal client for HTTP/GraphQL/gRPC with support for WebSockets, SSE, workflows, profiling, OpenAPI and response diffs.
* [termdbms](https://github.com/mathaou/termdbms) ⭐ 1,818 | 🐛 6 | 🌐 Go | 📅 2022-06-11 A TUI for viewing and editing database files.
...
* [proxelar](https://github.com/emanuele-em/proxelar) ⭐ 1,048 | 🐛 3 | 🌐 Rust | 📅 2026-08-19 Scriptable MITM proxy TUI to inspect, intercept, replay, and rewrite HTTP(S) and WebSocket traffic
...
* [VT Code](https://github.com/vinhnx/vtcode) ⭐ 811 | 🐛 3 | 🌐 Rust | 📅 2026-08-19 VT Code - Semantic Coding Agent
...
* [models](https://github.com/arimxyer/models) ⭐ 493 | 🐛 0 | 🌐 Rust | 📅 2026-08-20 TUI for browsing AI models and coding agents
* [Froggit](https://github.com/thewizardshell/froggit) ⭐ 481 | 🐛 3 | 🌐 Go | 📅 2026-03-20 Minimalist Git TUI with GitHub CLI integration
* [Feluda](https://github.com/anistark/feluda) ⭐ 469 | 🐛 12 | 🌐 Rust | 📅 2026-08-19 Detect restrictive and incompatible licesenses in all dependencies of your project.
* [hcom](https://github.com/aannoo/hcom) ⭐ 459 | 🐛 28 | 🌐 Rust | 📅 2026-08-09 CLI and TUI for real-time messaging, observation, and orchestration between AI coding agents (Claude Code, Antigravity, Codex, OpenCode, Kilo, Cursor) across terminals
...
* [sabiql](https://github.com/riii111/sabiql) ⭐ 252 | 🐛 5 | 🌐 Rust | 📅 2026-08-20 A fast, driver-less TUI to browse, query, and edit PostgreSQL databases, written in Rust
...
* [amux](https://github.com/andyrewlee/amux) ⭐ 147 | 🐛 6 | 🌐 Go | 📅 2026-08-20 Easily run parallel coding agents
* [fast-resume](https://github.com/angristan/fast-resume) ⭐ 145 | 🐛 15 | 🌐 Rust | 📅 2026-08-15 Index and fuzzy search coding agent sessions
...
* [gitwig](https://github.com/tareqmy/gitwig) ⭐ 77 | 🐛 0 | 🌐 Rust | 📅 2026-08-16 - A mouse-drivable git TUI and multi-repo dashboard built in Rust.
...
* [lazydocker](https://github.com/jesseduffield/lazydocker) ⭐ 52,559 | 🐛 292 | 🌐 Go | 📅 2026-04-19 The lazier way to manage everything docker
* [k9s](https://github.com/derailed/k9s) ⭐ 34,397 | 🐛 115 | 🌐 Go | 📅 2026-08-20 TUI for managing a Kubernetes cluster
...
* [kdash](https://github.com/kdash-rs/kdash) ⭐ 2,522 | 🐛 2 | 🌐 Rust | 📅 2026-08-19 A simple and fast dashboard for Kubernetes
...
* [kftui](https://github.com/hcavarsan/kftray) ⭐ 1,549 | 🐛 16 | 🌐 Rust | 📅 2026-08-20 A TUI to manage multiple kubectl port-forward commands, with support for UDP and K8s proxy.
* [dtop](https://github.com/amir20/dtop) ⭐ 1,339 | 🐛 1 | 🌐 Rust | 📅 2026-08-16 Terminal dashboard for Docker monitoring across multiple hosts
...
* [e1s](https://github.com/keidarcy/e1s) ⭐ 919 | 🐛 2 | 🌐 Go | 📅 2026-08-03 TUI for managing AWS ECS resources
...
* [micro](https://github.com/zyedidia/micro) ⭐ 29,399 | 🐛 1,033 | 🌐 Go | 📅 2026-08-20 A modern and intuitive terminal-based text editor
* [Edit](https://github.com/microsoft/edit) ⭐ 14,473 | 🐛 163 | 🌐 Rust | 📅 2026-08-19 A simple text editor. Pays homage to the classic MS-DOS Editor.
* [kilo](https://github.com/antirez/kilo) ⭐ 9,078 | 🐛 62 | 🌐 C | 📅 2025-01-04 A minimal but complete editor in \~1000 lines of C code.
* [Fresh](https://github.com/sinelaw/fresh) ⭐ 8,362 | 🐛 286 | 🌐 Rust | 📅 2026-08-20 An easy-to-use, powerful and fast terminal-based text editor.
* [slap](https://github.com/slap-editor/slap) ⭐ 6,190 | 🐛 115 | 🌐 JavaScript | 📅 2021-11-01 Sublime-like terminal-based text editor
* [vis](https://github.com/martanne/vis) ⭐ 4,688 | 🐛 148 | 🌐 C | 📅 2026-08-20 A vi-like editor based on Plan 9's structural regular expressions
...
* [flow-control](https://github.com/neurocyte/flow) ⭐ 2,180 | 🐛 81 | 🌐 Zig | 📅 2026-08-20 A lightning-fast, feature-rich text editor written in Zig
* [zee](https://github.com/zee-editor/zee) ⭐ 1,799 | 🐛 44 | 🌐 Rust | 📅 2025-02-06 A modern text editor for the terminal written in Rust
* [Durdraw](https://github.com/cmang/durdraw) ⭐ 1,788 | 🐛 4 | 🌐 Python | 📅 2026-08-18 An ASCII, Unicode and ANSI art editor
* [orbiton](https://github.com/xyproto/orbiton) ⭐ 694 | 🐛 1 | 🌐 Go | 📅 2026-08-20 Text editor limited by VT100, suitable for programming, writing git commit messages and editing Markdown
...
* [treemd](https://github.com/Epistates/treemd) ⭐ 674 | 🐛 6 | 🌐 Rust | 📅 2026-08-19 A markdown navigator with tree-based structural navigation
* [tilde](https://github.com/gphalkes/tilde) ⭐ 551 | 🐛 65 | 🌐 C++ | 📅 2026-06-10 Intuitive text editor for the terminal
* [PNANA](https://github.com/Cyxuan0311/PNANA) ⭐ 317 | 🐛 15 | 🌐 C++ | 📅 2026-08-19 A modern terminal text editor built with FTXUI, inspired by Nano, Micro, and Sublime Text.
...
* [yazi](https://github.com/sxyazi/yazi) ⭐ 41,528 | 🐛 65 | 🌐 Rust | 📅 2026-08-19 Blazing fast terminal file manager written in Rust, based on async I/O.
* [superfile](https://github.com/MHNightCat/superfile) ⭐ 22,666 | 🐛 257 | 🌐 Go | 📅 2026-08-20 Pretty fancy and modern terminal file manager.
...
* [broot](https://github.com/Canop/broot) ⭐ 12,903 | 🐛 236 | 🌐 Rust | 📅 2026-08-19 A new way to see and navigate directory trees
* [lf](https://github.com/gokcehan/lf) ⭐ 9,465 | 🐛 80 | 🌐 Go | 📅 2026-08-15 A terminal file manager written in Go with heavy inspiration from ranger file manager.
...
* [far2l](https://github.com/elfmz/far2l) ⭐ 2,209 | 🐛 480 | 🌐 C++ | 📅 2026-08-19 Linux port of Far v2 file manager
...
* [rovr](https://github.com/NSPC911/rovr) ⭐ 402 | 🐛 13 | 🌐 Python | 📅 2026-08-20 A post-modern terminal file manager.
...
* [ytreenova](https://github.com/robkam/ytreenova) ⭐ 14 | 🐛 1 | 🌐 C | 📅 2026-08-20 The XTree™ style file manager Unix should have had all along.
...
* [NetHack](https://github.com/NetHack/NetHack) ⭐ 3,872 | 🐛 140 | 🌐 C | 📅 2026-08-20 Dungeon exploration game
...
* [BrogueCE](https://github.com/tmewett/BrogueCE) ⭐ 1,444 | 🐛 205 | 🌐 C | 📅 2026-08-05 Beautiful roguelike dungeon crawler
* [chess-tui](https://github.com/thomas-mauran/chess-tui) ⭐ 1,156 | 🐛 30 | 🌐 Rust | 📅 2026-08-17 Play Chess in your terminal, built in rust
...
* [Rich](https://github.com/willmcgugan/rich) ⭐ 57,099 | 🐛 371 | 🌐 Python | 📅 2026-06-23 is a **Python** library for rich text and beautiful formatting in the terminal.
* [textual](https://github.com/willmcgugan/textual) ⭐ 36,985 | 🐛 353 | 🌐 Python | 📅 2026-07-11 is a TUI (Text User Interface) framework for **Python** inspired by modern web development.
...
* [notcurses](https://github.com/dankamongmen/notcurses) ⭐ 4,668 | 🐛 326 | 🌐 C | 📅 2026-05-18 blingful character graphics/TUI library for **C** and **Python**. definitely not curses.
...
* [blessed](https://github.com/jquast/blessed) ⭐ 1,493 | 🐛 2 | 🌐 Python | 📅 2026-08-07 Blessed is an easy, practical library for making **Python** terminal apps
...
* [bubbletea](https://github.com/charmbracelet/bubbletea) ⭐ 44,464 | 🐛 200 | 🌐 Go | 📅 2026-08-19 A **Go** framework based on Elm to build functional and fun terminal apps
* [tview](https://github.com/rivo/tview/) ⭐ 14,045 | 🐛 94 | 🌐 Go | 📅 2026-08-11 Terminal UI library with rich, interactive widgets — written in **Go**
...
* [tcell](https://github.com/gdamore/tcell) ⭐ 5,214 | 🐛 10 | 🌐 Go | 📅 2026-08-20 Tcell is an alternate **Go** terminal package, similar in some ways to termbox, but better in others.
...
* [libuv](https://github.com/libuv/libuv) ⭐ 27,124 | 🐛 227 | 🌐 C | 📅 2026-08-20 Cross-platform asynchronous I/O library - written in **C**
...
* [FTXUI](https://github.com/ArthurSonzogni/FTXUI) ⭐ 10,575 | 🐛 105 | 🌐 C++ | 📅 2026-08-18 💻 **C++** Functional Terminal User Interface. ❤️
...
* [xtd](https://github.com/gammasoft71/xtd) ⭐ 1,159 | 🐛 98 | 🌐 C++ | 📅 2026-08-19 Free open-source modern **C++** framework to create console (CLI), forms (GUI like WinForms) and unit test (xUnit) applications and libraries on Windows, macOS, Linux, iOS, Android, FreeBSD, and Haiku.
...
* [ASCII\_Board\_Game\_Engine](https://github.com/tjunruh/ASCII_Board_Game_Engine) ⭐ 1 | 🐛 1 | 🌐 C++ | 📅 2026-08-20 A graphics engine for making board games in **C++**
...
* [casciian](https://github.com/crramirez/casciian) ⭐ 50 | 🐛 2 | 🌐 Java | 📅 2026-08-20 A Text User Interface Library for **Java** based on "Jexer" without the AWT/Swing dependencies, tailored for GraalVM AOT native compilation with a focus on performance over remote connections and maximum terminal compatibility.
...
* [Spectre.Console](https://github.com/spectreconsole/spectre.console) ⭐ 11,593 | 🐛 181 | 🌐 C# | 📅 2026-08-17 A **.NET** library for creating beautiful console applications
* [Terminal.Gui](https://github.com/gui-cs/Terminal.Gui) ⭐ 11,178 | 🐛 66 | 🌐 C# | 📅 2026-08-20 Cross-platform terminal UI toolkit for **.NET**
* [Consolonia](https://github.com/jinek/Consolonia) ⭐ 818 | 🐛 56 | 🌐 C# | 📅 2026-08-20 A **.NET** terminal-based GUI framework with support of XAML
* [SharpConsoleUI](https://github.com/nickprotop/ConsoleEx) ⭐ 265 | 🐛 2 | 🌐 C# | 📅 2026-08-20 Multi-window TUI framework for **.NET** with overlapping windows, compositor effects, and Spectre.Console integration
...
* [Ratatui](https://github.com/tui-rs-revival/ratatui) ⭐ 22,288 | 🐛 235 | 🌐 Rust | 📅 2026-08-19 A **Rust** crate for building Terminal UIs (actively maintained fork of tui-rs).
...
* [iocraft](https://github.com/ccbrown/iocraft) ⭐ 1,513 | 🐛 27 | 🌐 Rust | 📅 2026-08-20 **Rust** crate for beautiful, artisanally crafted TUIs and text-based IO, with a declarative, React-like API inspired by Ink.
...
* [ink](https://github.com/vadimdemedes/ink) ⭐ 39,699 | 🐛 38 | 🌐 TypeScript | 📅 2026-08-12 React for **Node.js** interactive command-line apps
* [gum](https://github.com/charmbracelet/gum) ⭐ 24,251 | 🐛 185 | 🌐 Go | 📅 2026-08-20 A tool for glamorous **shell** scripts
* [OpenTUI](https://github.com/sst/opentui) ⭐ 13,103 | 🐛 222 | 🌐 TypeScript | 📅 2026-08-20 A **TypeScript** library for building terminal user interfaces (TUIs)
* [blessed](https://github.com/chjj/blessed) ⭐ 11,882 | 🐛 256 | 🌐 JavaScript | 📅 2024-03-22 A high-level terminal interface library for **Node.js**
  stateful TUI apps.
* [termbox2](https://github.com/termbox/termbox2) ⭐ 752 | 🐛 18 | 🌐 C | 📅 2026-08-11 A terminal rendering library for creating TUIs.
...
* [discordo](https://github.com/ayntgl/discordo) ⭐ 5,735 | 🐛 56 | 🌐 Go | 📅 2026-08-19 A lightweight, secure, and feature-rich Discord terminal client
...
* [nomadnet](https://github.com/markqvist/NomadNet) ⭐ 2,438 | 🐛 0 | 🌐 Python | 📅 2026-05-28 Secure messaging network built on Reticulum
...
* [nchat](https://github.com/d99kris/nchat) ⭐ 1,922 | 🐛 21 | 🌐 C++ | 📅 2026-08-16 Telegram/WhatsApp client
* [gomuks](https://github.com/tulir/gomuks) ⭐ 1,714 | 🐛 74 | 🌐 Go | 📅 2026-08-20 Matrix client
...
* [basalt](https://github.com/erikjuhani/basalt) ⭐ 1,313 | 🐛 44 | 🌐 Rust | 📅 2026-08-18 TUI Application to manage Obsidian vaults and notes directly from the terminal.
* [concord](https://github.com/chojs23/concord) ⭐ 1,241 | 🐛 40 | 🌐 Rust | 📅 2026-08-20 A feature-rich TUI client for Discord
...
* [endcord](https://github.com/mzivic7/endcord) ⭐ 953 | 🐛 2 | 🌐 Python | 📅 2026-08-20 Feature rich Discord TUI client.
...
* [fzf](https://github.com/junegunn/fzf) ⭐ 82,596 | 🐛 328 | 🌐 Go | 📅 2026-08-20 A general-purpose command-line fuzzy finder
* [wttr.in](https://github.com/chubin/wttr.in) ⭐ 30,374 | 🐛 328 | 🌐 Go | 📅 2026-08-02 The right way to check the weather
* [oha](https://github.com/hatoo/oha) ⭐ 10,499 | 🐛 57 | 🌐 Rust | 📅 2026-08-19 HTTP load generator
* [termshark](https://github.com/gcla/termshark) ⭐ 9,958 | 🐛 50 | 🌐 Go | 📅 2024-04-30 Terminal UI for tshark
...
* [gdu](https://github.com/dundee/gdu) ⭐ 5,912 | 🐛 57 | 🌐 Go | 📅 2026-08-18 Fast disk usage analyzer with console interface written in Go
...
* [x-cmd](https://github.com/x-cmd/x-cmd) ⭐ 4,581 | 🐛 92 | 🌐 Awk | 📅 2026-08-14 A vast and interesting collection of tools that can then bootstrap lots of other programs / functions in a consistent and structured way.
* [csvlens](https://github.com/YS-L/csvlens) ⭐ 3,936 | 🐛 58 | 🌐 Rust | 📅 2026-07-04 TUI CSV file viewer. It is like less but made for CSV.
* [cfdisk](https://github.com/util-linux/util-linux) ⭐ 3,207 | 🐛 416 | 🌐 C | 📅 2026-08-20 TUI partition editor included in util-linux
* [diskonaut](https://github.com/imsnif/diskonaut) ⭐ 3,117 | 🐛 45 | 🌐 Rust | 📅 2024-03-07 Terminal disk space navigator
* [bluetui](https://github.com/pythops/bluetui) ⭐ 2,962 | 🐛 21 | 🌐 Rust | 📅 2026-07-17 A TUI for managing bluetooth devices.
...
* [tweakcc](https://github.com/Piebald-AI/tweakcc) ⭐ 2,450 | 🐛 57 | 🌐 TypeScript | 📅 2026-08-20 TUI to customize your Claude Code themes, thinking verbs, and more.
* [Caligula](https://github.com/ifd3f/caligula) ⭐ 2,204 | 🐛 51 | 🌐 Rust | 📅 2026-08-18 A user-friendly, lightweight TUI for imaging disks.
* [smassh](https://github.com/kraanzu/smassh) ⭐ 2,033 | 🐛 11 | 🌐 Python | 📅 2026-08-17 A TUI based typing test application inspired by MonkeyType.
* [recoverpy](https://github.com/PabloLec/recoverpy) ⭐ 1,786 | 🐛 4 | 🌐 Python | 📅 2026-08-03 A TUI to recover overwritten or deleted data.
* [gpg-tui](https://github.com/orhun/gpg-tui) ⭐ 1,754 | 🐛 14 | 🌐 Rust | 📅 2026-08-10 A terminal user interface for GnuPG
...
* [godap](https://github.com/Macmod/godap) ⭐ 971 | 🐛 5 | 🌐 Go | 📅 2026-08-20 A complete TUI for LDAP written in Golang
...
* [mqttui](https://github.com/EdJoPaTo/mqttui) ⭐ 715 | 🐛 10 | 🌐 Rust | 📅 2026-08-09 MQTT Client written in rust
* [pug](https://github.com/leg100/pug) ⭐ 693 | 🐛 21 | 🌐 Go | 📅 2026-01-02 terraform and tofu module and infrastructure management.
* [vortix](https://github.com/Harry-kp/vortix) ⭐ 636 | 🐛 29 | 🌐 Rust | 📅 2026-08-20 Terminal UI for WireGuard and OpenVPN with real-time telemetry, leak detection, and kill switch.
...
* [mac-cleanup-go](https://github.com/2ykwang/mac-cleanup-go) ⭐ 451 | 🐛 6 | 🌐 Go | 📅 2026-08-20 macOS disk cleanup TUI: scan cache/dev artifacts, preview, exclude, and move items to Trash.
...
* [vlc](https://github.com/videolan/vlc) ⭐ 19,390 | 🐛 2 | 🌐 C | 📅 2026-08-20 VLC includes an ncurses interface, `vlc --intf ncurses`
...
* [spotify-player](https://github.com/aome510/spotify-player) ⭐ 7,095 | 🐛 164 | 🌐 Rust | 📅 2026-07-20 A Spotify player in the terminal with full feature parity
* [ncspot](https://github.com/hrkfdn/ncspot) ⭐ 6,732 | 🐛 209 | 🌐 Rust | 📅 2026-08-19 Cross-platform ncurses Spotify client written in Rust
...
* [kew](https://github.com/ravachol/kew) ⭐ 2,983 | 🐛 0 | 🌐 C | 📅 2026-08-20 A terminal music player for Linux
* [timg](https://github.com/hzeller/timg) ⭐ 2,730 | 🐛 36 | 🌐 C++ | 📅 2026-08-05 A terminal image viewer
* [termusic](https://github.com/tramhao/termusic) ⭐ 2,176 | 🐛 49 | 🌐 Rust | 📅 2026-08-17 Music Player TUI written in Rust
* [tdf](https://github.com/itsjunetime/tdf) ⭐ 1,934 | 🐛 41 | 🌐 Rust | 📅 2026-08-16 A tui-based PDF viewer
...
* [spotatui](https://github.com/LargeModGames/spotatui) ⭐ 1,239 | 🐛 27 | 🌐 Rust | 📅 2026-08-20 Spotify client with native streaming, synced lyrics, and real-time audio visualization
* [textual-paint](https://github.com/1j01/textual-paint) ⭐ 1,121 | 🐛 10 | 🌐 Python | 📅 2026-02-21 MS Paint in your terminal
* [bookokrat](https://github.com/bugzmanov/bookokrat) ⭐ 1,099 | 🐛 48 | 🌐 Rust | 📅 2026-08-08 Full-featured EPUB books reader with Vim keybindings.
...
* [wiremix](https://github.com/tsowell/wiremix) ⭐ 1,020 | 🐛 37 | 🌐 Rust | 📅 2026-07-12 TUI audio mixer for PipeWire similar to pavucontrol to adjust volumes, change input/output devices and their profiles
...
* [xytz](https://github.com/xdagiz/xytz) ⭐ 595 | 🐛 10 | 🌐 Go | 📅 2026-08-06 Beautiful TUI for downloading YouTube videos/playlists/channels.
...
* [mpvc](https://github.com/gmt4/mpvc) ⭐ 157 | 🐛 1 | 🌐 Shell | 📅 2026-08-20 A mpc-like control interface for mpv
* [line](https://github.com/pd3v/line) ⭐ 152 | 🐛 0 | 🌐 C++ | 📅 2025-08-11 Tiny command-line midi sequencer and language for live coding
* [Trophy](https://github.com/taigrr/trophy) ⭐ 126 | 🐛 1 | 🌐 Go | 📅 2026-08-20 A TUI 3D Model Viewer for OBJ and GLB files
...
* [tmux](https://github.com/tmux/tmux) ⭐ 48,745 | 🐛 24 | 🌐 C | 📅 2026-08-20 Terminal multiplexer
* [zellij](https://github.com/zellij-org/zellij) ⭐ 35,013 | 🐛 1,858 | 🌐 Rust | 📅 2026-08-20 A terminal workspace with batteries included
* [Glow](https://github.com/charmbracelet/glow) ⭐ 26,971 | 🐛 221 | 🌐 Go | 📅 2026-08-16 A markdown reader, designed from the ground up to showcase the elegance and capabilities of TUI.
* [slides](https://github.com/maaslalani/slides) ⭐ 11,620 | 🐛 77 | 🌐 Go | 📅 2026-07-08 A terminal based presentation tool, supporting markdown syntax.
* [Visidata](https://github.com/saulpw/visidata) ⭐ 9,250 | 🐛 78 | 🌐 Python | 📅 2026-08-15 A terminal spreadsheet multitool for discovering and arranging data
* [presenterm](https://github.com/mfontanini/presenterm) ⭐ 8,783 | 🐛 74 | 🌐 Rust | 📅 2026-05-22 A markdown terminal slideshow tool
...
* [television](https://github.com/alexpasmantier/television) ⭐ 6,186 | 🐛 82 | 🌐 Rust | 📅 2026-08-16 A fast and versatile fuzzy finder TUI
* [sc-im](https://github.com/andmarti1424/sc-im) ⭐ 5,685 | 🐛 118 | 🌐 C | 📅 2026-08-06 An ncurses spreadsheet program for terminal. Reignited version of sc
* [hledger-ui](https://github.com/simonmichael/hledger) ⭐ 4,654 | 🐛 340 | 🌐 Haskell | 📅 2026-08-18 A fast TUI for browsing double entry bookkeeping data
* [LazySSH](https://github.com/adembc/lazyssh) ⭐ 3,889 | 🐛 65 | 🌐 Go | 📅 2025-10-09 TUI SSH manager to browse, connect, and manage servers from ssh config files.
* [doxx](https://github.com/bgreenwell/doxx) ⭐ 3,738 | 🐛 8 | 🌐 Rust | 📅 2026-08-10 A TUI document viewer for Microsoft Word files
* [TUIOS](https://github.com/Gaurav-Gosain/tuios) ⭐ 3,513 | 🐛 16 | 🌐 Go | 📅 2026-08-20 A TUI window manager for managing multiple terminal sessions
* [Tabiew](https://github.com/shshemi/tabiew) ⭐ 3,080 | 🐛 15 | 🌐 Rust | 📅 2026-08-17 A lightweight app to view and query tabular data files, such as CSV, TSV, and parquet.
...
* [calcure](https://github.com/anufrievroman/calcure) ⭐ 2,338 | 🐛 8 | 🌐 Python | 📅 2026-06-17 Modern TUI calendar and task manager with minimal and customizable UI.
...
* [jiratui](https://github.com/whyisdifficult/jiratui) ⭐ 1,678 | 🐛 11 | 🌐 Python | 📅 2026-08-19 A TUI for interacting with Atlassian Jira directly from your shell
...
* [sshm](https://github.com/gu1llaum-3/sshm) ⭐ 1,367 | 🐛 28 | 🌐 Go | 📅 2026-07-27 SSH made easy and fast: browse, connect, and control from your terminal with a modern TUI
...
* [longbridge-terminal](https://github.com/longbridge/longbridge-terminal) ⭐ 986 | 🐛 10 | 🌐 Rust | 📅 2026-08-20 AI-native TUI for Longbridge Securities: real-time quotes, portfolio management, and trading for HK/US/A-share/SG markets.
* [ekphos](https://github.com/hanebox/ekphos) ⭐ 975 | 🐛 7 | 🌐 Rust | 📅 2026-08-16 A fast, lightweight, markdown research tool written in rust
...
* [agent-deck](https://github.com/asheshgoplani/agent-deck) ⭐ 761 | 🐛 53 | 🌐 Go | 📅 2026-08-17 Terminal dashboard for managing multiple AI coding agent sessions
...
* [Tock](https://github.com/kriuchkov/tock) ⭐ 467 | 🐛 4 | 🌐 Go | 📅 2026-08-19 The powerful time tracking tool for the command line with a beautiful interactive TUI.
...
* [kanban](https://github.com/fulsomenko/kanban) ⭐ 156 | 🐛 8 | 🌐 Rust | 📅 2026-08-20 TUI kanban board for projects management with sprint tracking and task prioritization.
...
* [drako](https://github.com/lucky7xz/drako) ⭐ 41 | 🐛 1 | 🌐 Go | 📅 2026-08-19 A grid-based, customizable and extendable command- and TUI-Deck launcher
...
* [tuiserial](https://github.com/Horldsence/tuiserial) ⭐ 26 | 🐛 0 | 🌐 Rust | 📅 2026-08-06 TUI Serial Port Tool for Edge Computing Devices
...
* [weathr](https://github.com/veirt/weathr) ⭐ 3,010 | 🐛 19 | 🌐 Rust | 📅 2026-08-12 A terminal weather app with ASCII animations for weather visualization
* [astroterm](https://github.com/da-luce/astroterm) ⭐ 2,013 | 🐛 38 | 🌐 C | 📅 2026-04-01 A planetarium for your terminal! Explore stars, planets, constellations, and more
...
* [browsh](https://github.com/browsh-org/browsh) ⭐ 18,990 | 🐛 241 | 🌐 JavaScript | 📅 2025-07-11 A fully-modern text-based browser, rendering to TTY and browsers
* [rtorrent](https://github.com/rakshasa/rtorrent) ⭐ 4,844 | 🐛 400 | 🌐 C++ | 📅 2026-08-19 A text-based BitTorrent client written in C++
...
* [newsboat](https://github.com/newsboat/newsboat) ⭐ 3,886 | 🐛 409 | 🌐 C++ | 📅 2026-08-15 An RSS/Atom feed reader for the text console
* [surge](https://github.com/surge-downloader/surge) ⭐ 3,472 | 🐛 49 | 🌐 Go | 📅 2026-08-20 A blazing fast, beautiful TUI download manager built in Go.
* [textual-web](https://github.com/Textualize/textual-web) ⭐ 1,445 | 🐛 23 | 🌐 Python | 📅 2024-08-30 Run TUIs and terminals in your browser
* [Slumber](https://github.com/LucasPickering/slumber) ⭐ 1,215 | 🐛 9 | 🌐 Rust | 📅 2026-07-04 Terminal-based HTTP/REST client
* [w3m](https://github.com/tats/w3m) ⭐ 1,075 | 🐛 79 | 🌐 C | 📅 2024-08-19 A text-mode WWW browser
* [cloudflare-speed-cli](https://github.com/kavehtehrani/cloudflare-speed-cli) ⭐ 990 | 🐛 0 | 🌐 Rust | 📅 2026-07-27 Internet speed test via Cloudflare
...
* [elinks](https://github.com/rkd77/elinks) ⭐ 630 | 🐛 121 | 🌐 C | 📅 2026-08-19 ELinks (HTTP/FTP/..) brower with mujs javascript support.

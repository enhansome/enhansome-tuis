...
There's a lot of cool projects here that I have no association with. Run them at your own risk. If you have a cool tool you'd like to share please [open a PR](https://github.com/rothgar/awesome-tuis/pulls) ⭐ 20,428 | 🐛 99 | 📅 2026-08-11.
...
* [btop++](https://github.com/aristocratos/btop) ⭐ 34,360 | 🐛 530 | 🌐 C++ | 📅 2026-09-01 Resource monitor with extras
* [Glances](https://github.com/nicolargo/glances) ⭐ 33,499 | 🐛 102 | 🌐 Python | 📅 2026-08-30 Glances an Eye on your system. A top/htop alternative.
* [Goaccess](https://github.com/allinurl/goaccess) ⭐ 20,890 | 🐛 449 | 🌐 C | 📅 2026-08-31 GoAccess is a real-time web log analyzer and interactive viewer that runs in a terminal in nix systems or through your browser.
* [WTF](https://github.com/senorprogrammer/wtf) ⭐ 17,070 | 🐛 103 | 🌐 Go | 📅 2026-08-05 The personal information dashboard for your terminal.
* [bottom](https://github.com/ClementTsang/bottom) ⭐ 13,964 | 🐛 106 | 🌐 Rust | 📅 2026-09-01 A customizable graphical process/system monitor for the terminal.
...
* [gh-dash](https://github.com/dlvhdr/gh-dash) ⭐ 12,451 | 🐛 99 | 🌐 Go | 📅 2026-08-01 A rich terminal UI for GitHub PRs and Issues
* [bandwhich](https://github.com/imsnif/bandwhich) ⭐ 11,943 | 🐛 55 | 🌐 Rust | 📅 2026-08-01 Terminal bandwidth utilization tool
* [bashtop](https://github.com/aristocratos/bashtop) ⭐ 11,119 | 🐛 64 | 🌐 Shell | 📅 2023-08-21 Resource manager written in bash
* [talos linux](https://github.com/siderolabs/talos) ⭐ 11,066 | 🐛 226 | 🌐 Go | 📅 2026-09-01 A Linux distro with a TUI dashboard for local and remote usage
...
* [htop](https://github.com/htop-dev/htop) ⭐ 8,299 | 🐛 360 | 🌐 C | 📅 2026-08-30 Interactive text-mode process viewer for Unix systems. It aims to be a better 'top'
...
* [trippy](https://github.com/fujiapple852/trippy) ⭐ 7,769 | 🐛 80 | 🌐 Rust | 📅 2026-09-01 A network diagnostic tool that includes functionality like mtr and more
* [Backlog.md](https://github.com/MrLesk/Backlog.md) ⭐ 6,602 | 🐛 35 | 🌐 TypeScript | 📅 2026-09-01 A tool for managing project collaboration between humans and AI Agents in a git ecosystem
...
* [rustnet](https://github.com/domcyrus/rustnet) ⭐ 4,982 | 🐛 17 | 🌐 Rust | 📅 2026-09-01 A cross-platform network monitoring tool with deep packet inspection
...
* [psmux](https://github.com/marlocarlo/psmux) ⭐ 3,401 | 🐛 34 | 🌐 PowerShell | 📅 2026-09-01 tmux-compatible terminal multiplexer for Windows built in Rust with ratatui.
...
* [gonzo](https://github.com/control-theory/gonzo) ⭐ 2,761 | 🐛 18 | 🌐 Go | 📅 2026-07-15 A powerful, real-time log analysis terminal UI inspired by k9s.
* [process-compose](https://github.com/F1bonacc1/process-compose) ⭐ 2,741 | 🐛 16 | 🌐 Go | 📅 2026-08-29 TUI for running apps and processes
...
* [netscanner](https://github.com/Chleba/netscanner) ⭐ 1,831 | 🐛 6 | 🌐 Rust | 📅 2026-07-06 Network scanner
...
* [bmon](https://github.com/tgraf/bmon) ⭐ 1,386 | 🐛 38 | 🌐 C | 📅 2026-08-24 A monitoring and debugging tool to capture networking related statistics and prepare them visually.
...
* [kaskade](https://github.com/sauljabin/kaskade) ⭐ 1,024 | 🐛 7 | 🌐 Python | 📅 2026-09-01 TUI for kafka, which allows you to interact and consume topics from your terminal in style!
...
* [opencode](https://github.com/sst/opencode) ⭐ 203,055 | 🐛 5,648 | 🌐 TypeScript | 📅 2026-09-01 AI coding agent, built for the terminal
* [codex](https://github.com/openai/codex) ⭐ 120,683 | 🐛 14,788 | 🌐 Rust | 📅 2026-09-01 Lightweight coding agent that runs in your terminal
* [lazygit](https://github.com/jesseduffield/lazygit) ⭐ 81,864 | 🐛 1,027 | 🌐 Go | 📅 2026-08-31 Simple terminal UI for git commands
* [delta](https://github.com/dandavison/delta) ⭐ 32,057 | 🐛 434 | 🌐 Rust | 📅 2026-08-02 A syntax-highlighting pager for git, diff, and grep output
* [crush](https://github.com/charmbracelet/crush) ⭐ 27,853 | 🐛 679 | 🌐 Go | 📅 2026-09-01 The glamourous AI coding agent
* [gitui](https://github.com/extrawurst/gitui) ⭐ 22,454 | 🐛 342 | 🌐 Rust | 📅 2026-08-04 blazing fast terminal-ui for git written in rust
...
* [posting](https://github.com/darrenburns/posting) ⭐ 12,345 | 🐛 83 | 🌐 Python | 📅 2026-03-25 A powerful HTTP client that lives in your terminal
* [Claude Code Usage Monitor](https://github.com/Maciek-roboblog/Claude-Code-Usage-Monitor) ⭐ 8,668 | 🐛 37 | 🌐 Python | 📅 2026-07-05 Monitor Claude token usage
...
* [harlequin](https://github.com/tconbeer/harlequin) ⭐ 6,364 | 🐛 45 | 🌐 Python | 📅 2026-09-01 The SQL IDE for Your Terminal
...
* [sqlit](https://github.com/Maxteabag/sqlit) ⭐ 4,758 | 🐛 17 | 🌐 Python | 📅 2026-08-27 A lightweight TUI for SQL databases inspired by lazygit
* [lazysql](https://github.com/jorgerojas26/lazysql) ⭐ 4,256 | 🐛 48 | 🌐 Go | 📅 2026-08-22 A cross-platform TUI database management tool written in Go.
...
* [Claude Code Bridge](https://github.com/bfly123/claude_code_bridge) ⭐ 3,468 | 🐛 99 | 🌐 Python | 📅 2026-09-01 Real-time multi-AI collaboration between Claude, Codex and Gemini in terminal
* [Toad](https://github.com/batrachianai/toad) ⭐ 3,414 | 🐛 6 | 🌐 Python | 📅 2026-05-26 A unified interface for AI
* [pudb](https://github.com/inducer/pudb) ⭐ 3,248 | 🐛 164 | 🌐 Python | 📅 2026-08-28 A console-based visual debugger for Python
* [dblab](https://github.com/danvergara/dblab) ⭐ 3,197 | 🐛 14 | 🌐 Go | 📅 2026-09-01 The database client every command line junkie deserves
...
* [runme](https://github.com/stateful/runme) ⭐ 2,159 | 🐛 163 | 🌐 Go | 📅 2026-09-01 Discover and run code snippets directly from your README.md or other markdowns
* [serie](https://github.com/lusingander/serie) ⭐ 2,072 | 🐛 23 | 🌐 Rust | 📅 2026-08-21 A rich git commit graph
* [resterm](https://github.com/unkn0wn-root/resterm) ⭐ 1,896 | 🐛 0 | 🌐 Go | 📅 2026-08-31 A terminal client for HTTP/GraphQL/gRPC with support for WebSockets, SSE, workflows, profiling, OpenAPI and response diffs.
...
* [VT Code](https://github.com/vinhnx/vtcode) ⭐ 826 | 🐛 0 | 🌐 Rust | 📅 2026-09-01 VT Code - Semantic Coding Agent
...
* [models](https://github.com/arimxyer/models) ⭐ 504 | 🐛 0 | 🌐 Rust | 📅 2026-09-01 TUI for browsing AI models and coding agents
...
* [hcom](https://github.com/aannoo/hcom) ⭐ 469 | 🐛 35 | 🌐 Rust | 📅 2026-08-09 CLI and TUI for real-time messaging, observation, and orchestration between AI coding agents (Claude Code, Antigravity, Codex, OpenCode, Kilo, Cursor) across terminals
...
* [ghcup](https://github.com/haskell/ghcup-hs) ⭐ 355 | 🐛 210 | 🌐 Haskell | 📅 2026-08-20 An installer for the Haskell toolchain
...
* [sabiql](https://github.com/riii111/sabiql) ⭐ 263 | 🐛 5 | 🌐 Rust | 📅 2026-09-01 A fast, driver-less TUI to browse, query, and edit PostgreSQL databases, written in Rust
...
* [fast-resume](https://github.com/angristan/fast-resume) ⭐ 154 | 🐛 16 | 🌐 Rust | 📅 2026-08-27 Index and fuzzy search coding agent sessions
...
* [sot](https://github.com/anistark/sot) ⭐ 58 | 🐛 6 | 🌐 Python | 📅 2026-08-06 A top like system observability tool written in python
* [differ](https://github.com/JanSmrcka/differ) ⭐ 53 | 🐛 12 | 🌐 Go | 📅 2026-07-08 A TUI git diff viewer
* [tokui](https://github.com/zdyxry/tokui) ⭐ 52 | 🐛 0 | 🌐 Go | 📅 2026-07-30 An interactive TUI for visualizing code statistics from tokei.
* [qrypad](https://github.com/wheelibin/qrypad) ⭐ 43 | 🐛 1 | 🌐 Go | 📅 2026-09-01 A terminal SQL client for Postgres, MySQL and SQLite.
...
* [lazydocker](https://github.com/jesseduffield/lazydocker) ⭐ 52,693 | 🐛 297 | 🌐 Go | 📅 2026-04-19 The lazier way to manage everything docker
* [k9s](https://github.com/derailed/k9s) ⭐ 34,485 | 🐛 91 | 🌐 Go | 📅 2026-09-01 TUI for managing a Kubernetes cluster
...
* [kftui](https://github.com/hcavarsan/kftray) ⭐ 1,555 | 🐛 19 | 🌐 Rust | 📅 2026-09-01 A TUI to manage multiple kubectl port-forward commands, with support for UDP and K8s proxy.
* [dtop](https://github.com/amir20/dtop) ⭐ 1,366 | 🐛 1 | 🌐 Rust | 📅 2026-08-30 Terminal dashboard for Docker monitoring across multiple hosts
* [Podman-tui](https://github.com/containers/podman-tui) ⭐ 1,213 | 🐛 6 | 🌐 Go | 📅 2026-08-30 TUI for Podman containers
...
* [e1s](https://github.com/keidarcy/e1s) ⭐ 920 | 🐛 9 | 🌐 Go | 📅 2026-09-01 TUI for managing AWS ECS resources
...
* [d4s](https://github.com/jr-k/d4s) ⭐ 126 | 🐛 0 | 🌐 Go | 📅 2026-08-28 A fast, keyboard-driven terminal UI to manage Docker containers, Compose stacks, and Swarm services with the ergonomics of K9s
...
* [micro](https://github.com/zyedidia/micro) ⭐ 29,492 | 🐛 971 | 🌐 Go | 📅 2026-09-01 A modern and intuitive terminal-based text editor
* [Edit](https://github.com/microsoft/edit) ⭐ 14,531 | 🐛 173 | 🌐 Rust | 📅 2026-08-27 A simple text editor. Pays homage to the classic MS-DOS Editor.
* [kilo](https://github.com/antirez/kilo) ⭐ 9,103 | 🐛 63 | 🌐 C | 📅 2025-01-04 A minimal but complete editor in \~1000 lines of C code.
* [Fresh](https://github.com/sinelaw/fresh) ⭐ 8,620 | 🐛 329 | 🌐 Rust | 📅 2026-09-01 An easy-to-use, powerful and fast terminal-based text editor.
...
* [frogmouth](https://github.com/Textualize/frogmouth) ⭐ 3,276 | 🐛 46 | 🌐 Python | 📅 2024-08-01 A Markdown browser for your terminal
* [flow-control](https://github.com/neurocyte/flow) ⭐ 2,200 | 🐛 78 | 🌐 Zig | 📅 2026-08-29 A lightning-fast, feature-rich text editor written in Zig
...
* [nino](https://github.com/evanlin96069/nino) ⭐ 95 | 🐛 9 | 🌐 C | 📅 2026-09-01 A small terminal-based text editor written in C.
...
* [yazi](https://github.com/sxyazi/yazi) ⭐ 41,862 | 🐛 66 | 🌐 Rust | 📅 2026-09-01 Blazing fast terminal file manager written in Rust, based on async I/O.
* [superfile](https://github.com/MHNightCat/superfile) ⭐ 23,032 | 🐛 263 | 🌐 Go | 📅 2026-08-30 Pretty fancy and modern terminal file manager.
* [nnn](https://github.com/jarun/nnn) ⭐ 21,855 | 🐛 4 | 🌐 C | 📅 2026-09-01 n³ The unorthodox terminal file manager.
* [ranger](https://github.com/ranger/ranger) ⭐ 17,383 | 🐛 897 | 🌐 Python | 📅 2026-08-31 A VIM-inspired file manager for the console.
* [broot](https://github.com/Canop/broot) ⭐ 12,925 | 🐛 230 | 🌐 Rust | 📅 2026-09-01 A new way to see and navigate directory trees
...
* [Vifm](https://github.com/vifm/vifm) ⭐ 3,260 | 🐛 144 | 🌐 C | 📅 2026-08-30 A TUI file manager with vi-keybindings and other vim like behaviour.
* [far2l](https://github.com/elfmz/far2l) ⭐ 2,211 | 🐛 471 | 🌐 C++ | 📅 2026-09-01 Linux port of Far v2 file manager
* [mc](https://github.com/MidnightCommander/mc) ⭐ 967 | 🐛 686 | 🌐 C | 📅 2026-08-30 GNU Midnight Commander. A free cross-platform orthodox file manager.
...
* [rovr](https://github.com/NSPC911/rovr) ⭐ 407 | 🐛 7 | 🌐 Python | 📅 2026-09-01 A post-modern terminal file manager.
...
* [ytreenova](https://github.com/robkam/ytreenova) ⭐ 14 | 🐛 1 | 🌐 C | 📅 2026-09-01 The XTree™ style file manager Unix should have had all along.
...
* [NetHack](https://github.com/NetHack/NetHack) ⭐ 3,889 | 🐛 143 | 🌐 C | 📅 2026-08-31 Dungeon exploration game
...
* [Rich](https://github.com/willmcgugan/rich) ⭐ 57,298 | 🐛 372 | 🌐 Python | 📅 2026-06-23 is a **Python** library for rich text and beautiful formatting in the terminal.
* [textual](https://github.com/willmcgugan/textual) ⭐ 37,110 | 🐛 354 | 🌐 Python | 📅 2026-07-11 is a TUI (Text User Interface) framework for **Python** inspired by modern web development.
...
* [urwid](https://github.com/urwid/urwid) ⭐ 3,017 | 🐛 136 | 🌐 Python | 📅 2026-09-01 A console user interface library for **Python** on Linux, OSX, Cygwin or other unix-like OS.
...
* [bubbletea](https://github.com/charmbracelet/bubbletea) ⭐ 44,743 | 🐛 207 | 🌐 Go | 📅 2026-09-01 A **Go** framework based on Elm to build functional and fun terminal apps
* [tview](https://github.com/rivo/tview/) ⭐ 14,074 | 🐛 95 | 🌐 Go | 📅 2026-08-11 Terminal UI library with rich, interactive widgets — written in **Go**
...
* [libuv](https://github.com/libuv/libuv) ⭐ 27,148 | 🐛 236 | 🌐 C | 📅 2026-09-01 Cross-platform asynchronous I/O library - written in **C**
...
* [FTXUI](https://github.com/ArthurSonzogni/FTXUI) ⭐ 10,625 | 🐛 99 | 🌐 C++ | 📅 2026-08-23 💻 **C++** Functional Terminal User Interface. ❤️
...
* [tvision](https://github.com/magiblot/tvision) ⭐ 3,143 | 🐛 42 | 🌐 C++ | 📅 2026-09-01 A modern port of **C++** Turbo Vision 2.0, cross-platform and Unicode support.
...
* [xtd](https://github.com/gammasoft71/xtd) ⭐ 1,160 | 🐛 98 | 🌐 C++ | 📅 2026-09-01 Free open-source modern **C++** framework to create console (CLI), forms (GUI like WinForms) and unit test (xUnit) applications and libraries on Windows, macOS, Linux, iOS, Android, FreeBSD, and Haiku.
...
* [Spectre.Console](https://github.com/spectreconsole/spectre.console) ⭐ 11,604 | 🐛 178 | 🌐 C# | 📅 2026-08-30 A **.NET** library for creating beautiful console applications
* [Terminal.Gui](https://github.com/gui-cs/Terminal.Gui) ⭐ 11,196 | 🐛 52 | 🌐 C# | 📅 2026-08-27 Cross-platform terminal UI toolkit for **.NET**
...
* [Hex1b](https://github.com/mitchdenny/hex1b) ⭐ 173 | 🐛 101 | 🌐 C# | 📅 2026-09-01 A **.NET** library for building rich, interactive TUIs with a React-inspired declarative API
...
* [Ratatui](https://github.com/tui-rs-revival/ratatui) ⭐ 22,471 | 🐛 226 | 🌐 Rust | 📅 2026-08-31 A **Rust** crate for building Terminal UIs (actively maintained fork of tui-rs).
...
* [iocraft](https://github.com/ccbrown/iocraft) ⭐ 1,530 | 🐛 28 | 🌐 Rust | 📅 2026-08-20 **Rust** crate for beautiful, artisanally crafted TUIs and text-based IO, with a declarative, React-like API inspired by Ink.
...
* [ink](https://github.com/vadimdemedes/ink) ⭐ 39,768 | 🐛 32 | 🌐 TypeScript | 📅 2026-08-25 React for **Node.js** interactive command-line apps
* [gum](https://github.com/charmbracelet/gum) ⭐ 24,324 | 🐛 201 | 🌐 Go | 📅 2026-09-01 A tool for glamorous **shell** scripts
* [OpenTUI](https://github.com/sst/opentui) ⭐ 13,205 | 🐛 136 | 🌐 TypeScript | 📅 2026-09-01 A **TypeScript** library for building terminal user interfaces (TUIs)
...
* [discordo](https://github.com/ayntgl/discordo) ⭐ 5,753 | 🐛 54 | 🌐 Go | 📅 2026-09-01 A lightweight, secure, and feature-rich Discord terminal client
...
* [instagram-cli](https://github.com/supreme-gg-gg/instagram-cli) ⭐ 2,128 | 🐛 42 | 🌐 TypeScript | 📅 2026-08-22 Use Instagram from your terminal, the end of brainrot is here
* [nchat](https://github.com/d99kris/nchat) ⭐ 1,931 | 🐛 14 | 🌐 C++ | 📅 2026-08-30 Telegram/WhatsApp client
* [gomuks](https://github.com/tulir/gomuks) ⭐ 1,720 | 🐛 73 | 🌐 Go | 📅 2026-09-01 Matrix client
* [gurk-rs](https://github.com/boxdot/gurk-rs) ⭐ 1,368 | 🐛 100 | 🌐 Rust | 📅 2026-07-29 Signal Messenger client for terminal
* [basalt](https://github.com/erikjuhani/basalt) ⭐ 1,331 | 🐛 44 | 🌐 Rust | 📅 2026-09-01 TUI Application to manage Obsidian vaults and notes directly from the terminal.
* [toot](https://github.com/ihabunek/toot) ⭐ 1,324 | 🐛 128 | 🌐 Python | 📅 2026-07-04 Mastodon CLI & TUI
* [concord](https://github.com/chojs23/concord) ⭐ 1,296 | 🐛 42 | 🌐 Rust | 📅 2026-09-01 A feature-rich TUI client for Discord
* [matterhorn](https://github.com/matterhorn-chat/matterhorn) ⭐ 1,152 | 🐛 22 | 🌐 Haskell | 📅 2026-08-25 A Mattermost terminal client.
* [matcha](https://github.com/floatpane/matcha) ⭐ 1,079 | 🐛 76 | 🌐 Go | 📅 2026-08-31 Email client
...
* [nostui](https://github.com/akiomik/nostui) ⭐ 69 | 🐛 3 | 🌐 Rust | 📅 2026-08-31 Nostr client
...
* [fzf](https://github.com/junegunn/fzf) ⭐ 82,770 | 🐛 327 | 🌐 Go | 📅 2026-08-31 A general-purpose command-line fuzzy finder
* [wttr.in](https://github.com/chubin/wttr.in) ⭐ 30,472 | 🐛 330 | 🌐 Go | 📅 2026-08-02 The right way to check the weather
* [oha](https://github.com/hatoo/oha) ⭐ 10,521 | 🐛 57 | 🌐 Rust | 📅 2026-08-23 HTTP load generator
* [termshark](https://github.com/gcla/termshark) ⭐ 9,984 | 🐛 51 | 🌐 Go | 📅 2024-04-30 Terminal UI for tshark
* [mapscii](https://github.com/rastapasta/mapscii) ⭐ 9,233 | 🐛 52 | 🌐 JavaScript | 📅 2024-11-03 Braille & ASCII world map renderer for your console
* [wego](https://github.com/schachmat/wego) ⭐ 8,545 | 🐛 16 | 🌐 Go | 📅 2026-08-01 Weather app
* [term.everything](https://github.com/mmulet/term.everything) ⭐ 8,087 | 🐛 10 | 🌐 Go | 📅 2026-03-18 Run any GUI app in the terminal
* [cava](https://github.com/karlstav/cava) ⭐ 6,388 | 🐛 18 | 🌐 C | 📅 2026-08-18 Cross-platform Audio Visualizer
* [gdu](https://github.com/dundee/gdu) ⭐ 5,950 | 🐛 57 | 🌐 Go | 📅 2026-09-01 Fast disk usage analyzer with console interface written in Go
...
* [x-cmd](https://github.com/x-cmd/x-cmd) ⭐ 4,629 | 🐛 98 | 🌐 Awk | 📅 2026-09-01 A vast and interesting collection of tools that can then bootstrap lots of other programs / functions in a consistent and structured way.
* [csvlens](https://github.com/YS-L/csvlens) ⭐ 3,949 | 🐛 59 | 🌐 Rust | 📅 2026-07-04 TUI CSV file viewer. It is like less but made for CSV.
* [cfdisk](https://github.com/util-linux/util-linux) ⭐ 3,219 | 🐛 421 | 🌐 C | 📅 2026-09-01 TUI partition editor included in util-linux
...
* [impala](https://github.com/pythops/impala) ⭐ 2,823 | 🐛 0 | 🌐 Rust | 📅 2026-08-27 TUI for managing wifi
* [tweakcc](https://github.com/Piebald-AI/tweakcc) ⭐ 2,476 | 🐛 57 | 🌐 TypeScript | 📅 2026-09-01 TUI to customize your Claude Code themes, thinking verbs, and more.
* [Caligula](https://github.com/ifd3f/caligula) ⭐ 2,283 | 🐛 52 | 🌐 Rust | 📅 2026-08-27 A user-friendly, lightweight TUI for imaging disks.
...
* [bluetuith](https://github.com/darkhz/bluetuith) ⭐ 1,394 | 🐛 11 | 🌐 Go | 📅 2026-07-01 A TUI-based bluetooth connection manager, which can interact with bluetooth adapters and devices.
...
* [godap](https://github.com/Macmod/godap) ⭐ 976 | 🐛 5 | 🌐 Go | 📅 2026-08-21 A complete TUI for LDAP written in Golang
...
* [golazo](https://github.com/0xjuanma/golazo) ⭐ 841 | 🐛 7 | 🌐 Go | 📅 2026-08-31 Get soccer minute-by-minute updates and finished match stats in your terminal
...
* [vortix](https://github.com/Harry-kp/vortix) ⭐ 645 | 🐛 24 | 🌐 Rust | 📅 2026-09-01 Terminal UI for WireGuard and OpenVPN with real-time telemetry, leak detection, and kill switch.
...
* [vlc](https://github.com/videolan/vlc) ⭐ 19,506 | 🐛 2 | 🌐 C | 📅 2026-09-01 VLC includes an ncurses interface, `vlc --intf ncurses`
...
* [spotify-player](https://github.com/aome510/spotify-player) ⭐ 7,161 | 🐛 174 | 🌐 Rust | 📅 2026-07-20 A Spotify player in the terminal with full feature parity
* [ncspot](https://github.com/hrkfdn/ncspot) ⭐ 6,750 | 🐛 210 | 🌐 Rust | 📅 2026-08-31 Cross-platform ncurses Spotify client written in Rust
...
* [kew](https://github.com/ravachol/kew) ⭐ 3,011 | 🐛 3 | 🌐 C | 📅 2026-09-01 A terminal music player for Linux
* [timg](https://github.com/hzeller/timg) ⭐ 2,741 | 🐛 36 | 🌐 C++ | 📅 2026-08-05 A terminal image viewer
* [termusic](https://github.com/tramhao/termusic) ⭐ 2,186 | 🐛 53 | 🌐 Rust | 📅 2026-09-01 Music Player TUI written in Rust
* [tdf](https://github.com/itsjunetime/tdf) ⭐ 1,954 | 🐛 41 | 🌐 Rust | 📅 2026-08-16 A tui-based PDF viewer
...
* [spotatui](https://github.com/LargeModGames/spotatui) ⭐ 1,295 | 🐛 35 | 🌐 Rust | 📅 2026-09-01 Spotify client with native streaming, synced lyrics, and real-time audio visualization
* [textual-paint](https://github.com/1j01/textual-paint) ⭐ 1,122 | 🐛 10 | 🌐 Python | 📅 2026-02-21 MS Paint in your terminal
* [bookokrat](https://github.com/bugzmanov/bookokrat) ⭐ 1,118 | 🐛 45 | 📅 2026-08-30 Full-featured EPUB books reader with Vim keybindings.
...
* [fancy-cat](https://github.com/freref/fancy-cat) ⭐ 559 | 🐛 20 | 🌐 Zig | 📅 2026-08-03 A Lightweight terminal-based PDF reader with Vim keybindings
...
* [waves](https://github.com/llehouerou/waves) ⭐ 170 | 🐛 4 | 🌐 Go | 📅 2026-06-18 Terminal music player with vim-style navigation and radio mode that plays similar artists from your library
...
* [tmux](https://github.com/tmux/tmux) ⭐ 48,967 | 🐛 32 | 🌐 C | 📅 2026-09-01 Terminal multiplexer
* [zellij](https://github.com/zellij-org/zellij) ⭐ 35,235 | 🐛 1,884 | 🌐 Rust | 📅 2026-08-31 A terminal workspace with batteries included
* [Glow](https://github.com/charmbracelet/glow) ⭐ 27,154 | 🐛 229 | 🌐 Go | 📅 2026-09-01 A markdown reader, designed from the ground up to showcase the elegance and capabilities of TUI.
* [slides](https://github.com/maaslalani/slides) ⭐ 11,643 | 🐛 77 | 🌐 Go | 📅 2026-07-08 A terminal based presentation tool, supporting markdown syntax.
* [Visidata](https://github.com/saulpw/visidata) ⭐ 9,261 | 🐛 80 | 🌐 Python | 📅 2026-08-28 A terminal spreadsheet multitool for discovering and arranging data
* [presenterm](https://github.com/mfontanini/presenterm) ⭐ 8,807 | 🐛 77 | 🌐 Rust | 📅 2026-05-22 A markdown terminal slideshow tool
...
* [television](https://github.com/alexpasmantier/television) ⭐ 6,228 | 🐛 83 | 🌐 Rust | 📅 2026-09-01 A fast and versatile fuzzy finder TUI
...
* [hledger-ui](https://github.com/simonmichael/hledger) ⭐ 4,686 | 🐛 349 | 🌐 Haskell | 📅 2026-09-01 A fast TUI for browsing double entry bookkeeping data
* [LazySSH](https://github.com/adembc/lazyssh) ⭐ 3,907 | 🐛 66 | 🌐 Go | 📅 2025-10-09 TUI SSH manager to browse, connect, and manage servers from ssh config files.
* [doxx](https://github.com/bgreenwell/doxx) ⭐ 3,744 | 🐛 8 | 🌐 Rust | 📅 2026-08-10 A TUI document viewer for Microsoft Word files
* [TUIOS](https://github.com/Gaurav-Gosain/tuios) ⭐ 3,589 | 🐛 19 | 🌐 Go | 📅 2026-09-01 A TUI window manager for managing multiple terminal sessions
* [Tabiew](https://github.com/shshemi/tabiew) ⭐ 3,092 | 🐛 15 | 🌐 Rust | 📅 2026-09-01 A lightweight app to view and query tabular data files, such as CSV, TSV, and parquet.
* [termscp](https://github.com/veeso/termscp) ⭐ 3,062 | 🐛 4 | 🌐 Rust | 📅 2026-09-01 A TUI file transfer and explorer, with support for SCP/SFTP/FTP/S3.
* [khal](https://github.com/pimutils/khal) ⭐ 3,046 | 🐛 260 | 🌐 Python | 📅 2026-08-31 A standards based CLI calendar program, able to synchronize with CalDAV servers
* [Bagels](https://github.com/EnhancedJax/Bagels) ⭐ 2,891 | 🐛 18 | 🌐 Python | 📅 2025-07-06 TUI expense tracker
...
* [jiratui](https://github.com/whyisdifficult/jiratui) ⭐ 1,686 | 🐛 11 | 🌐 Python | 📅 2026-08-28 A TUI for interacting with Atlassian Jira directly from your shell
...
* [sshm](https://github.com/gu1llaum-3/sshm) ⭐ 1,375 | 🐛 30 | 🌐 Go | 📅 2026-07-27 SSH made easy and fast: browse, connect, and control from your terminal with a modern TUI
...
* [clipse](https://github.com/savedra1/clipse) ⭐ 1,034 | 🐛 45 | 🌐 Go | 📅 2026-06-09 TUI-based clipboard manager application
...
* [agent-deck](https://github.com/asheshgoplani/agent-deck) ⭐ 823 | 🐛 49 | 🌐 Go | 📅 2026-08-31 Terminal dashboard for managing multiple AI coding agent sessions
...
* [kanban](https://github.com/fulsomenko/kanban) ⭐ 165 | 🐛 8 | 🌐 Rust | 📅 2026-09-01 TUI kanban board for projects management with sprint tracking and task prioritization.
...
* [ekphos](https://github.com/hanebox/ekphos) ⭐ 0 | 🐛 0 | 📅 2026-09-01 A fast, lightweight, markdown research tool written in rust
...
* [gitlogue](https://github.com/unhappychoice/gitlogue) ⭐ 4,948 | 🐛 13 | 🌐 Rust | 📅 2026-08-31 A TUI screensaver that visualizes Git commit history in your terminal
* [weathr](https://github.com/veirt/weathr) ⭐ 3,039 | 🐛 20 | 🌐 Rust | 📅 2026-08-12 A terminal weather app with ASCII animations for weather visualization
...
* [rtorrent](https://github.com/rakshasa/rtorrent) ⭐ 4,855 | 🐛 397 | 🌐 C++ | 📅 2026-09-01 A text-based BitTorrent client written in C++
...
* [newsboat](https://github.com/newsboat/newsboat) ⭐ 3,891 | 🐛 409 | 🌐 C++ | 📅 2026-09-01 An RSS/Atom feed reader for the text console
* [surge](https://github.com/surge-downloader/surge) ⭐ 3,498 | 🐛 55 | 🌐 Go | 📅 2026-08-31 A blazing fast, beautiful TUI download manager built in Go.
* [textual-web](https://github.com/Textualize/textual-web) ⭐ 1,462 | 🐛 23 | 🌐 Python | 📅 2024-08-30 Run TUIs and terminals in your browser
* [Slumber](https://github.com/LucasPickering/slumber) ⭐ 1,224 | 🐛 9 | 🌐 Rust | 📅 2026-09-01 Terminal-based HTTP/REST client
* [w3m](https://github.com/tats/w3m) ⭐ 1,077 | 🐛 79 | 🌐 C | 📅 2024-08-19 A text-mode WWW browser
* [cloudflare-speed-cli](https://github.com/kavehtehrani/cloudflare-speed-cli) ⭐ 1,018 | 🐛 0 | 🌐 Rust | 📅 2026-07-27 Internet speed test via Cloudflare
* [eilmeldung](https://github.com/christo-auer/eilmeldung) ⭐ 962 | 🐛 0 | 🌐 Rust | 📅 2026-09-01 RSS reader, supporting many RSS providers, bulk-operations and configuration options.

...
There's a lot of cool projects here that I have no association with. Run them at your own risk. If you have a cool tool you'd like to share please [open a PR](https://github.com/rothgar/awesome-tuis/pulls) ⭐ 20,312 | 🐛 83 | 📅 2026-08-11.
...
* [btop++](https://github.com/aristocratos/btop) ⭐ 34,201 | 🐛 528 | 🌐 C++ | 📅 2026-08-23 Resource monitor with extras
* [Glances](https://github.com/nicolargo/glances) ⭐ 33,421 | 🐛 109 | 🌐 Python | 📅 2026-08-23 Glances an Eye on your system. A top/htop alternative.
...
* [bottom](https://github.com/ClementTsang/bottom) ⭐ 13,925 | 🐛 109 | 🌐 Rust | 📅 2026-08-24 A customizable graphical process/system monitor for the terminal.
...
* [gh-dash](https://github.com/dlvhdr/gh-dash) ⭐ 12,388 | 🐛 98 | 🌐 Go | 📅 2026-08-01 A rich terminal UI for GitHub PRs and Issues
...
* [talos linux](https://github.com/siderolabs/talos) ⭐ 11,009 | 🐛 214 | 🌐 Go | 📅 2026-08-24 A Linux distro with a TUI dashboard for local and remote usage
* [nvtop](https://github.com/Syllo/nvtop) ⭐ 10,938 | 🐛 146 | 🌐 C | 📅 2026-05-06 GPUs process monitoring for AMD, Intel and NVIDIA
...
* [htop](https://github.com/htop-dev/htop) ⭐ 8,280 | 🐛 353 | 🌐 C | 📅 2026-08-24 Interactive text-mode process viewer for Unix systems. It aims to be a better 'top'
* [trippy](https://github.com/fujiapple852/trippy) ⭐ 7,528 | 🐛 77 | 🌐 Rust | 📅 2026-08-25 A network diagnostic tool that includes functionality like mtr and more
...
* [rustnet](https://github.com/domcyrus/rustnet) ⭐ 4,918 | 🐛 17 | 🌐 Rust | 📅 2026-08-24 A cross-platform network monitoring tool with deep packet inspection
...
* [psmux](https://github.com/marlocarlo/psmux) ⭐ 3,333 | 🐛 15 | 🌐 PowerShell | 📅 2026-08-24 tmux-compatible terminal multiplexer for Windows built in Rust with ratatui.
...
* [oryx](https://github.com/pythops/oryx) ⭐ 2,562 | 🐛 5 | 🌐 Rust | 📅 2026-07-17 A TUI for sniffing network traffic using eBPF
...
* [macmon](https://github.com/vladkens/macmon) ⭐ 1,828 | 🐛 14 | 🌐 Rust | 📅 2026-08-04 Sudoless performance monitoring for Apple Silicon processors written in Rust
...
* [opencode](https://github.com/sst/opencode) ⭐ 201,116 | 🐛 5,359 | 🌐 TypeScript | 📅 2026-08-25 AI coding agent, built for the terminal
* [codex](https://github.com/openai/codex) ⭐ 117,403 | 🐛 13,730 | 🌐 Rust | 📅 2026-08-25 Lightweight coding agent that runs in your terminal
* [lazygit](https://github.com/jesseduffield/lazygit) ⭐ 81,607 | 🐛 1,025 | 🌐 Go | 📅 2026-08-21 Simple terminal UI for git commands
* [delta](https://github.com/dandavison/delta) ⭐ 31,852 | 🐛 430 | 🌐 Rust | 📅 2026-08-02 A syntax-highlighting pager for git, diff, and grep output
* [crush](https://github.com/charmbracelet/crush) ⭐ 27,657 | 🐛 672 | 🌐 Go | 📅 2026-08-25 The glamourous AI coding agent
...
* [posting](https://github.com/darrenburns/posting) ⭐ 12,308 | 🐛 83 | 🌐 Python | 📅 2026-03-25 A powerful HTTP client that lives in your terminal
...
* [rainfrog](https://github.com/achristmascarl/rainfrog) ⭐ 5,288 | 🐛 14 | 🌐 Rust | 📅 2026-08-25 A database management TUI for Postgres, MySQL, and SQLite written in Rust
...
* [Claude Code Bridge](https://github.com/bfly123/claude_code_bridge) ⭐ 3,448 | 🐛 101 | 🌐 Python | 📅 2026-08-20 Real-time multi-AI collaboration between Claude, Codex and Gemini in terminal
...
* [VT Code](https://github.com/vinhnx/vtcode) ⭐ 822 | 🐛 2 | 🌐 Rust | 📅 2026-08-25 VT Code - Semantic Coding Agent
...
* [models](https://github.com/arimxyer/models) ⭐ 496 | 🐛 0 | 🌐 Rust | 📅 2026-08-25 TUI for browsing AI models and coding agents
...
* [gitwig](https://github.com/tareqmy/gitwig) ⭐ 80 | 🐛 0 | 🌐 Rust | 📅 2026-08-24 - A mouse-drivable git TUI and multi-repo dashboard built in Rust.
...
* [lazydocker](https://github.com/jesseduffield/lazydocker) ⭐ 52,599 | 🐛 295 | 🌐 Go | 📅 2026-04-19 The lazier way to manage everything docker
* [k9s](https://github.com/derailed/k9s) ⭐ 34,424 | 🐛 102 | 🌐 Go | 📅 2026-08-24 TUI for managing a Kubernetes cluster
...
* [kftui](https://github.com/hcavarsan/kftray) ⭐ 1,554 | 🐛 19 | 🌐 Rust | 📅 2026-08-24 A TUI to manage multiple kubectl port-forward commands, with support for UDP and K8s proxy.
* [dtop](https://github.com/amir20/dtop) ⭐ 1,351 | 🐛 3 | 🌐 Rust | 📅 2026-08-24 Terminal dashboard for Docker monitoring across multiple hosts
...
* [micro](https://github.com/zyedidia/micro) ⭐ 29,433 | 🐛 1,038 | 🌐 Go | 📅 2026-08-25 A modern and intuitive terminal-based text editor
* [Edit](https://github.com/microsoft/edit) ⭐ 14,488 | 🐛 172 | 🌐 Rust | 📅 2026-08-23 A simple text editor. Pays homage to the classic MS-DOS Editor.
* [kilo](https://github.com/antirez/kilo) ⭐ 9,083 | 🐛 62 | 🌐 C | 📅 2025-01-04 A minimal but complete editor in \~1000 lines of C code.
* [Fresh](https://github.com/sinelaw/fresh) ⭐ 8,496 | 🐛 296 | 🌐 Rust | 📅 2026-08-24 An easy-to-use, powerful and fast terminal-based text editor.
...
* [flow-control](https://github.com/neurocyte/flow) ⭐ 2,186 | 🐛 80 | 🌐 Zig | 📅 2026-08-24 A lightning-fast, feature-rich text editor written in Zig
...
* [orbiton](https://github.com/xyproto/orbiton) ⭐ 698 | 🐛 1 | 🌐 Go | 📅 2026-08-21 Text editor limited by VT100, suitable for programming, writing git commit messages and editing Markdown
* [treemd](https://github.com/Epistates/treemd) ⭐ 679 | 🐛 0 | 🌐 Rust | 📅 2026-08-25 A markdown navigator with tree-based structural navigation
...
* [superfile](https://github.com/MHNightCat/superfile) ⭐ 22,793 | 🐛 258 | 🌐 Go | 📅 2026-08-20 Pretty fancy and modern terminal file manager.
* [nnn](https://github.com/jarun/nnn) ⭐ 21,828 | 🐛 5 | 🌐 C | 📅 2026-08-17 n³ The unorthodox terminal file manager.
* [ranger](https://github.com/ranger/ranger) ⭐ 17,366 | 🐛 899 | 🌐 Python | 📅 2026-08-15 A VIM-inspired file manager for the console.
* [broot](https://github.com/Canop/broot) ⭐ 12,909 | 🐛 232 | 🌐 Rust | 📅 2026-08-24 A new way to see and navigate directory trees
...
* [NetHack](https://github.com/NetHack/NetHack) ⭐ 3,876 | 🐛 139 | 🌐 C | 📅 2026-08-24 Dungeon exploration game
...
* [Rich](https://github.com/willmcgugan/rich) ⭐ 57,206 | 🐛 373 | 🌐 Python | 📅 2026-06-23 is a **Python** library for rich text and beautiful formatting in the terminal.
* [textual](https://github.com/willmcgugan/textual) ⭐ 37,032 | 🐛 352 | 🌐 Python | 📅 2026-07-11 is a TUI (Text User Interface) framework for **Python** inspired by modern web development.
...
* [notcurses](https://github.com/dankamongmen/notcurses) ⭐ 4,674 | 🐛 327 | 🌐 C | 📅 2026-05-18 blingful character graphics/TUI library for **C** and **Python**. definitely not curses.
...
* [bubbletea](https://github.com/charmbracelet/bubbletea) ⭐ 44,529 | 🐛 200 | 🌐 Go | 📅 2026-08-19 A **Go** framework based on Elm to build functional and fun terminal apps
...
* [libuv](https://github.com/libuv/libuv) ⭐ 27,128 | 🐛 228 | 🌐 C | 📅 2026-08-20 Cross-platform asynchronous I/O library - written in **C**
...
* [FTXUI](https://github.com/ArthurSonzogni/FTXUI) ⭐ 10,595 | 🐛 98 | 🌐 C++ | 📅 2026-08-23 💻 **C++** Functional Terminal User Interface. ❤️
...
* [Lanterna](https://github.com/mabe02/lanterna) ⭐ 2,615 | 🐛 94 | 🌐 Java | 📅 2026-07-07 A **Java** library for creating text-based UIs, very similar to the C library curses but with more functionality.
...
* [Consolonia](https://github.com/jinek/Consolonia) ⭐ 820 | 🐛 56 | 🌐 C# | 📅 2026-08-25 A **.NET** terminal-based GUI framework with support of XAML
...
* [Ratatui](https://github.com/tui-rs-revival/ratatui) ⭐ 22,362 | 🐛 218 | 🌐 Rust | 📅 2026-08-24 A **Rust** crate for building Terminal UIs (actively maintained fork of tui-rs).
...
* [ink](https://github.com/vadimdemedes/ink) ⭐ 39,732 | 🐛 38 | 🌐 TypeScript | 📅 2026-08-12 React for **Node.js** interactive command-line apps
* [gum](https://github.com/charmbracelet/gum) ⭐ 24,273 | 🐛 192 | 🌐 Go | 📅 2026-08-20 A tool for glamorous **shell** scripts
* [OpenTUI](https://github.com/sst/opentui) ⭐ 13,145 | 🐛 179 | 🌐 TypeScript | 📅 2026-08-25 A **TypeScript** library for building terminal user interfaces (TUIs)
...
* [nomadnet](https://github.com/markqvist/NomadNet) ⭐ 2,454 | 🐛 0 | 🌐 Python | 📅 2026-05-28 Secure messaging network built on Reticulum
...
* [matcha](https://github.com/floatpane/matcha) ⭐ 1,071 | 🐛 84 | 🌐 Go | 📅 2026-08-24 Email client
...
* [zulip-terminal](https://github.com/zulip/zulip-terminal) ⭐ 857 | 🐛 474 | 🌐 Python | 📅 2026-08-16 Official Zulip terminal client (similar to matterhorn)
...
* [fzf](https://github.com/junegunn/fzf) ⭐ 82,640 | 🐛 327 | 🌐 Go | 📅 2026-08-24 A general-purpose command-line fuzzy finder
* [wttr.in](https://github.com/chubin/wttr.in) ⭐ 30,402 | 🐛 330 | 🌐 Go | 📅 2026-08-02 The right way to check the weather
* [oha](https://github.com/hatoo/oha) ⭐ 10,504 | 🐛 57 | 🌐 Rust | 📅 2026-08-23 HTTP load generator
...
* [impala](https://github.com/pythops/impala) ⭐ 2,796 | 🐛 5 | 🌐 Rust | 📅 2026-08-24 TUI for managing wifi
* [tweakcc](https://github.com/Piebald-AI/tweakcc) ⭐ 2,459 | 🐛 56 | 🌐 TypeScript | 📅 2026-08-25 TUI to customize your Claude Code themes, thinking verbs, and more.
* [Caligula](https://github.com/ifd3f/caligula) ⭐ 2,238 | 🐛 51 | 🌐 Rust | 📅 2026-08-24 A user-friendly, lightweight TUI for imaging disks.
...
* [godap](https://github.com/Macmod/godap) ⭐ 972 | 🐛 5 | 🌐 Go | 📅 2026-08-21 A complete TUI for LDAP written in Golang
...
* [vlc](https://github.com/videolan/vlc) ⭐ 19,427 | 🐛 2 | 🌐 C | 📅 2026-08-24 VLC includes an ncurses interface, `vlc --intf ncurses`
...
* [tdf](https://github.com/itsjunetime/tdf) ⭐ 1,944 | 🐛 41 | 🌐 Rust | 📅 2026-08-16 A tui-based PDF viewer
...
* [bookokrat](https://github.com/bugzmanov/bookokrat) ⭐ 1,104 | 🐛 48 | 🌐 Rust | 📅 2026-08-08 Full-featured EPUB books reader with Vim keybindings.
...
* [manga-tui](https://github.com/josueBarretogit/manga-tui) ⭐ 920 | 🐛 22 | 🌐 Rust | 📅 2026-07-13 Terminal-based manga reader and downloader with image rendering support
...
* [xytz](https://github.com/xdagiz/xytz) ⭐ 598 | 🐛 10 | 🌐 Go | 📅 2026-08-24 Beautiful TUI for downloading YouTube videos/playlists/channels.
...
* [tmux](https://github.com/tmux/tmux) ⭐ 48,799 | 🐛 30 | 🌐 C | 📅 2026-08-25 Terminal multiplexer
* [zellij](https://github.com/zellij-org/zellij) ⭐ 35,098 | 🐛 1,873 | 🌐 Rust | 📅 2026-08-24 A terminal workspace with batteries included
* [Glow](https://github.com/charmbracelet/glow) ⭐ 27,027 | 🐛 222 | 🌐 Go | 📅 2026-08-16 A markdown reader, designed from the ground up to showcase the elegance and capabilities of TUI.
* [slides](https://github.com/maaslalani/slides) ⭐ 11,628 | 🐛 77 | 🌐 Go | 📅 2026-07-08 A terminal based presentation tool, supporting markdown syntax.
...
* [presenterm](https://github.com/mfontanini/presenterm) ⭐ 8,790 | 🐛 75 | 🌐 Rust | 📅 2026-05-22 A markdown terminal slideshow tool
...
* [television](https://github.com/alexpasmantier/television) ⭐ 6,207 | 🐛 83 | 🌐 Rust | 📅 2026-08-16 A fast and versatile fuzzy finder TUI
...
* [hledger-ui](https://github.com/simonmichael/hledger) ⭐ 4,666 | 🐛 340 | 🌐 Haskell | 📅 2026-08-25 A fast TUI for browsing double entry bookkeeping data
...
* [TUIOS](https://github.com/Gaurav-Gosain/tuios) ⭐ 3,546 | 🐛 20 | 🌐 Go | 📅 2026-08-25 A TUI window manager for managing multiple terminal sessions
* [Tabiew](https://github.com/shshemi/tabiew) ⭐ 3,085 | 🐛 16 | 🌐 Rust | 📅 2026-08-17 A lightweight app to view and query tabular data files, such as CSV, TSV, and parquet.
...
* [khal](https://github.com/pimutils/khal) ⭐ 3,043 | 🐛 260 | 🌐 Python | 📅 2026-08-24 A standards based CLI calendar program, able to synchronize with CalDAV servers
* [Bagels](https://github.com/EnhancedJax/Bagels) ⭐ 2,884 | 🐛 18 | 🌐 Python | 📅 2025-07-06 TUI expense tracker
...
* [longbridge-terminal](https://github.com/longbridge/longbridge-terminal) ⭐ 989 | 🐛 11 | 🌐 Rust | 📅 2026-08-23 AI-native TUI for Longbridge Securities: real-time quotes, portfolio management, and trading for HK/US/A-share/SG markets.
...
* [agent-deck](https://github.com/asheshgoplani/agent-deck) ⭐ 786 | 🐛 34 | 🌐 Go | 📅 2026-08-24 Terminal dashboard for managing multiple AI coding agent sessions
...
* [pomo](https://github.com/Bahaaio/pomo) ⭐ 485 | 🐛 3 | 🌐 Go | 📅 2026-06-06 A minimal, customizable TUI Pomodoro timer with ASCII art, progress bar, desktop notifications, and productivity statistics.
...
* [surge](https://github.com/surge-downloader/surge) ⭐ 3,487 | 🐛 54 | 🌐 Go | 📅 2026-08-25 A blazing fast, beautiful TUI download manager built in Go.
...
* [cloudflare-speed-cli](https://github.com/kavehtehrani/cloudflare-speed-cli) ⭐ 1,000 | 🐛 0 | 🌐 Rust | 📅 2026-07-27 Internet speed test via Cloudflare
* [eilmeldung](https://github.com/christo-auer/eilmeldung) ⭐ 941 | 🐛 1 | 🌐 Rust | 📅 2026-08-24 RSS reader, supporting many RSS providers, bulk-operations and configuration options.

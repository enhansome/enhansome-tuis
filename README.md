...
There's a lot of cool projects here that I have no association with. Run them at your own risk. If you have a cool tool you'd like to share please [open a PR](https://github.com/rothgar/awesome-tuis/pulls) ⭐ 20,499 | 🐛 104 | 📅 2026-08-11.
...
* [btop++](https://github.com/aristocratos/btop) ⭐ 34,429 | 🐛 531 | 🌐 C++ | 📅 2026-09-05 Resource monitor with extras
* [Glances](https://github.com/nicolargo/glances) ⭐ 33,531 | 🐛 101 | 🌐 Python | 📅 2026-09-05 Glances an Eye on your system. A top/htop alternative.
* [Goaccess](https://github.com/allinurl/goaccess) ⭐ 20,910 | 🐛 449 | 🌐 C | 📅 2026-09-03 GoAccess is a real-time web log analyzer and interactive viewer that runs in a terminal in nix systems or through your browser.
* [WTF](https://github.com/senorprogrammer/wtf) ⭐ 17,075 | 🐛 105 | 🌐 Go | 📅 2026-09-02 The personal information dashboard for your terminal.
* [bottom](https://github.com/ClementTsang/bottom) ⭐ 13,983 | 🐛 107 | 🌐 Rust | 📅 2026-09-06 A customizable graphical process/system monitor for the terminal.
...
* [gh-dash](https://github.com/dlvhdr/gh-dash) ⭐ 12,480 | 🐛 100 | 🌐 Go | 📅 2026-09-02 A rich terminal UI for GitHub PRs and Issues
...
* [talos linux](https://github.com/siderolabs/talos) ⭐ 11,104 | 🐛 226 | 🌐 Go | 📅 2026-09-06 A Linux distro with a TUI dashboard for local and remote usage
* [nvtop](https://github.com/Syllo/nvtop) ⭐ 10,974 | 🐛 149 | 🌐 C | 📅 2026-05-06 GPUs process monitoring for AMD, Intel and NVIDIA
...
* [htop](https://github.com/htop-dev/htop) ⭐ 8,312 | 🐛 360 | 🌐 C | 📅 2026-09-05 Interactive text-mode process viewer for Unix systems. It aims to be a better 'top'
...
* [trippy](https://github.com/fujiapple852/trippy) ⭐ 7,869 | 🐛 79 | 🌐 Rust | 📅 2026-09-04 A network diagnostic tool that includes functionality like mtr and more
...
* [ticker](https://github.com/achannarasappa/ticker) ⭐ 6,224 | 🐛 33 | 🌐 Go | 📅 2026-06-28 Track stocks, crypto, and derivatives prices and positions in real time from your terminal
...
* [rustnet](https://github.com/domcyrus/rustnet) ⭐ 4,996 | 🐛 19 | 🌐 Rust | 📅 2026-09-06 A cross-platform network monitoring tool with deep packet inspection
...
* [psmux](https://github.com/marlocarlo/psmux) ⭐ 3,428 | 🐛 37 | 🌐 PowerShell | 📅 2026-09-06 tmux-compatible terminal multiplexer for Windows built in Rust with ratatui.
...
* [zenith](https://github.com/bvaisvil/zenith) ⭐ 3,047 | 🐛 40 | 🌐 Rust | 📅 2026-09-02 In terminal graphical metrics for your \*nix system written in Rust
* [kmon](https://github.com/orhun/kmon) ⭐ 2,943 | 🐛 23 | 🌐 Rust | 📅 2026-07-31 Linux Kernel Manager and Activity Monitor
* [gonzo](https://github.com/control-theory/gonzo) ⭐ 2,762 | 🐛 17 | 🌐 Go | 📅 2026-09-04 A powerful, real-time log analysis terminal UI inspired by k9s.
...
* [macmon](https://github.com/vladkens/macmon) ⭐ 1,867 | 🐛 15 | 🌐 Rust | 📅 2026-08-04 Sudoless performance monitoring for Apple Silicon processors written in Rust
* [cgdb](https://github.com/cgdb/cgdb) ⭐ 1,842 | 🐛 46 | 🌐 C | 📅 2026-02-27 Console front-end to the GNU debugger
* [netscanner](https://github.com/Chleba/netscanner) ⭐ 1,836 | 🐛 6 | 🌐 Rust | 📅 2026-07-06 Network scanner
...
* [updo](https://github.com/Owloops/updo) ⭐ 1,131 | 🐛 6 | 🌐 Go | 📅 2026-05-26 Website monitoring tool with uptime tracking, response time metrics, and SSL certificate monitoring.
* [hwatch](https://github.com/blacknon/hwatch) ⭐ 1,076 | 🐛 10 | 🌐 Rust | 📅 2026-08-30 A modern alternative to watch that records command output history and provides interactive diff views, scrolling, filtering, JSON logging, and hooks.
* [otel-tui](https://github.com/ymtdzzz/otel-tui) ⭐ 1,076 | 🐛 30 | 🌐 Go | 📅 2026-09-01 A terminal OpenTelemetry viewer
...
* [chdig](https://github.com/azat/chdig) ⭐ 293 | 🐛 5 | 🌐 Rust | 📅 2026-09-06 Dig into ClickHouse with TUI interface
...
* [pstop](https://github.com/marlocarlo/pstop) ⭐ 245 | 🐛 6 | 🌐 Rust | 📅 2026-07-18 htop-style system monitor for Windows with per-core CPU bars, tree view, and 7 color schemes.
...
* [sockttop](https://github.com/jasonwitty/socktop) ⭐ 189 | 🐛 0 | 🌐 Rust | 📅 2026-08-31 socktop is a remote system monitor with a rich TUI, inspired by top/btop, talking to a lightweight agent over WebSockets.
...
* [opencode](https://github.com/sst/opencode) ⭐ 205,166 | 🐛 5,746 | 🌐 TypeScript | 📅 2026-09-06 AI coding agent, built for the terminal
* [codex](https://github.com/openai/codex) ⭐ 121,952 | 🐛 15,590 | 🌐 Rust | 📅 2026-09-06 Lightweight coding agent that runs in your terminal
* [lazygit](https://github.com/jesseduffield/lazygit) ⭐ 82,069 | 🐛 1,028 | 🌐 Go | 📅 2026-09-06 Simple terminal UI for git commands
* [delta](https://github.com/dandavison/delta) ⭐ 32,101 | 🐛 435 | 🌐 Rust | 📅 2026-09-02 A syntax-highlighting pager for git, diff, and grep output
* [crush](https://github.com/charmbracelet/crush) ⭐ 27,936 | 🐛 693 | 🌐 Go | 📅 2026-09-06 The glamourous AI coding agent
* [gitui](https://github.com/extrawurst/gitui) ⭐ 22,466 | 🐛 344 | 🌐 Rust | 📅 2026-08-04 blazing fast terminal-ui for git written in rust
...
* [posting](https://github.com/darrenburns/posting) ⭐ 12,378 | 🐛 85 | 🌐 Python | 📅 2026-03-25 A powerful HTTP client that lives in your terminal
* [Claude Code Usage Monitor](https://github.com/Maciek-roboblog/Claude-Code-Usage-Monitor) ⭐ 8,673 | 🐛 37 | 🌐 Python | 📅 2026-07-05 Monitor Claude token usage
...
* [harlequin](https://github.com/tconbeer/harlequin) ⭐ 6,381 | 🐛 41 | 🌐 Python | 📅 2026-09-05 The SQL IDE for Your Terminal
...
* [sqlit](https://github.com/Maxteabag/sqlit) ⭐ 4,806 | 🐛 12 | 🌐 Python | 📅 2026-09-06 A lightweight TUI for SQL databases inspired by lazygit
* [lazysql](https://github.com/jorgerojas26/lazysql) ⭐ 4,274 | 🐛 49 | 🌐 Go | 📅 2026-08-22 A cross-platform TUI database management tool written in Go.
...
* [Claude Code Bridge](https://github.com/bfly123/claude_code_bridge) ⭐ 3,480 | 🐛 100 | 🌐 Python | 📅 2026-09-06 Real-time multi-AI collaboration between Claude, Codex and Gemini in terminal
* [Toad](https://github.com/batrachianai/toad) ⭐ 3,423 | 🐛 6 | 🌐 Python | 📅 2026-05-26 A unified interface for AI
...
* [runme](https://github.com/stateful/runme) ⭐ 2,160 | 🐛 153 | 🌐 Go | 📅 2026-09-03 Discover and run code snippets directly from your README.md or other markdowns
* [serie](https://github.com/lusingander/serie) ⭐ 2,083 | 🐛 24 | 🌐 Rust | 📅 2026-09-06 A rich git commit graph
* [resterm](https://github.com/unkn0wn-root/resterm) ⭐ 1,911 | 🐛 0 | 🌐 Go | 📅 2026-09-06 A terminal client for HTTP/GraphQL/gRPC with support for WebSockets, SSE, workflows, profiling, OpenAPI and response diffs.
...
* [terraform-tui](https://github.com/idoavrah/terraform-tui) ⭐ 1,293 | 🐛 11 | 🌐 Python | 📅 2026-09-06 view and interact with Terraform state
* [proxelar](https://github.com/emanuele-em/proxelar) ⭐ 1,054 | 🐛 7 | 🌐 Rust | 📅 2026-09-04 Scriptable MITM proxy TUI to inspect, intercept, replay, and rewrite HTTP(S) and WebSocket traffic
...
* [VT Code](https://github.com/vinhnx/vtcode) ⭐ 833 | 🐛 1 | 🌐 Rust | 📅 2026-09-05 VT Code - Semantic Coding Agent
...
* [models](https://github.com/arimxyer/models) ⭐ 504 | 🐛 0 | 🌐 Rust | 📅 2026-09-06 TUI for browsing AI models and coding agents
* [Froggit](https://github.com/thewizardshell/froggit) ⭐ 485 | 🐛 3 | 🌐 Go | 📅 2026-03-20 Minimalist Git TUI with GitHub CLI integration
* [hcom](https://github.com/aannoo/hcom) ⭐ 479 | 🐛 49 | 🌐 Rust | 📅 2026-08-09 CLI and TUI for real-time messaging, observation, and orchestration between AI coding agents (Claude Code, Antigravity, Codex, OpenCode, Kilo, Cursor) across terminals
...
* [heretek](https://github.com/wcampbell0x2a/heretek) ⭐ 389 | 🐛 29 | 🌐 Rust | 📅 2026-09-03 GDB TUI Dashboard
...
* [sabiql](https://github.com/riii111/sabiql) ⭐ 299 | 🐛 7 | 🌐 Rust | 📅 2026-09-06 A fast, driver-less TUI to browse, query, and edit PostgreSQL databases, written in Rust
...
* [fast-resume](https://github.com/angristan/fast-resume) ⭐ 156 | 🐛 16 | 🌐 Rust | 📅 2026-09-02 Index and fuzzy search coding agent sessions
...
* [qrypad](https://github.com/wheelibin/qrypad) ⭐ 43 | 🐛 0 | 🌐 Go | 📅 2026-09-03 A terminal SQL client for Postgres, MySQL and SQLite.
...
* [lazydocker](https://github.com/jesseduffield/lazydocker) ⭐ 52,747 | 🐛 299 | 🌐 Go | 📅 2026-04-19 The lazier way to manage everything docker
* [k9s](https://github.com/derailed/k9s) ⭐ 34,521 | 🐛 83 | 🌐 Go | 📅 2026-09-06 TUI for managing a Kubernetes cluster
...
* [oxker](https://github.com/mrjackwills/oxker) ⭐ 1,828 | 🐛 23 | 🌐 Rust | 📅 2026-08-22 A simple tui to view & control docker containers
...
* [kftui](https://github.com/hcavarsan/kftray) ⭐ 1,557 | 🐛 20 | 🌐 Rust | 📅 2026-09-06 A TUI to manage multiple kubectl port-forward commands, with support for UDP and K8s proxy.
* [dtop](https://github.com/amir20/dtop) ⭐ 1,394 | 🐛 2 | 🌐 Rust | 📅 2026-09-05 Terminal dashboard for Docker monitoring across multiple hosts
* [Podman-tui](https://github.com/containers/podman-tui) ⭐ 1,215 | 🐛 6 | 🌐 Go | 📅 2026-09-06 TUI for Podman containers
...
* [e1s](https://github.com/keidarcy/e1s) ⭐ 923 | 🐛 2 | 🌐 Go | 📅 2026-09-04 TUI for managing AWS ECS resources
* [Argonaut](https://github.com/darksworm/argonaut) ⭐ 444 | 🐛 13 | 🌐 Go | 📅 2026-09-06 ArgoCD TUI
...
* [micro](https://github.com/zyedidia/micro) ⭐ 29,531 | 🐛 975 | 🌐 Go | 📅 2026-09-06 A modern and intuitive terminal-based text editor
* [Edit](https://github.com/microsoft/edit) ⭐ 14,542 | 🐛 174 | 🌐 Rust | 📅 2026-08-27 A simple text editor. Pays homage to the classic MS-DOS Editor.
* [kilo](https://github.com/antirez/kilo) ⭐ 9,110 | 🐛 63 | 🌐 C | 📅 2025-01-04 A minimal but complete editor in \~1000 lines of C code.
* [Fresh](https://github.com/sinelaw/fresh) ⭐ 8,719 | 🐛 329 | 🌐 Rust | 📅 2026-09-06 An easy-to-use, powerful and fast terminal-based text editor.
* [slap](https://github.com/slap-editor/slap) ⭐ 6,189 | 🐛 115 | 🌐 JavaScript | 📅 2021-11-01 Sublime-like terminal-based text editor
* [vis](https://github.com/martanne/vis) ⭐ 4,709 | 🐛 152 | 🌐 C | 📅 2026-08-20 A vi-like editor based on Plan 9's structural regular expressions
...
* [flow-control](https://github.com/neurocyte/flow) ⭐ 2,211 | 🐛 82 | 🌐 Zig | 📅 2026-08-29 A lightning-fast, feature-rich text editor written in Zig
* [Durdraw](https://github.com/cmang/durdraw) ⭐ 1,809 | 🐛 4 | 🌐 Python | 📅 2026-09-05 An ASCII, Unicode and ANSI art editor
* [zee](https://github.com/zee-editor/zee) ⭐ 1,803 | 🐛 44 | 🌐 Rust | 📅 2025-02-06 A modern text editor for the terminal written in Rust
* [orbiton](https://github.com/xyproto/orbiton) ⭐ 698 | 🐛 0 | 🌐 Go | 📅 2026-09-04 Text editor limited by VT100, suitable for programming, writing git commit messages and editing Markdown
* [treemd](https://github.com/Epistates/treemd) ⭐ 689 | 🐛 4 | 🌐 Rust | 📅 2026-09-02 A markdown navigator with tree-based structural navigation
...
* [PNANA](https://github.com/Cyxuan0311/PNANA) ⭐ 322 | 🐛 14 | 🌐 C++ | 📅 2026-08-19 A modern terminal text editor built with FTXUI, inspired by Nano, Micro, and Sublime Text.
...
* [yazi](https://github.com/sxyazi/yazi) ⭐ 41,986 | 🐛 69 | 🌐 Rust | 📅 2026-09-01 Blazing fast terminal file manager written in Rust, based on async I/O.
* [superfile](https://github.com/MHNightCat/superfile) ⭐ 23,112 | 🐛 262 | 🌐 Go | 📅 2026-09-06 Pretty fancy and modern terminal file manager.
* [nnn](https://github.com/jarun/nnn) ⭐ 21,868 | 🐛 4 | 🌐 C | 📅 2026-09-05 n³ The unorthodox terminal file manager.
* [ranger](https://github.com/ranger/ranger) ⭐ 17,394 | 🐛 897 | 🌐 Python | 📅 2026-08-31 A VIM-inspired file manager for the console.
* [broot](https://github.com/Canop/broot) ⭐ 12,929 | 🐛 102 | 🌐 Rust | 📅 2026-09-06 A new way to see and navigate directory trees
* [lf](https://github.com/gokcehan/lf) ⭐ 9,491 | 🐛 84 | 🌐 Go | 📅 2026-08-25 A terminal file manager written in Go with heavy inspiration from ranger file manager.
* [Vifm](https://github.com/vifm/vifm) ⭐ 3,262 | 🐛 143 | 🌐 C | 📅 2026-09-04 A TUI file manager with vi-keybindings and other vim like behaviour.
* [far2l](https://github.com/elfmz/far2l) ⭐ 2,210 | 🐛 472 | 🌐 C++ | 📅 2026-09-06 Linux port of Far v2 file manager
* [mc](https://github.com/MidnightCommander/mc) ⭐ 970 | 🐛 688 | 🌐 C | 📅 2026-08-30 GNU Midnight Commander. A free cross-platform orthodox file manager.
...
* [rovr](https://github.com/NSPC911/rovr) ⭐ 409 | 🐛 8 | 🌐 Python | 📅 2026-09-06 A post-modern terminal file manager.
...
* [ytreenova](https://github.com/robkam/ytreenova) ⭐ 15 | 🐛 1 | 🌐 C | 📅 2026-09-06 The XTree™ style file manager Unix should have had all along.
* [fyzenor](https://github.com/Bimbok/fyzenor) ⭐ 14 | 🐛 21 | 🌐 C++ | 📅 2026-09-06 A modern, blazing-fast terminal file manager built in C++ with live previews, async workflows, and a polished three-column interface.
...
* [NetHack](https://github.com/NetHack/NetHack) ⭐ 3,894 | 🐛 142 | 🌐 C | 📅 2026-09-06 Dungeon exploration game
...
* [BrogueCE](https://github.com/tmewett/BrogueCE) ⭐ 1,451 | 🐛 214 | 🌐 C | 📅 2026-08-05 Beautiful roguelike dungeon crawler
...
* [textual](https://github.com/willmcgugan/textual) ⭐ 37,159 | 🐛 358 | 🌐 Python | 📅 2026-07-11 is a TUI (Text User Interface) framework for **Python** inspired by modern web development.
...
* [notcurses](https://github.com/dankamongmen/notcurses) ⭐ 4,691 | 🐛 328 | 🌐 C | 📅 2026-05-18 blingful character graphics/TUI library for **C** and **Python**. definitely not curses.
* [urwid](https://github.com/urwid/urwid) ⭐ 3,017 | 🐛 125 | 🌐 Python | 📅 2026-09-04 A console user interface library for **Python** on Linux, OSX, Cygwin or other unix-like OS.
...
* [blessed](https://github.com/jquast/blessed) ⭐ 1,497 | 🐛 4 | 🌐 Python | 📅 2026-09-04 Blessed is an easy, practical library for making **Python** terminal apps
...
* [bubbletea](https://github.com/charmbracelet/bubbletea) ⭐ 44,819 | 🐛 213 | 🌐 Go | 📅 2026-09-01 A **Go** framework based on Elm to build functional and fun terminal apps
* [tview](https://github.com/rivo/tview/) ⭐ 14,084 | 🐛 95 | 🌐 Go | 📅 2026-08-11 Terminal UI library with rich, interactive widgets — written in **Go**
...
* [tcell](https://github.com/gdamore/tcell) ⭐ 5,218 | 🐛 9 | 🌐 Go | 📅 2026-09-06 Tcell is an alternate **Go** terminal package, similar in some ways to termbox, but better in others.
...
* [libuv](https://github.com/libuv/libuv) ⭐ 27,159 | 🐛 234 | 🌐 C | 📅 2026-09-06 Cross-platform asynchronous I/O library - written in **C**
...
* [FTXUI](https://github.com/ArthurSonzogni/FTXUI) ⭐ 10,649 | 🐛 98 | 🌐 C++ | 📅 2026-09-02 💻 **C++** Functional Terminal User Interface. ❤️
...
* [tvision](https://github.com/magiblot/tvision) ⭐ 3,147 | 🐛 46 | 🌐 C++ | 📅 2026-09-01 A modern port of **C++** Turbo Vision 2.0, cross-platform and Unicode support.
...
* [xtd](https://github.com/gammasoft71/xtd) ⭐ 1,160 | 🐛 98 | 🌐 C++ | 📅 2026-09-06 Free open-source modern **C++** framework to create console (CLI), forms (GUI like WinForms) and unit test (xUnit) applications and libraries on Windows, macOS, Linux, iOS, Android, FreeBSD, and Haiku.
...
* [Terminal.Gui](https://github.com/gui-cs/Terminal.Gui) ⭐ 11,203 | 🐛 49 | 🌐 C# | 📅 2026-09-03 Cross-platform terminal UI toolkit for **.NET**
* [Consolonia](https://github.com/jinek/Consolonia) ⭐ 821 | 🐛 51 | 🌐 C# | 📅 2026-09-06 A **.NET** terminal-based GUI framework with support of XAML
...
* [Hex1b](https://github.com/mitchdenny/hex1b) ⭐ 175 | 🐛 107 | 🌐 C# | 📅 2026-09-06 A **.NET** library for building rich, interactive TUIs with a React-inspired declarative API
...
* [Ratatui](https://github.com/tui-rs-revival/ratatui) ⭐ 22,515 | 🐛 209 | 🌐 Rust | 📅 2026-09-04 A **Rust** crate for building Terminal UIs (actively maintained fork of tui-rs).
...
* [iocraft](https://github.com/ccbrown/iocraft) ⭐ 1,532 | 🐛 27 | 🌐 Rust | 📅 2026-09-04 **Rust** crate for beautiful, artisanally crafted TUIs and text-based IO, with a declarative, React-like API inspired by Ink.
...
* [ink](https://github.com/vadimdemedes/ink) ⭐ 39,823 | 🐛 32 | 🌐 TypeScript | 📅 2026-08-25 React for **Node.js** interactive command-line apps
* [gum](https://github.com/charmbracelet/gum) ⭐ 24,341 | 🐛 205 | 🌐 Go | 📅 2026-09-01 A tool for glamorous **shell** scripts
* [OpenTUI](https://github.com/sst/opentui) ⭐ 13,252 | 🐛 131 | 🌐 TypeScript | 📅 2026-09-06 A **TypeScript** library for building terminal user interfaces (TUIs)
...
* [php-tui](https://github.com/php-tui/php-tui) ⭐ 615 | 🐛 16 | 🌐 PHP | 📅 2026-05-04 comprehensive TUI library for **PHP** based heavily on Ratatui.
...
* [discordo](https://github.com/ayntgl/discordo) ⭐ 5,765 | 🐛 54 | 🌐 Go | 📅 2026-09-05 A lightweight, secure, and feature-rich Discord terminal client
...
* [nomadnet](https://github.com/markqvist/NomadNet) ⭐ 2,496 | 🐛 0 | 🌐 Python | 📅 2026-05-28 Secure messaging network built on Reticulum
...
* [concord](https://github.com/chojs23/concord) ⭐ 1,439 | 🐛 39 | 🌐 Rust | 📅 2026-09-04 A feature-rich TUI client for Discord
* [gurk-rs](https://github.com/boxdot/gurk-rs) ⭐ 1,371 | 🐛 100 | 🌐 Rust | 📅 2026-07-29 Signal Messenger client for terminal
* [basalt](https://github.com/erikjuhani/basalt) ⭐ 1,339 | 🐛 42 | 🌐 Rust | 📅 2026-09-06 TUI Application to manage Obsidian vaults and notes directly from the terminal.
...
* [matcha](https://github.com/floatpane/matcha) ⭐ 1,089 | 🐛 74 | 🌐 Go | 📅 2026-09-03 Email client
* [tgt](https://github.com/FedericoBruzzone/tgt) ⭐ 1,006 | 🐛 15 | 🌐 Rust | 📅 2026-08-17 A TUI for Telegram written in Rust
* [endcord](https://github.com/mzivic7/endcord) ⭐ 978 | 🐛 5 | 🌐 Python | 📅 2026-09-06 Feature rich Discord TUI client.
...
* [mastui](https://github.com/kimusan/mastui) ⭐ 89 | 🐛 4 | 🌐 Python | 📅 2026-09-06 Mastodon TUI
...
* [fzf](https://github.com/junegunn/fzf) ⭐ 82,846 | 🐛 329 | 🌐 Go | 📅 2026-09-06 A general-purpose command-line fuzzy finder
* [wttr.in](https://github.com/chubin/wttr.in) ⭐ 30,493 | 🐛 331 | 🌐 Go | 📅 2026-08-02 The right way to check the weather
* [oha](https://github.com/hatoo/oha) ⭐ 10,531 | 🐛 57 | 🌐 Rust | 📅 2026-08-23 HTTP load generator
* [termshark](https://github.com/gcla/termshark) ⭐ 10,001 | 🐛 51 | 🌐 Go | 📅 2024-04-30 Terminal UI for tshark
...
* [wego](https://github.com/schachmat/wego) ⭐ 8,546 | 🐛 16 | 🌐 Go | 📅 2026-08-01 Weather app
* [term.everything](https://github.com/mmulet/term.everything) ⭐ 8,091 | 🐛 10 | 🌐 Go | 📅 2026-03-18 Run any GUI app in the terminal
* [cava](https://github.com/karlstav/cava) ⭐ 6,399 | 🐛 18 | 🌐 C | 📅 2026-08-18 Cross-platform Audio Visualizer
* [gdu](https://github.com/dundee/gdu) ⭐ 5,964 | 🐛 54 | 🌐 Go | 📅 2026-09-04 Fast disk usage analyzer with console interface written in Go
...
* [x-cmd](https://github.com/x-cmd/x-cmd) ⭐ 4,641 | 🐛 104 | 🌐 Awk | 📅 2026-09-05 A vast and interesting collection of tools that can then bootstrap lots of other programs / functions in a consistent and structured way.
* [csvlens](https://github.com/YS-L/csvlens) ⭐ 3,955 | 🐛 59 | 🌐 Rust | 📅 2026-07-04 TUI CSV file viewer. It is like less but made for CSV.
* [cfdisk](https://github.com/util-linux/util-linux) ⭐ 3,225 | 🐛 429 | 🌐 C | 📅 2026-09-03 TUI partition editor included in util-linux
* [diskonaut](https://github.com/imsnif/diskonaut) ⭐ 3,125 | 🐛 45 | 🌐 Rust | 📅 2024-03-07 Terminal disk space navigator
* [bluetui](https://github.com/pythops/bluetui) ⭐ 2,995 | 🐛 18 | 🌐 Rust | 📅 2026-08-28 A TUI for managing bluetooth devices.
* [gif-for-cli](https://github.com/google/gif-for-cli) ⚠️ Archived Convert a gif into ASCII
* [impala](https://github.com/pythops/impala) ⭐ 2,839 | 🐛 0 | 🌐 Rust | 📅 2026-08-27 TUI for managing wifi
...
* [Caligula](https://github.com/ifd3f/caligula) ⭐ 2,300 | 🐛 52 | 🌐 Rust | 📅 2026-08-27 A user-friendly, lightweight TUI for imaging disks.
...
* [gpg-tui](https://github.com/orhun/gpg-tui) ⭐ 1,759 | 🐛 14 | 🌐 Rust | 📅 2026-08-26 A terminal user interface for GnuPG
...
* [bluetuith](https://github.com/darkhz/bluetuith) ⭐ 1,400 | 🐛 12 | 🌐 Go | 📅 2026-07-01 A TUI-based bluetooth connection manager, which can interact with bluetooth adapters and devices.
* [arttime](https://github.com/reportaman/arttime) ⭐ 1,382 | 🐛 6 | 🌐 Shell | 📅 2026-08-18 An app that brings beauty of text-art together with functionality of clock, timer, and pattern-based time manager.
...
* [golazo](https://github.com/0xjuanma/golazo) ⭐ 855 | 🐛 5 | 🌐 Go | 📅 2026-09-06 Get soccer minute-by-minute updates and finished match stats in your terminal
...
* [mac-cleanup-go](https://github.com/2ykwang/mac-cleanup-go) ⭐ 459 | 🐛 7 | 🌐 Go | 📅 2026-09-03 macOS disk cleanup TUI: scan cache/dev artifacts, preview, exclude, and move items to Trash.
...
* [Captain's log](https://github.com/NikolaDucak/caps-log) ⭐ 398 | 🐛 16 | 🌐 C++ | 📅 2026-08-14 A small TUI journaling tool
...
* [vlc](https://github.com/videolan/vlc) ⭐ 19,546 | 🐛 2 | 🌐 C | 📅 2026-09-06 VLC includes an ncurses interface, `vlc --intf ncurses`
...
* [ncspot](https://github.com/hrkfdn/ncspot) ⭐ 6,767 | 🐛 210 | 🌐 Rust | 📅 2026-08-31 Cross-platform ncurses Spotify client written in Rust
...
* [kew](https://github.com/ravachol/kew) ⭐ 3,025 | 🐛 3 | 🌐 C | 📅 2026-09-06 A terminal music player for Linux
* [timg](https://github.com/hzeller/timg) ⭐ 2,747 | 🐛 36 | 🌐 C++ | 📅 2026-08-05 A terminal image viewer
* [termusic](https://github.com/tramhao/termusic) ⭐ 2,194 | 🐛 52 | 🌐 Rust | 📅 2026-09-02 Music Player TUI written in Rust
...
* [spotatui](https://github.com/LargeModGames/spotatui) ⭐ 1,315 | 🐛 31 | 🌐 Rust | 📅 2026-09-06 Spotify client with native streaming, synced lyrics, and real-time audio visualization
* [bookokrat](https://github.com/bugzmanov/bookokrat) ⭐ 1,128 | 🐛 45 | 🌐 Rust | 📅 2026-09-06 Full-featured EPUB books reader with Vim keybindings.
...
* [xytz](https://github.com/xdagiz/xytz) ⭐ 626 | 🐛 9 | 🌐 Go | 📅 2026-08-29 Beautiful TUI for downloading YouTube videos/playlists/channels.
* [jellyfin-tui](https://github.com/dhonus/jellyfin-tui) ⭐ 586 | 🐛 27 | 🌐 Rust | 📅 2026-09-06 Jellyfin client
...
* [waves](https://github.com/llehouerou/waves) ⭐ 173 | 🐛 5 | 🌐 Go | 📅 2026-09-06 Terminal music player with vim-style navigation and radio mode that plays similar artists from your library
...
* [mpvc](https://github.com/gmt4/mpvc) ⭐ 158 | 🐛 1 | 🌐 Shell | 📅 2026-09-06 A mpc-like control interface for mpv
...
* [tmux](https://github.com/tmux/tmux) ⭐ 49,100 | 🐛 33 | 🌐 C | 📅 2026-09-05 Terminal multiplexer
* [zellij](https://github.com/zellij-org/zellij) ⭐ 35,300 | 🐛 1,898 | 🌐 Rust | 📅 2026-08-31 A terminal workspace with batteries included
* [Glow](https://github.com/charmbracelet/glow) ⭐ 27,208 | 🐛 230 | 🌐 Go | 📅 2026-09-06 A markdown reader, designed from the ground up to showcase the elegance and capabilities of TUI.
* [slides](https://github.com/maaslalani/slides) ⭐ 11,648 | 🐛 77 | 🌐 Go | 📅 2026-07-08 A terminal based presentation tool, supporting markdown syntax.
* [Visidata](https://github.com/saulpw/visidata) ⭐ 9,262 | 🐛 82 | 🌐 Python | 📅 2026-08-28 A terminal spreadsheet multitool for discovering and arranging data
* [presenterm](https://github.com/mfontanini/presenterm) ⭐ 8,825 | 🐛 77 | 🌐 Rust | 📅 2026-05-22 A markdown terminal slideshow tool
...
* [television](https://github.com/alexpasmantier/television) ⭐ 6,246 | 🐛 79 | 🌐 Rust | 📅 2026-09-06 A fast and versatile fuzzy finder TUI
...
* [hledger-ui](https://github.com/simonmichael/hledger) ⭐ 4,696 | 🐛 330 | 🌐 Haskell | 📅 2026-09-06 A fast TUI for browsing double entry bookkeeping data
* [LazySSH](https://github.com/adembc/lazyssh) ⭐ 3,917 | 🐛 66 | 🌐 Go | 📅 2025-10-09 TUI SSH manager to browse, connect, and manage servers from ssh config files.
* [doxx](https://github.com/bgreenwell/doxx) ⭐ 3,746 | 🐛 8 | 🌐 Rust | 📅 2026-08-10 A TUI document viewer for Microsoft Word files
* [TUIOS](https://github.com/Gaurav-Gosain/tuios) ⭐ 3,607 | 🐛 21 | 🌐 Go | 📅 2026-09-06 A TUI window manager for managing multiple terminal sessions
* [Tabiew](https://github.com/shshemi/tabiew) ⭐ 3,095 | 🐛 18 | 🌐 Rust | 📅 2026-09-06 A lightweight app to view and query tabular data files, such as CSV, TSV, and parquet.
* [termscp](https://github.com/veeso/termscp) ⭐ 3,071 | 🐛 2 | 🌐 Rust | 📅 2026-09-03 A TUI file transfer and explorer, with support for SCP/SFTP/FTP/S3.
* [khal](https://github.com/pimutils/khal) ⭐ 3,047 | 🐛 262 | 🌐 Python | 📅 2026-08-31 A standards based CLI calendar program, able to synchronize with CalDAV servers
* [Bagels](https://github.com/EnhancedJax/Bagels) ⭐ 2,897 | 🐛 18 | 🌐 Python | 📅 2025-07-06 TUI expense tracker
...
* [calcure](https://github.com/anufrievroman/calcure) ⭐ 2,349 | 🐛 6 | 🌐 Python | 📅 2026-08-29 Modern TUI calendar and task manager with minimal and customizable UI.
* [h-m-m](https://github.com/nadrad/h-m-m) ⭐ 2,287 | 🐛 4 | 🌐 PHP | 📅 2026-07-06 Hackers Mind Map
* [taskwarrior-tui](https://github.com/kdheepak/taskwarrior-tui) ⭐ 2,120 | 🐛 132 | 🌐 Rust | 📅 2026-09-06 A Terminal User Interface for Taskwarrior
* [jiratui](https://github.com/whyisdifficult/jiratui) ⭐ 1,692 | 🐛 11 | 🌐 Python | 📅 2026-09-05 A TUI for interacting with Atlassian Jira directly from your shell
* [sshm](https://github.com/gu1llaum-3/sshm) ⭐ 1,381 | 🐛 34 | 🌐 Go | 📅 2026-07-27 SSH made easy and fast: browse, connect, and control from your terminal with a modern TUI
...
* [longbridge-terminal](https://github.com/longbridge/longbridge-terminal) ⭐ 994 | 🐛 12 | 🌐 Rust | 📅 2026-09-03 AI-native TUI for Longbridge Securities: real-time quotes, portfolio management, and trading for HK/US/A-share/SG markets.
...
* [agent-deck](https://github.com/asheshgoplani/agent-deck) ⭐ 847 | 🐛 80 | 🌐 Go | 📅 2026-09-06 Terminal dashboard for managing multiple AI coding agent sessions
...
* [pomo](https://github.com/Bahaaio/pomo) ⭐ 494 | 🐛 4 | 🌐 Go | 📅 2026-06-06 A minimal, customizable TUI Pomodoro timer with ASCII art, progress bar, desktop notifications, and productivity statistics.
...
* [tiki](https://github.com/boolean-maybe/tiki) ⭐ 207 | 🐛 10 | 🌐 Go | 📅 2026-08-12 Markdown-based git-versioned project and issue manager
...
* [kanban](https://github.com/fulsomenko/kanban) ⭐ 166 | 🐛 13 | 🌐 Rust | 📅 2026-09-06 TUI kanban board for projects management with sprint tracking and task prioritization.
...
* [portfolio\_rs](https://github.com/MarkusZoppelt/portfolio_rs) ⭐ 92 | 🐛 3 | 🌐 Rust | 📅 2026-09-01 A command line tool for managing financial investment portfolios.
...
* [browsh](https://github.com/browsh-org/browsh) ⭐ 19,029 | 🐛 241 | 🌐 JavaScript | 📅 2025-07-11 A fully-modern text-based browser, rendering to TTY and browsers
* [rtorrent](https://github.com/rakshasa/rtorrent) ⭐ 4,855 | 🐛 397 | 🌐 C++ | 📅 2026-09-06 A text-based BitTorrent client written in C++
...
* [surge](https://github.com/surge-downloader/surge) ⭐ 3,508 | 🐛 56 | 🌐 Go | 📅 2026-09-03 A blazing fast, beautiful TUI download manager built in Go.
...
* [cloudflare-speed-cli](https://github.com/kavehtehrani/cloudflare-speed-cli) ⭐ 1,028 | 🐛 0 | 🌐 Rust | 📅 2026-07-27 Internet speed test via Cloudflare
* [eilmeldung](https://github.com/christo-auer/eilmeldung) ⭐ 991 | 🐛 1 | 🌐 Rust | 📅 2026-09-04 RSS reader, supporting many RSS providers, bulk-operations and configuration options.

...
There's a lot of cool projects here that I have no association with. Run them at your own risk. If you have a cool tool you'd like to share please [open a PR](https://github.com/rothgar/awesome-tuis/pulls) ⭐ 20,276 | 🐛 79 | 📅 2026-08-11.
...
* [btop++](https://github.com/aristocratos/btop) ⭐ 34,149 | 🐛 529 | 🌐 C++ | 📅 2026-08-22 Resource monitor with extras
* [Glances](https://github.com/nicolargo/glances) ⭐ 33,404 | 🐛 103 | 🌐 Python | 📅 2026-08-22 Glances an Eye on your system. A top/htop alternative.
* [Goaccess](https://github.com/allinurl/goaccess) ⭐ 20,830 | 🐛 456 | 🌐 C | 📅 2026-08-20 GoAccess is a real-time web log analyzer and interactive viewer that runs in a terminal in nix systems or through your browser.
* [WTF](https://github.com/senorprogrammer/wtf) ⭐ 17,059 | 🐛 102 | 🌐 Go | 📅 2026-08-05 The personal information dashboard for your terminal.
* [bottom](https://github.com/ClementTsang/bottom) ⭐ 13,924 | 🐛 107 | 🌐 Rust | 📅 2026-08-22 A customizable graphical process/system monitor for the terminal.
...
* [gh-dash](https://github.com/dlvhdr/gh-dash) ⭐ 12,346 | 🐛 98 | 🌐 Go | 📅 2026-08-01 A rich terminal UI for GitHub PRs and Issues
...
* [talos linux](https://github.com/siderolabs/talos) ⭐ 10,997 | 🐛 220 | 🌐 Go | 📅 2026-08-21 A Linux distro with a TUI dashboard for local and remote usage
* [nvtop](https://github.com/Syllo/nvtop) ⭐ 10,932 | 🐛 144 | 🌐 C | 📅 2026-05-06 GPUs process monitoring for AMD, Intel and NVIDIA
...
* [htop](https://github.com/htop-dev/htop) ⭐ 8,271 | 🐛 352 | 🌐 C | 📅 2026-08-22 Interactive text-mode process viewer for Unix systems. It aims to be a better 'top'
* [trippy](https://github.com/fujiapple852/trippy) ⭐ 7,514 | 🐛 76 | 🌐 Rust | 📅 2026-08-22 A network diagnostic tool that includes functionality like mtr and more
* [Backlog.md](https://github.com/MrLesk/Backlog.md) ⭐ 6,526 | 🐛 33 | 🌐 TypeScript | 📅 2026-08-20 A tool for managing project collaboration between humans and AI Agents in a git ecosystem
* [ticker](https://github.com/achannarasappa/ticker) ⭐ 6,216 | 🐛 35 | 🌐 Go | 📅 2026-06-28 Track stocks, crypto, and derivatives prices and positions in real time from your terminal
* [s-tui](https://github.com/amanusk/s-tui) ⭐ 5,067 | 🐛 39 | 🌐 Python | 📅 2026-08-19 CPU stress and monitoring utility
* [Kyanos](https://github.com/hengyoush/kyanos) ⭐ 5,065 | 🐛 33 | 🌐 C | 📅 2026-08-20 Linux network analysis tool based on eBPF
* [rustnet](https://github.com/domcyrus/rustnet) ⭐ 4,889 | 🐛 17 | 🌐 Rust | 📅 2026-08-22 A cross-platform network monitoring tool with deep packet inspection
* [binsider](https://github.com/orhun/binsider) ⭐ 4,396 | 🐛 35 | 🌐 Rust | 📅 2026-08-16 A TUI for analyzing Linux binaries.
...
* [psmux](https://github.com/marlocarlo/psmux) ⭐ 3,314 | 🐛 13 | 🌐 PowerShell | 📅 2026-08-22 tmux-compatible terminal multiplexer for Windows built in Rust with ratatui.
...
* [gonzo](https://github.com/control-theory/gonzo) ⭐ 2,752 | 🐛 18 | 🌐 Go | 📅 2026-07-15 A powerful, real-time log analysis terminal UI inspired by k9s.
* [process-compose](https://github.com/F1bonacc1/process-compose) ⭐ 2,702 | 🐛 18 | 🌐 Go | 📅 2026-08-17 TUI for running apps and processes
...
* [cgdb](https://github.com/cgdb/cgdb) ⭐ 1,841 | 🐛 46 | 🌐 C | 📅 2026-02-27 Console front-end to the GNU debugger
* [macmon](https://github.com/vladkens/macmon) ⭐ 1,823 | 🐛 14 | 🌐 Rust | 📅 2026-08-04 Sudoless performance monitoring for Apple Silicon processors written in Rust
...
* [bmon](https://github.com/tgraf/bmon) ⭐ 1,381 | 🐛 38 | 🌐 C | 📅 2026-08-03 A monitoring and debugging tool to capture networking related statistics and prepare them visually.
* [dolphie](https://github.com/charles-001/dolphie) ⭐ 1,191 | 🐛 2 | 🌐 Python | 📅 2026-08-22 Your single pane of glass for real-time analytics into MySQL/MariaDB & ProxySQL
...
* [framework-tool-tui](https://github.com/grouzen/framework-tool-tui) ⭐ 349 | 🐛 10 | 🌐 Rust | 📅 2026-08-16 TUI for controlling and monitoring Framework Computers hardware built in Rust
* [Yozefu](https://github.com/MAIF/yozefu) ⭐ 343 | 🐛 16 | 🌐 Rust | 📅 2026-08-18 A TUI for exploring data of a kafka cluster.
...
* [pstop](https://github.com/marlocarlo/pstop) ⭐ 237 | 🐛 6 | 🌐 Rust | 📅 2026-07-18 htop-style system monitor for Windows with per-core CPU bars, tree view, and 7 color schemes.
...
* [sockttop](https://github.com/jasonwitty/socktop) ⭐ 188 | 🐛 1 | 🌐 Rust | 📅 2026-08-21 socktop is a remote system monitor with a rich TUI, inspired by top/btop, talking to a lightweight agent over WebSockets.
...
* [psnet](https://github.com/marlocarlo/psnet) ⭐ 141 | 🐛 3 | 🌐 Rust | 📅 2026-08-10 Real-time TUI network monitor for Windows with speed graphs, DNS resolution, and packet inspection.
...
* [opencode](https://github.com/sst/opencode) ⭐ 200,292 | 🐛 5,352 | 🌐 TypeScript | 📅 2026-08-22 AI coding agent, built for the terminal
* [codex](https://github.com/openai/codex) ⭐ 112,886 | 🐛 13,478 | 🌐 Rust | 📅 2026-08-22 Lightweight coding agent that runs in your terminal
* [lazygit](https://github.com/jesseduffield/lazygit) ⭐ 81,549 | 🐛 1,025 | 🌐 Go | 📅 2026-08-21 Simple terminal UI for git commands
* [delta](https://github.com/dandavison/delta) ⭐ 31,828 | 🐛 429 | 🌐 Rust | 📅 2026-08-02 A syntax-highlighting pager for git, diff, and grep output
* [crush](https://github.com/charmbracelet/crush) ⭐ 27,580 | 🐛 666 | 🌐 Go | 📅 2026-08-22 The glamourous AI coding agent
* [gitui](https://github.com/extrawurst/gitui) ⭐ 22,414 | 🐛 341 | 🌐 Rust | 📅 2026-08-04 blazing fast terminal-ui for git written in rust
...
* [posting](https://github.com/darrenburns/posting) ⭐ 12,296 | 🐛 83 | 🌐 Python | 📅 2026-03-25 A powerful HTTP client that lives in your terminal
* [Claude Code Usage Monitor](https://github.com/Maciek-roboblog/Claude-Code-Usage-Monitor) ⭐ 8,650 | 🐛 36 | 🌐 Python | 📅 2026-07-05 Monitor Claude token usage
...
* [soft-serve](https://github.com/charmbracelet/soft-serve) ⭐ 7,190 | 🐛 78 | 🌐 Go | 📅 2026-08-12 A tasty, self-hostable Git server for the command lineicecream
* [harlequin](https://github.com/tconbeer/harlequin) ⭐ 6,339 | 🐛 45 | 🌐 Python | 📅 2026-08-20 The SQL IDE for Your Terminal
* [rainfrog](https://github.com/achristmascarl/rainfrog) ⭐ 5,287 | 🐛 17 | 🌐 Rust | 📅 2026-08-21 A database management TUI for Postgres, MySQL, and SQLite written in Rust
* [sqlit](https://github.com/Maxteabag/sqlit) ⭐ 4,702 | 🐛 32 | 🌐 Python | 📅 2026-08-07 A lightweight TUI for SQL databases inspired by lazygit
* [lazysql](https://github.com/jorgerojas26/lazysql) ⭐ 4,237 | 🐛 50 | 🌐 Go | 📅 2026-08-20 A cross-platform TUI database management tool written in Go.
* [grv](https://github.com/rgburke/grv) ⭐ 4,093 | 🐛 31 | 🌐 Go | 📅 2019-05-01 Terminal interface for viewing git repositories
* [ATAC](https://github.com/Julien-cpsn/ATAC) ⭐ 3,701 | 🐛 21 | 🌐 Rust | 📅 2026-03-09 A feature-full TUI API client made in Rust. ATAC is free, open-source, offline and account-less.
* [Claude Code Bridge](https://github.com/bfly123/claude_code_bridge) ⭐ 3,435 | 🐛 101 | 🌐 Python | 📅 2026-08-20 Real-time multi-AI collaboration between Claude, Codex and Gemini in terminal
* [Toad](https://github.com/batrachianai/toad) ⭐ 3,378 | 🐛 6 | 🌐 Python | 📅 2026-05-26 A unified interface for AI
* [pudb](https://github.com/inducer/pudb) ⭐ 3,248 | 🐛 164 | 🌐 Python | 📅 2026-08-16 A console-based visual debugger for Python
...
* [euporie](https://github.com/joouha/euporie) ⭐ 2,637 | 🐛 15 | 🌐 Python | 📅 2026-08-21 Jupyter notebooks in the terminal
* [nap](https://github.com/maaslalani/nap) ⭐ 2,218 | 🐛 17 | 🌐 Go | 📅 2024-05-18 Code snippets in your terminal
* [runme](https://github.com/stateful/runme) ⭐ 2,140 | 🐛 152 | 🌐 Go | 📅 2026-08-22 Discover and run code snippets directly from your README.md or other markdowns
* [serie](https://github.com/lusingander/serie) ⭐ 2,049 | 🐛 22 | 🌐 Rust | 📅 2026-08-21 A rich git commit graph
* [resterm](https://github.com/unkn0wn-root/resterm) ⭐ 1,860 | 🐛 0 | 🌐 Go | 📅 2026-08-22 A terminal client for HTTP/GraphQL/gRPC with support for WebSockets, SSE, workflows, profiling, OpenAPI and response diffs.
...
* [VT Code](https://github.com/vinhnx/vtcode) ⭐ 816 | 🐛 1 | 🌐 Rust | 📅 2026-08-22 VT Code - Semantic Coding Agent
...
* [models](https://github.com/arimxyer/models) ⭐ 494 | 🐛 0 | 🌐 Rust | 📅 2026-08-22 TUI for browsing AI models and coding agents
...
* [sabiql](https://github.com/riii111/sabiql) ⭐ 254 | 🐛 7 | 🌐 Rust | 📅 2026-08-22 A fast, driver-less TUI to browse, query, and edit PostgreSQL databases, written in Rust
...
* [scope](https://github.com/matheuswhite/scope-rs) ⭐ 61 | 🐛 15 | 🌐 Rust | 📅 2026-08-17 Cross-platform serial-port & RTT monitor with colored timestamped I/O, hex/@tag input macros, search, session recording, auto-reconnect and Lua plugins
...
* [lazydocker](https://github.com/jesseduffield/lazydocker) ⭐ 52,575 | 🐛 292 | 🌐 Go | 📅 2026-04-19 The lazier way to manage everything docker
* [k9s](https://github.com/derailed/k9s) ⭐ 34,410 | 🐛 111 | 🌐 Go | 📅 2026-08-21 TUI for managing a Kubernetes cluster
...
* [kdash](https://github.com/kdash-rs/kdash) ⭐ 2,523 | 🐛 2 | 🌐 Rust | 📅 2026-08-19 A simple and fast dashboard for Kubernetes
...
* [kftui](https://github.com/hcavarsan/kftray) ⭐ 1,551 | 🐛 18 | 🌐 Rust | 📅 2026-08-22 A TUI to manage multiple kubectl port-forward commands, with support for UDP and K8s proxy.
* [dtop](https://github.com/amir20/dtop) ⭐ 1,348 | 🐛 1 | 🌐 Rust | 📅 2026-08-20 Terminal dashboard for Docker monitoring across multiple hosts
* [Podman-tui](https://github.com/containers/podman-tui) ⭐ 1,203 | 🐛 17 | 🌐 Go | 📅 2026-08-19 TUI for Podman containers
...
* [micro](https://github.com/zyedidia/micro) ⭐ 29,415 | 🐛 1,033 | 🌐 Go | 📅 2026-08-22 A modern and intuitive terminal-based text editor
* [Edit](https://github.com/microsoft/edit) ⭐ 14,478 | 🐛 163 | 🌐 Rust | 📅 2026-08-19 A simple text editor. Pays homage to the classic MS-DOS Editor.
* [kilo](https://github.com/antirez/kilo) ⭐ 9,081 | 🐛 62 | 🌐 C | 📅 2025-01-04 A minimal but complete editor in \~1000 lines of C code.
* [Fresh](https://github.com/sinelaw/fresh) ⭐ 8,441 | 🐛 296 | 🌐 Rust | 📅 2026-08-21 An easy-to-use, powerful and fast terminal-based text editor.
...
* [Durdraw](https://github.com/cmang/durdraw) ⭐ 1,790 | 🐛 4 | 🌐 Python | 📅 2026-08-18 An ASCII, Unicode and ANSI art editor
...
* [treemd](https://github.com/Epistates/treemd) ⭐ 677 | 🐛 5 | 🌐 Rust | 📅 2026-08-22 A markdown navigator with tree-based structural navigation
...
* [yazi](https://github.com/sxyazi/yazi) ⭐ 41,601 | 🐛 66 | 🌐 Rust | 📅 2026-08-22 Blazing fast terminal file manager written in Rust, based on async I/O.
* [superfile](https://github.com/MHNightCat/superfile) ⭐ 22,730 | 🐛 257 | 🌐 Go | 📅 2026-08-20 Pretty fancy and modern terminal file manager.
* [nnn](https://github.com/jarun/nnn) ⭐ 21,819 | 🐛 5 | 🌐 C | 📅 2026-08-17 n³ The unorthodox terminal file manager.
* [ranger](https://github.com/ranger/ranger) ⭐ 17,359 | 🐛 899 | 🌐 Python | 📅 2026-08-15 A VIM-inspired file manager for the console.
* [broot](https://github.com/Canop/broot) ⭐ 12,907 | 🐛 232 | 🌐 Rust | 📅 2026-08-22 A new way to see and navigate directory trees
* [lf](https://github.com/gokcehan/lf) ⭐ 9,469 | 🐛 82 | 🌐 Go | 📅 2026-08-15 A terminal file manager written in Go with heavy inspiration from ranger file manager.
...
* [far2l](https://github.com/elfmz/far2l) ⭐ 2,210 | 🐛 474 | 🌐 C++ | 📅 2026-08-22 Linux port of Far v2 file manager
...
* [rovr](https://github.com/NSPC911/rovr) ⭐ 403 | 🐛 14 | 🌐 Python | 📅 2026-08-22 A post-modern terminal file manager.
...
* [NetHack](https://github.com/NetHack/NetHack) ⭐ 3,875 | 🐛 141 | 🌐 C | 📅 2026-08-22 Dungeon exploration game
...
* [GitType](https://github.com/unhappychoice/gittype) ⭐ 1,571 | 🐛 14 | 🌐 Rust | 📅 2026-08-19 A CLI code-typing game that turns your source code into typing challenges
* [BrogueCE](https://github.com/tmewett/BrogueCE) ⭐ 1,445 | 🐛 205 | 🌐 C | 📅 2026-08-05 Beautiful roguelike dungeon crawler
* [chess-tui](https://github.com/thomas-mauran/chess-tui) ⭐ 1,157 | 🐛 30 | 🌐 Rust | 📅 2026-08-17 Play Chess in your terminal, built in rust
* [steam-tui](https://github.com/dmadisetti/steam-tui) ⭐ 1,033 | 🐛 9 | 🌐 Rust | 📅 2026-03-12 Just a simple TUI client for steamcmd. Allows for the graphical launching, updating, and downloading of steam games through a simple terminal client.
...
* [Rich](https://github.com/willmcgugan/rich) ⭐ 57,112 | 🐛 373 | 🌐 Python | 📅 2026-06-23 is a **Python** library for rich text and beautiful formatting in the terminal.
* [textual](https://github.com/willmcgugan/textual) ⭐ 37,002 | 🐛 353 | 🌐 Python | 📅 2026-07-11 is a TUI (Text User Interface) framework for **Python** inspired by modern web development.
...
* [notcurses](https://github.com/dankamongmen/notcurses) ⭐ 4,670 | 🐛 327 | 🌐 C | 📅 2026-05-18 blingful character graphics/TUI library for **C** and **Python**. definitely not curses.
* [urwid](https://github.com/urwid/urwid) ⭐ 3,013 | 🐛 136 | 🌐 Python | 📅 2026-08-19 A console user interface library for **Python** on Linux, OSX, Cygwin or other unix-like OS.
...
* [bubbletea](https://github.com/charmbracelet/bubbletea) ⭐ 44,495 | 🐛 200 | 🌐 Go | 📅 2026-08-19 A **Go** framework based on Elm to build functional and fun terminal apps
...
* [libuv](https://github.com/libuv/libuv) ⭐ 27,125 | 🐛 227 | 🌐 C | 📅 2026-08-20 Cross-platform asynchronous I/O library - written in **C**
...
* [FTXUI](https://github.com/ArthurSonzogni/FTXUI) ⭐ 10,584 | 🐛 106 | 🌐 C++ | 📅 2026-08-18 💻 **C++** Functional Terminal User Interface. ❤️
...
* [tvision](https://github.com/magiblot/tvision) ⭐ 3,129 | 🐛 42 | 🌐 C++ | 📅 2026-08-22 A modern port of **C++** Turbo Vision 2.0, cross-platform and Unicode support.
...
* [FINAL CUT](https://github.com/gansm/finalcut) ⭐ 1,197 | 🐛 13 | 🌐 C++ | 📅 2026-08-19 **C++** library for creating terminal applications with text-based widgets
* [xtd](https://github.com/gammasoft71/xtd) ⭐ 1,159 | 🐛 98 | 🌐 C++ | 📅 2026-08-21 Free open-source modern **C++** framework to create console (CLI), forms (GUI like WinForms) and unit test (xUnit) applications and libraries on Windows, macOS, Linux, iOS, Android, FreeBSD, and Haiku.
...
* [Spectre.Console](https://github.com/spectreconsole/spectre.console) ⭐ 11,595 | 🐛 182 | 🌐 C# | 📅 2026-08-21 A **.NET** library for creating beautiful console applications
* [Terminal.Gui](https://github.com/gui-cs/Terminal.Gui) ⭐ 11,179 | 🐛 45 | 🌐 C# | 📅 2026-08-22 Cross-platform terminal UI toolkit for **.NET**
* [Consolonia](https://github.com/jinek/Consolonia) ⭐ 819 | 🐛 55 | 🌐 C# | 📅 2026-08-21 A **.NET** terminal-based GUI framework with support of XAML
* [SharpConsoleUI](https://github.com/nickprotop/ConsoleEx) ⭐ 265 | 🐛 1 | 🌐 C# | 📅 2026-08-22 Multi-window TUI framework for **.NET** with overlapping windows, compositor effects, and Spectre.Console integration
...
* [Ratatui](https://github.com/tui-rs-revival/ratatui) ⭐ 22,321 | 🐛 233 | 🌐 Rust | 📅 2026-08-21 A **Rust** crate for building Terminal UIs (actively maintained fork of tui-rs).
...
* [iocraft](https://github.com/ccbrown/iocraft) ⭐ 1,521 | 🐛 27 | 🌐 Rust | 📅 2026-08-20 **Rust** crate for beautiful, artisanally crafted TUIs and text-based IO, with a declarative, React-like API inspired by Ink.
...
* [ink](https://github.com/vadimdemedes/ink) ⭐ 39,715 | 🐛 38 | 🌐 TypeScript | 📅 2026-08-12 React for **Node.js** interactive command-line apps
* [gum](https://github.com/charmbracelet/gum) ⭐ 24,263 | 🐛 187 | 🌐 Go | 📅 2026-08-20 A tool for glamorous **shell** scripts
* [OpenTUI](https://github.com/sst/opentui) ⭐ 13,121 | 🐛 223 | 🌐 TypeScript | 📅 2026-08-22 A **TypeScript** library for building terminal user interfaces (TUIs)
* [blessed](https://github.com/chjj/blessed) ⭐ 11,883 | 🐛 256 | 🌐 JavaScript | 📅 2024-03-22 A high-level terminal interface library for **Node.js**
  stateful TUI apps.
* [termbox2](https://github.com/termbox/termbox2) ⭐ 754 | 🐛 19 | 🌐 C | 📅 2026-08-11 A terminal rendering library for creating TUIs.
...
* [nocterm](https://github.com/Norbert515/nocterm) ⭐ 394 | 🐛 21 | 🌐 Dart | 📅 2026-08-10 A Flutter-like TUI framework for **Dart** with hot reload, 45+ components, and declarative UI patterns.
...
* [nomadnet](https://github.com/markqvist/NomadNet) ⭐ 2,445 | 🐛 0 | 🌐 Python | 📅 2026-05-28 Secure messaging network built on Reticulum
* [instagram-cli](https://github.com/supreme-gg-gg/instagram-cli) ⭐ 2,119 | 🐛 40 | 🌐 TypeScript | 📅 2026-08-16 Use Instagram from your terminal, the end of brainrot is here
* [nchat](https://github.com/d99kris/nchat) ⭐ 1,924 | 🐛 22 | 🌐 C++ | 📅 2026-08-22 Telegram/WhatsApp client
* [gomuks](https://github.com/tulir/gomuks) ⭐ 1,716 | 🐛 73 | 🌐 Go | 📅 2026-08-22 Matrix client
* [gurk-rs](https://github.com/boxdot/gurk-rs) ⭐ 1,362 | 🐛 100 | 🌐 Rust | 📅 2026-07-29 Signal Messenger client for terminal
* [toot](https://github.com/ihabunek/toot) ⭐ 1,320 | 🐛 127 | 🌐 Python | 📅 2026-07-04 Mastodon CLI & TUI
* [basalt](https://github.com/erikjuhani/basalt) ⭐ 1,318 | 🐛 44 | 🌐 Rust | 📅 2026-08-18 TUI Application to manage Obsidian vaults and notes directly from the terminal.
* [concord](https://github.com/chojs23/concord) ⭐ 1,251 | 🐛 37 | 🌐 Rust | 📅 2026-08-21 A feature-rich TUI client for Discord
* [matterhorn](https://github.com/matterhorn-chat/matterhorn) ⭐ 1,152 | 🐛 22 | 🌐 Haskell | 📅 2026-08-19 A Mattermost terminal client.
* [matcha](https://github.com/floatpane/matcha) ⭐ 1,067 | 🐛 86 | 🌐 Go | 📅 2026-08-19 Email client
...
* [endcord](https://github.com/mzivic7/endcord) ⭐ 957 | 🐛 2 | 🌐 Python | 📅 2026-08-22 Feature rich Discord TUI client.
...
* [fzf](https://github.com/junegunn/fzf) ⭐ 82,612 | 🐛 330 | 🌐 Go | 📅 2026-08-21 A general-purpose command-line fuzzy finder
* [wttr.in](https://github.com/chubin/wttr.in) ⭐ 30,390 | 🐛 328 | 🌐 Go | 📅 2026-08-02 The right way to check the weather
* [oha](https://github.com/hatoo/oha) ⭐ 10,500 | 🐛 57 | 🌐 Rust | 📅 2026-08-19 HTTP load generator
...
* [wego](https://github.com/schachmat/wego) ⭐ 8,535 | 🐛 16 | 🌐 Go | 📅 2026-08-01 Weather app
...
* [gdu](https://github.com/dundee/gdu) ⭐ 5,920 | 🐛 57 | 🌐 Go | 📅 2026-08-18 Fast disk usage analyzer with console interface written in Go
...
* [x-cmd](https://github.com/x-cmd/x-cmd) ⭐ 4,582 | 🐛 95 | 🌐 Awk | 📅 2026-08-22 A vast and interesting collection of tools that can then bootstrap lots of other programs / functions in a consistent and structured way.
* [csvlens](https://github.com/YS-L/csvlens) ⭐ 3,936 | 🐛 58 | 🌐 Rust | 📅 2026-07-04 TUI CSV file viewer. It is like less but made for CSV.
* [cfdisk](https://github.com/util-linux/util-linux) ⭐ 3,208 | 🐛 420 | 🌐 C | 📅 2026-08-20 TUI partition editor included in util-linux
* [diskonaut](https://github.com/imsnif/diskonaut) ⭐ 3,116 | 🐛 45 | 🌐 Rust | 📅 2024-03-07 Terminal disk space navigator
* [bluetui](https://github.com/pythops/bluetui) ⭐ 2,966 | 🐛 21 | 🌐 Rust | 📅 2026-07-17 A TUI for managing bluetooth devices.
* [gif-for-cli](https://github.com/google/gif-for-cli) ⚠️ Archived Convert a gif into ASCII
* [impala](https://github.com/pythops/impala) ⭐ 2,788 | 🐛 6 | 🌐 Rust | 📅 2026-08-17 TUI for managing wifi
* [tweakcc](https://github.com/Piebald-AI/tweakcc) ⭐ 2,453 | 🐛 53 | 🌐 TypeScript | 📅 2026-08-22 TUI to customize your Claude Code themes, thinking verbs, and more.
* [Caligula](https://github.com/ifd3f/caligula) ⭐ 2,218 | 🐛 51 | 🌐 Rust | 📅 2026-08-18 A user-friendly, lightweight TUI for imaging disks.
* [smassh](https://github.com/kraanzu/smassh) ⭐ 2,038 | 🐛 11 | 🌐 Python | 📅 2026-08-17 A TUI based typing test application inspired by MonkeyType.
...
* [Systemd-manager-tui](https://github.com/matheus-git/systemd-manager-tui) ⭐ 1,566 | 🐛 4 | 🌐 Rust | 📅 2026-08-03 A program for managing systemd services through a TUI.
...
* [mac-cleanup-go](https://github.com/2ykwang/mac-cleanup-go) ⭐ 453 | 🐛 6 | 🌐 Go | 📅 2026-08-20 macOS disk cleanup TUI: scan cache/dev artifacts, preview, exclude, and move items to Trash.
...
* [vlc](https://github.com/videolan/vlc) ⭐ 19,417 | 🐛 2 | 🌐 C | 📅 2026-08-22 VLC includes an ncurses interface, `vlc --intf ncurses`
...
* [spotify-player](https://github.com/aome510/spotify-player) ⭐ 7,107 | 🐛 164 | 🌐 Rust | 📅 2026-07-20 A Spotify player in the terminal with full feature parity
* [ncspot](https://github.com/hrkfdn/ncspot) ⭐ 6,732 | 🐛 210 | 🌐 Rust | 📅 2026-08-21 Cross-platform ncurses Spotify client written in Rust
...
* [kew](https://github.com/ravachol/kew) ⭐ 2,985 | 🐛 2 | 🌐 C | 📅 2026-08-22 A terminal music player for Linux
...
* [spotatui](https://github.com/LargeModGames/spotatui) ⭐ 1,247 | 🐛 27 | 🌐 Rust | 📅 2026-08-22 Spotify client with native streaming, synced lyrics, and real-time audio visualization
* [textual-paint](https://github.com/1j01/textual-paint) ⭐ 1,121 | 🐛 10 | 🌐 Python | 📅 2026-02-21 MS Paint in your terminal
* [bookokrat](https://github.com/bugzmanov/bookokrat) ⭐ 1,103 | 🐛 47 | 🌐 Rust | 📅 2026-08-08 Full-featured EPUB books reader with Vim keybindings.
* [pyradio](https://github.com/coderholic/pyradio) ⭐ 1,090 | 🐛 11 | 🌐 Python | 📅 2026-05-07 TUI web radio player with thousands of stations from around the world
* [viu](https://github.com/viu-media/viu) ⚠️ Archived Your browser anime experience from the terminal
* [wiremix](https://github.com/tsowell/wiremix) ⭐ 1,022 | 🐛 37 | 🌐 Rust | 📅 2026-07-12 TUI audio mixer for PipeWire similar to pavucontrol to adjust volumes, change input/output devices and their profiles
...
* [jellyfin-tui](https://github.com/dhonus/jellyfin-tui) ⭐ 574 | 🐛 25 | 🌐 Rust | 📅 2026-08-09 Jellyfin client
...
* [mpvc](https://github.com/gmt4/mpvc) ⭐ 156 | 🐛 1 | 🌐 Shell | 📅 2026-08-22 A mpc-like control interface for mpv
* [line](https://github.com/pd3v/line) ⭐ 152 | 🐛 0 | 🌐 C++ | 📅 2025-08-11 Tiny command-line midi sequencer and language for live coding
* [Trophy](https://github.com/taigrr/trophy) ⭐ 128 | 🐛 1 | 🌐 Go | 📅 2026-08-20 A TUI 3D Model Viewer for OBJ and GLB files
...
* [valveFM](https://github.com/zorig/valvefm) ⭐ 53 | 🐛 0 | 🌐 Go | 📅 2026-08-20 Vintage FM radio TUI for streaming stations from radio-browser.info
...
* [tmux](https://github.com/tmux/tmux) ⭐ 48,760 | 🐛 28 | 🌐 C | 📅 2026-08-22 Terminal multiplexer
* [zellij](https://github.com/zellij-org/zellij) ⭐ 35,050 | 🐛 1,870 | 🌐 Rust | 📅 2026-08-20 A terminal workspace with batteries included
* [Glow](https://github.com/charmbracelet/glow) ⭐ 27,003 | 🐛 222 | 🌐 Go | 📅 2026-08-16 A markdown reader, designed from the ground up to showcase the elegance and capabilities of TUI.
* [slides](https://github.com/maaslalani/slides) ⭐ 11,622 | 🐛 77 | 🌐 Go | 📅 2026-07-08 A terminal based presentation tool, supporting markdown syntax.
* [Visidata](https://github.com/saulpw/visidata) ⭐ 9,250 | 🐛 79 | 🌐 Python | 📅 2026-08-15 A terminal spreadsheet multitool for discovering and arranging data
...
* [television](https://github.com/alexpasmantier/television) ⭐ 6,198 | 🐛 82 | 🌐 Rust | 📅 2026-08-16 A fast and versatile fuzzy finder TUI
* [sc-im](https://github.com/andmarti1424/sc-im) ⭐ 5,686 | 🐛 118 | 🌐 C | 📅 2026-08-06 An ncurses spreadsheet program for terminal. Reignited version of sc
* [hledger-ui](https://github.com/simonmichael/hledger) ⭐ 4,660 | 🐛 336 | 🌐 Haskell | 📅 2026-08-22 A fast TUI for browsing double entry bookkeeping data
...
* [TUIOS](https://github.com/Gaurav-Gosain/tuios) ⭐ 3,532 | 🐛 17 | 🌐 Go | 📅 2026-08-22 A TUI window manager for managing multiple terminal sessions
* [Tabiew](https://github.com/shshemi/tabiew) ⭐ 3,082 | 🐛 15 | 🌐 Rust | 📅 2026-08-17 A lightweight app to view and query tabular data files, such as CSV, TSV, and parquet.
...
* [jiratui](https://github.com/whyisdifficult/jiratui) ⭐ 1,677 | 🐛 11 | 🌐 Python | 📅 2026-08-21 A TUI for interacting with Atlassian Jira directly from your shell
...
* [sshm](https://github.com/gu1llaum-3/sshm) ⭐ 1,368 | 🐛 29 | 🌐 Go | 📅 2026-07-27 SSH made easy and fast: browse, connect, and control from your terminal with a modern TUI
...
* [longbridge-terminal](https://github.com/longbridge/longbridge-terminal) ⭐ 987 | 🐛 11 | 🌐 Rust | 📅 2026-08-21 AI-native TUI for Longbridge Securities: real-time quotes, portfolio management, and trading for HK/US/A-share/SG markets.
* [ekphos](https://github.com/hanebox/ekphos) ⭐ 974 | 🐛 7 | 🌐 Rust | 📅 2026-08-21 A fast, lightweight, markdown research tool written in rust
* [dvtm](https://github.com/martanne/dvtm) ⭐ 961 | 🐛 77 | 🌐 C | 📅 2024-05-18 A terminal multiplexer with dwm like window management
...
* [agent-deck](https://github.com/asheshgoplani/agent-deck) ⭐ 773 | 🐛 25 | 🌐 Go | 📅 2026-08-22 Terminal dashboard for managing multiple AI coding agent sessions
...
* [tiki](https://github.com/boolean-maybe/tiki) ⭐ 198 | 🐛 10 | 🌐 Go | 📅 2026-08-12 Markdown-based git-versioned project and issue manager
...
* [tuiserial](https://github.com/Horldsence/tuiserial) ⭐ 27 | 🐛 0 | 🌐 Rust | 📅 2026-08-06 TUI Serial Port Tool for Edge Computing Devices
...
* [weathr](https://github.com/veirt/weathr) ⭐ 3,012 | 🐛 19 | 🌐 Rust | 📅 2026-08-12 A terminal weather app with ASCII animations for weather visualization
...
* [browsh](https://github.com/browsh-org/browsh) ⭐ 18,996 | 🐛 241 | 🌐 JavaScript | 📅 2025-07-11 A fully-modern text-based browser, rendering to TTY and browsers
* [rtorrent](https://github.com/rakshasa/rtorrent) ⭐ 4,845 | 🐛 400 | 🌐 C++ | 📅 2026-08-19 A text-based BitTorrent client written in C++
...
* [surge](https://github.com/surge-downloader/surge) ⭐ 3,471 | 🐛 52 | 🌐 Go | 📅 2026-08-21 A blazing fast, beautiful TUI download manager built in Go.
...
* [w3m](https://github.com/tats/w3m) ⭐ 1,074 | 🐛 79 | 🌐 C | 📅 2024-08-19 A text-mode WWW browser
* [cloudflare-speed-cli](https://github.com/kavehtehrani/cloudflare-speed-cli) ⭐ 993 | 🐛 0 | 🌐 Rust | 📅 2026-07-27 Internet speed test via Cloudflare
* [eilmeldung](https://github.com/christo-auer/eilmeldung) ⭐ 939 | 🐛 0 | 🌐 Rust | 📅 2026-08-14 RSS reader, supporting many RSS providers, bulk-operations and configuration options.
* [hackernews-TUI](https://github.com/aome510/hackernews-TUI) ⭐ 719 | 🐛 9 | 🌐 Rust | 📅 2026-03-29 A Terminal UI to browse Hacker News
* [nyaa](https://github.com/Beastwick18/nyaa) ⭐ 692 | 🐛 16 | 🌐 Rust | 📅 2026-02-28 A nyaa.si TUI for browsing and downloading torrents
* [castero](https://github.com/xgi/castero) ⭐ 683 | 🐛 32 | 🌐 Python | 📅 2026-04-21 A TUI app to listen to podcast
* [elinks](https://github.com/rkd77/elinks) ⭐ 630 | 🐛 121 | 🌐 C | 📅 2026-08-21 ELinks (HTTP/FTP/..) brower with mujs javascript support.
...
* [omaro](https://github.com/Rolv-Apneseth/omaro) ⭐ 21 | 🐛 4 | 🌐 Rust | 📅 2026-08-22 TUI to browse posts and comments on lobste.rs

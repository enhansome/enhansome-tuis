...
There's a lot of cool projects here that I have no association with. Run them at your own risk. If you have a cool tool you'd like to share please [open a PR](https://github.com/rothgar/awesome-tuis/pulls) ⭐ 20,711 | 🐛 45 | 📅 2026-09-22.
...
* [btop++](https://github.com/aristocratos/btop) ⭐ 34,728 | 🐛 546 | 🌐 C++ | 📅 2026-09-19 Resource monitor with extras
* [Glances](https://github.com/nicolargo/glances) ⭐ 33,662 | 🐛 106 | 🌐 Python | 📅 2026-09-23 Glances an Eye on your system. A top/htop alternative.
* [Goaccess](https://github.com/allinurl/goaccess) ⭐ 20,947 | 🐛 449 | 🌐 C | 📅 2026-09-19 GoAccess is a real-time web log analyzer and interactive viewer that runs in a terminal in nix systems or through your browser.
* [WTF](https://github.com/senorprogrammer/wtf) ⭐ 17,099 | 🐛 108 | 🌐 Go | 📅 2026-09-17 The personal information dashboard for your terminal.
* [bottom](https://github.com/ClementTsang/bottom) ⭐ 14,052 | 🐛 105 | 🌐 Rust | 📅 2026-09-23 A customizable graphical process/system monitor for the terminal.
...
* [gh-dash](https://github.com/dlvhdr/gh-dash) ⭐ 12,545 | 🐛 101 | 🌐 Go | 📅 2026-09-22 A rich terminal UI for GitHub PRs and Issues
* [bandwhich](https://github.com/imsnif/bandwhich) ⭐ 11,985 | 🐛 54 | 🌐 Rust | 📅 2026-08-01 Terminal bandwidth utilization tool
* [talos linux](https://github.com/siderolabs/talos) ⭐ 11,228 | 🐛 259 | 🌐 Go | 📅 2026-09-23 A Linux distro with a TUI dashboard for local and remote usage
...
* [htop](https://github.com/htop-dev/htop) ⭐ 8,344 | 🐛 355 | 🌐 C | 📅 2026-09-22 Interactive text-mode process viewer for Unix systems. It aims to be a better 'top'
...
* [trippy](https://github.com/fujiapple852/trippy) ⭐ 7,952 | 🐛 85 | 🌐 Rust | 📅 2026-09-15 A network diagnostic tool that includes functionality like mtr and more
* [Backlog.md](https://github.com/MrLesk/Backlog.md) ⭐ 6,827 | 🐛 73 | 🌐 TypeScript | 📅 2026-09-23 A tool for managing project collaboration between humans and AI Agents in a git ecosystem
* [ticker](https://github.com/achannarasappa/ticker) ⭐ 6,236 | 🐛 34 | 🌐 Go | 📅 2026-06-28 Track stocks, crypto, and derivatives prices and positions in real time from your terminal
...
* [binsider](https://github.com/orhun/binsider) ⭐ 4,438 | 🐛 38 | 🌐 Rust | 📅 2026-09-20 A TUI for analyzing Linux binaries.
...
* [psmux](https://github.com/marlocarlo/psmux) ⭐ 3,546 | 🐛 42 | 🌐 PowerShell | 📅 2026-09-23 tmux-compatible terminal multiplexer for Windows built in Rust with ratatui.
...
* [macmon](https://github.com/vladkens/macmon) ⭐ 1,894 | 🐛 17 | 🌐 Rust | 📅 2026-08-04 Sudoless performance monitoring for Apple Silicon processors written in Rust
* [sysz](https://github.com/joehillen/sysz) ⭐ 1,881 | 🐛 5 | 🌐 Shell | 📅 2024-04-22 An fzf terminal UI for systemctl
* [netscanner](https://github.com/Chleba/netscanner) ⭐ 1,859 | 🐛 6 | 🌐 Rust | 📅 2026-07-06 Network scanner
...
* [otel-tui](https://github.com/ymtdzzz/otel-tui) ⭐ 1,089 | 🐛 27 | 🌐 Go | 📅 2026-09-21 A terminal OpenTelemetry viewer
...
* [atop](https://github.com/Atoptool/atop/) ⭐ 1,065 | 🐛 60 | 🌐 C | 📅 2026-09-23 root level system and process monitor for Linux
...
* [ServerHub](https://github.com/nickprotop/ServerHub) ⭐ 47 | 🐛 0 | 🌐 C# | 📅 2026-07-18 A TUI server monitoring dashboard for Linux with real-time metrics, scriptable widgets, and remote management
* [trek](https://github.com/franckverrot/trek) ⭐ 32 | 🐛 1 | 🌐 Go | 📅 2023-08-30 ncurses explorer for Hashicorp Nomad clusters
* [Servonaut](https://github.com/zb-ss/servonaut) ⭐ 28 | 🐛 1 | 🌐 Python | 📅 2026-09-23 A TUI for managing AWS, Hetzner, OVH and custom SSH servers with log viewing, CloudWatch/CloudTrail browsing, IP banning, AI log analysis and a built-in MCP server
...
* [opencode](https://github.com/sst/opencode) ⭐ 209,655 | 🐛 6,185 | 🌐 TypeScript | 📅 2026-09-23 AI coding agent, built for the terminal
* [codex](https://github.com/openai/codex) ⭐ 126,170 | 🐛 18,480 | 🌐 Rust | 📅 2026-09-23 Lightweight coding agent that runs in your terminal
* [lazygit](https://github.com/jesseduffield/lazygit) ⭐ 82,616 | 🐛 1,052 | 🌐 Go | 📅 2026-09-23 Simple terminal UI for git commands
* [delta](https://github.com/dandavison/delta) ⭐ 32,315 | 🐛 447 | 🌐 Rust | 📅 2026-09-19 A syntax-highlighting pager for git, diff, and grep output
* [crush](https://github.com/charmbracelet/crush) ⭐ 28,273 | 🐛 793 | 🌐 Go | 📅 2026-09-23 The glamourous AI coding agent
* [gitui](https://github.com/extrawurst/gitui) ⭐ 22,516 | 🐛 346 | 🌐 Rust | 📅 2026-08-04 blazing fast terminal-ui for git written in rust
...
* [posting](https://github.com/darrenburns/posting) ⭐ 12,443 | 🐛 87 | 🌐 Python | 📅 2026-03-25 A powerful HTTP client that lives in your terminal
* [Claude Code Usage Monitor](https://github.com/Maciek-roboblog/Claude-Code-Usage-Monitor) ⭐ 8,717 | 🐛 38 | 🌐 Python | 📅 2026-07-05 Monitor Claude token usage
...
* [soft-serve](https://github.com/charmbracelet/soft-serve) ⭐ 7,228 | 🐛 82 | 🌐 Go | 📅 2026-09-01 A tasty, self-hostable Git server for the command lineicecream
* [harlequin](https://github.com/tconbeer/harlequin) ⭐ 6,416 | 🐛 32 | 🌐 Python | 📅 2026-09-21 The SQL IDE for Your Terminal
* [rainfrog](https://github.com/achristmascarl/rainfrog) ⭐ 5,344 | 🐛 14 | 🌐 Rust | 📅 2026-09-23 A database management TUI for Postgres, MySQL, and SQLite written in Rust
* [sqlit](https://github.com/Maxteabag/sqlit) ⭐ 4,853 | 🐛 18 | 🌐 Python | 📅 2026-09-10 A lightweight TUI for SQL databases inspired by lazygit
...
* [ATAC](https://github.com/Julien-cpsn/ATAC) ⭐ 3,729 | 🐛 21 | 🌐 Rust | 📅 2026-09-03 A feature-full TUI API client made in Rust. ATAC is free, open-source, offline and account-less.
* [Claude Code Bridge](https://github.com/bfly123/claude_code_bridge) ⭐ 3,522 | 🐛 102 | 🌐 Python | 📅 2026-09-21 Real-time multi-AI collaboration between Claude, Codex and Gemini in terminal
* [Toad](https://github.com/batrachianai/toad) ⭐ 3,445 | 🐛 7 | 🌐 Python | 📅 2026-05-26 A unified interface for AI
* [pudb](https://github.com/inducer/pudb) ⭐ 3,245 | 🐛 164 | 🌐 Python | 📅 2026-09-20 A console-based visual debugger for Python
* [dblab](https://github.com/danvergara/dblab) ⭐ 3,237 | 🐛 11 | 🌐 Go | 📅 2026-09-09 The database client every command line junkie deserves
* [jqp](https://github.com/noahgorstein/jqp) ⭐ 2,845 | 🐛 24 | 🌐 Go | 📅 2026-02-06 A TUI playground to experiment with jq
* [euporie](https://github.com/joouha/euporie) ⭐ 2,658 | 🐛 15 | 🌐 Python | 📅 2026-09-18 Jupyter notebooks in the terminal
...
* [serie](https://github.com/lusingander/serie) ⭐ 2,115 | 🐛 25 | 🌐 Rust | 📅 2026-09-22 A rich git commit graph
* [resterm](https://github.com/unkn0wn-root/resterm) ⭐ 1,947 | 🐛 0 | 🌐 Go | 📅 2026-09-21 A terminal client for HTTP/GraphQL/gRPC with support for WebSockets, SSE, workflows, profiling, OpenAPI and response diffs.
* [termdbms](https://github.com/mathaou/termdbms) ⭐ 1,824 | 🐛 6 | 🌐 Go | 📅 2022-06-11 A TUI for viewing and editing database files.
* [lazyjournal](https://github.com/Lifailon/lazyjournal) ⭐ 1,410 | 🐛 9 | 🌐 Go | 📅 2026-08-01 TUI for journalctl, file system logs, as well Docker and Podman containers for quick viewing and filtering
* [snips.sh](https://github.com/robherley/snips.sh) ⭐ 1,308 | 🐛 13 | 🌐 Go | 📅 2026-09-08 ✂️ passwordless, anonymous SSH-powered pastebin with a human-friendly TUI and web UI
* [terraform-tui](https://github.com/idoavrah/terraform-tui) ⭐ 1,294 | 🐛 4 | 🌐 Python | 📅 2026-09-07 view and interact with Terraform state
...
* [VT Code](https://github.com/vinhnx/vtcode) ⭐ 854 | 🐛 3 | 🌐 Rust | 📅 2026-09-23 VT Code - Semantic Coding Agent
...
* [hcom](https://github.com/aannoo/hcom) ⭐ 515 | 🐛 37 | 🌐 Rust | 📅 2026-09-13 CLI and TUI for real-time messaging, observation, and orchestration between AI coding agents (Claude Code, Antigravity, Codex, OpenCode, Kilo, Cursor) across terminals
* [models](https://github.com/arimxyer/models) ⭐ 510 | 🐛 0 | 🌐 Rust | 📅 2026-09-23 TUI for browsing AI models and coding agents
...
* [ec](https://github.com/chojs23/ec) ⭐ 303 | 🐛 1 | 🌐 Go | 📅 2026-09-11 A TUI native Git mergetool with 3 panes
* [ggc](https://github.com/bmf-san/ggc) ⭐ 283 | 🐛 0 | 🌐 Go | 📅 2026-09-22 A terminal-based Git CLI tool written in Go
...
* [gitwig](https://github.com/tareqmy/gitwig) ⭐ 88 | 🐛 0 | 🌐 Rust | 📅 2026-09-23 - A mouse-drivable git TUI and multi-repo dashboard built in Rust.
...
* [y509](https://github.com/kanywst/y509) ⭐ 33 | 🐛 1 | 🌐 Go | 📅 2026-09-21 Inspect X.509 certificate chains, catching the missing intermediates that break curl but not browsers
* [violet](https://github.com/braheezy/violet) ⭐ 31 | 🐛 4 | 🌐 Go | 📅 2026-02-16 Colorful TUI frontend to run Vagrant commands
* [DevProjex](https://github.com/Avazbek22/DevProjex) ⭐ 24 | 🐛 13 | 🌐 C# | 📅 2026-09-23 A cross-platform TUI for exploring project trees, selecting files, previewing AI-ready context, and exporting structured codebase snapshots.
...
* [lazydocker](https://github.com/jesseduffield/lazydocker) ⭐ 52,935 | 🐛 301 | 🌐 Go | 📅 2026-04-19 The lazier way to manage everything docker
* [k9s](https://github.com/derailed/k9s) ⭐ 34,662 | 🐛 82 | 🌐 Go | 📅 2026-09-22 TUI for managing a Kubernetes cluster
...
* [kftui](https://github.com/hcavarsan/kftray) ⭐ 1,563 | 🐛 4 | 🌐 Rust | 📅 2026-09-23 A TUI to manage multiple kubectl port-forward commands, with support for UDP and K8s proxy.
* [dtop](https://github.com/amir20/dtop) ⭐ 1,429 | 🐛 1 | 🌐 Rust | 📅 2026-09-10 Terminal dashboard for Docker monitoring across multiple hosts
...
* [kubetui](https://github.com/sarub0b0/kubetui) ⭐ 395 | 🐛 12 | 🌐 Rust | 📅 2026-09-23 A TUI tool designed for monitoring Kubernetes resources.
...
* [micro](https://github.com/zyedidia/micro) ⭐ 29,628 | 🐛 915 | 🌐 Go | 📅 2026-09-23 A modern and intuitive terminal-based text editor
* [Edit](https://github.com/microsoft/edit) ⭐ 14,603 | 🐛 167 | 🌐 Rust | 📅 2026-09-23 A simple text editor. Pays homage to the classic MS-DOS Editor.
* [kilo](https://github.com/antirez/kilo) ⭐ 9,137 | 🐛 64 | 🌐 C | 📅 2025-01-04 A minimal but complete editor in \~1000 lines of C code.
* [Fresh](https://github.com/sinelaw/fresh) ⭐ 9,003 | 🐛 370 | 🌐 Rust | 📅 2026-09-23 An easy-to-use, powerful and fast terminal-based text editor.
* [slap](https://github.com/slap-editor/slap) ⭐ 6,188 | 🐛 115 | 🌐 JavaScript | 📅 2021-11-01 Sublime-like terminal-based text editor
* [vis](https://github.com/martanne/vis) ⭐ 4,726 | 🐛 153 | 🌐 C | 📅 2026-09-23 A vi-like editor based on Plan 9's structural regular expressions
* [amp](https://github.com/jmacdonald/amp) ⭐ 4,127 | 🐛 95 | 🌐 Rust | 📅 2026-06-10 A complete text editor for your terminal
* [frogmouth](https://github.com/Textualize/frogmouth) ⭐ 3,295 | 🐛 46 | 🌐 Python | 📅 2024-08-01 A Markdown browser for your terminal
* [flow-control](https://github.com/neurocyte/flow) ⭐ 2,428 | 🐛 78 | 🌐 Zig | 📅 2026-09-23 A lightning-fast, feature-rich text editor written in Zig
* [Durdraw](https://github.com/cmang/durdraw) ⭐ 1,826 | 🐛 8 | 🌐 Python | 📅 2026-09-23 An ASCII, Unicode and ANSI art editor
* [zee](https://github.com/zee-editor/zee) ⭐ 1,805 | 🐛 44 | 🌐 Rust | 📅 2025-02-06 A modern text editor for the terminal written in Rust
* [orbiton](https://github.com/xyproto/orbiton) ⭐ 703 | 🐛 0 | 🌐 Go | 📅 2026-09-23 Text editor limited by VT100, suitable for programming, writing git commit messages and editing Markdown
...
* [lazyide](https://github.com/TysonLabs/lazyide) ⭐ 93 | 🐛 3 | 🌐 Rust | 📅 2026-09-18 A lightweight terminal IDE in Rust: file tree, tabs, split panes, LSP, git diff view, minimap, 32 themes
...
* [yazi](https://github.com/sxyazi/yazi) ⭐ 42,376 | 🐛 63 | 🌐 Rust | 📅 2026-09-21 Blazing fast terminal file manager written in Rust, based on async I/O.
* [superfile](https://github.com/MHNightCat/superfile) ⭐ 23,361 | 🐛 270 | 🌐 Go | 📅 2026-09-23 Pretty fancy and modern terminal file manager.
* [nnn](https://github.com/jarun/nnn) ⭐ 21,999 | 🐛 1 | 🌐 C | 📅 2026-09-21 n³ The unorthodox terminal file manager.
* [ranger](https://github.com/ranger/ranger) ⭐ 17,411 | 🐛 897 | 🌐 Python | 📅 2026-09-09 A VIM-inspired file manager for the console.
* [broot](https://github.com/Canop/broot) ⭐ 12,956 | 🐛 100 | 🌐 Rust | 📅 2026-09-23 A new way to see and navigate directory trees
...
* [Vifm](https://github.com/vifm/vifm) ⭐ 3,274 | 🐛 146 | 🌐 C | 📅 2026-09-07 A TUI file manager with vi-keybindings and other vim like behaviour.
* [far2l](https://github.com/elfmz/far2l) ⭐ 2,218 | 🐛 482 | 🌐 C++ | 📅 2026-09-08 Linux port of Far v2 file manager
* [mc](https://github.com/MidnightCommander/mc) ⭐ 987 | 🐛 695 | 🌐 C | 📅 2026-09-16 GNU Midnight Commander. A free cross-platform orthodox file manager.
...
* [rovr](https://github.com/NSPC911/rovr) ⭐ 411 | 🐛 7 | 🌐 Python | 📅 2026-09-23 A post-modern terminal file manager.
...
* [fyzenor](https://github.com/Bimbok/fyzenor) ⭐ 14 | 🐛 7 | 🌐 C++ | 📅 2026-09-23 A modern, blazing-fast terminal file manager built in C++ with live previews, async workflows, and a polished three-column interface.
...
* [NetHack](https://github.com/NetHack/NetHack) ⭐ 3,919 | 🐛 150 | 🌐 C | 📅 2026-09-23 Dungeon exploration game
* [tinytetris](https://github.com/taylorconor/tinytetris) ⭐ 3,288 | 🐛 29 | 🌐 C++ | 📅 2024-07-09 80x23 terminal tetris!
...
* [GitType](https://github.com/unhappychoice/gittype) ⭐ 1,607 | 🐛 16 | 🌐 Rust | 📅 2026-09-23 A CLI code-typing game that turns your source code into typing challenges
* [BrogueCE](https://github.com/tmewett/BrogueCE) ⭐ 1,472 | 🐛 200 | 🌐 C | 📅 2026-09-20 Beautiful roguelike dungeon crawler
* [chess-tui](https://github.com/thomas-mauran/chess-tui) ⭐ 1,184 | 🐛 34 | 🌐 Rust | 📅 2026-09-17 Play Chess in your terminal, built in rust
...
* [LeTrain](https://github.com/antoniovazquezaraujo/LeTrain) ⭐ 19 | 🐛 36 | 🌐 Java | 📅 2026-09-23 - Open-source procedural train simulator using Java 17, LibGDX and Lanterna.
...
* [textual](https://github.com/willmcgugan/textual) ⭐ 37,313 | 🐛 359 | 🌐 Python | 📅 2026-07-11 is a TUI (Text User Interface) framework for **Python** inspired by modern web development.
...
* [urwid](https://github.com/urwid/urwid) ⭐ 3,021 | 🐛 118 | 🌐 Python | 📅 2026-09-23 A console user interface library for **Python** on Linux, OSX, Cygwin or other unix-like OS.
...
* [blessed](https://github.com/jquast/blessed) ⭐ 1,505 | 🐛 1 | 🌐 Python | 📅 2026-09-23 Blessed is an easy, practical library for making **Python** terminal apps
...
* [bubbletea](https://github.com/charmbracelet/bubbletea) ⭐ 45,099 | 🐛 231 | 🌐 Go | 📅 2026-09-22 A **Go** framework based on Elm to build functional and fun terminal apps
* [tview](https://github.com/rivo/tview/) ⭐ 14,109 | 🐛 97 | 🌐 Go | 📅 2026-08-11 Terminal UI library with rich, interactive widgets — written in **Go**
...
* [pterm](https://github.com/pterm/pterm/) ⭐ 5,541 | 🐛 87 | 🌐 Go | 📅 2026-07-11 A modern **Go** module to beautify console output. Featuring charts, progressbars, tables, trees, and much more! It's completely configurable and 100% cross-platform compatible.
* [tcell](https://github.com/gdamore/tcell) ⭐ 5,222 | 🐛 10 | 🌐 Go | 📅 2026-09-15 Tcell is an alternate **Go** terminal package, similar in some ways to termbox, but better in others.
...
* [libuv](https://github.com/libuv/libuv) ⭐ 27,196 | 🐛 242 | 🌐 C | 📅 2026-09-21 Cross-platform asynchronous I/O library - written in **C**
...
* [FTXUI](https://github.com/ArthurSonzogni/FTXUI) ⭐ 10,720 | 🐛 53 | 🌐 C++ | 📅 2026-09-23 💻 **C++** Functional Terminal User Interface. ❤️
...
* [xtd](https://github.com/gammasoft71/xtd) ⭐ 1,164 | 🐛 98 | 🌐 C++ | 📅 2026-09-23 Free open-source modern **C++** framework to create console (CLI), forms (GUI like WinForms) and unit test (xUnit) applications and libraries on Windows, macOS, Linux, iOS, Android, FreeBSD, and Haiku.
...
* [Lanterna](https://github.com/mabe02/lanterna) ⭐ 2,619 | 🐛 96 | 🌐 Java | 📅 2026-07-07 A **Java** library for creating text-based UIs, very similar to the C library curses but with more functionality.
* [TUI4J](https://github.com/WilliamAGH/tui4j) ⭐ 125 | 🐛 1 | 🌐 Java | 📅 2026-08-14 A **Java** terminal UI framework with a Bubble Tea (Go) port and additional features inspired by Textual.
* [casciian](https://github.com/crramirez/casciian) ⭐ 52 | 🐛 2 | 🌐 Java | 📅 2026-09-23 A Text User Interface Library for **Java** based on "Jexer" without the AWT/Swing dependencies, tailored for GraalVM AOT native compilation with a focus on performance over remote connections and maximum terminal compatibility.
...
* [Terminal.Gui](https://github.com/gui-cs/Terminal.Gui) ⭐ 11,220 | 🐛 48 | 🌐 C# | 📅 2026-09-23 Cross-platform terminal UI toolkit for **.NET**
* [Consolonia](https://github.com/jinek/Consolonia) ⭐ 829 | 🐛 51 | 🌐 C# | 📅 2026-09-13 A **.NET** terminal-based GUI framework with support of XAML
* [SharpConsoleUI](https://github.com/nickprotop/ConsoleEx) ⭐ 277 | 🐛 1 | 🌐 C# | 📅 2026-09-22 Multi-window TUI framework for **.NET** with overlapping windows, compositor effects, and Spectre.Console integration
...
* [Ratatui](https://github.com/tui-rs-revival/ratatui) ⭐ 22,708 | 🐛 213 | 🌐 Rust | 📅 2026-09-23 A **Rust** crate for building Terminal UIs (actively maintained fork of tui-rs).
...
* [ink](https://github.com/vadimdemedes/ink) ⭐ 39,936 | 🐛 34 | 🌐 TypeScript | 📅 2026-09-21 React for **Node.js** interactive command-line apps
* [gum](https://github.com/charmbracelet/gum) ⭐ 24,410 | 🐛 208 | 🌐 Go | 📅 2026-09-11 A tool for glamorous **shell** scripts
* [OpenTUI](https://github.com/sst/opentui) ⭐ 13,374 | 🐛 152 | 🌐 TypeScript | 📅 2026-09-23 A **TypeScript** library for building terminal user interfaces (TUIs)
* [blessed](https://github.com/chjj/blessed) ⭐ 11,886 | 🐛 255 | 🌐 JavaScript | 📅 2024-03-22 A high-level terminal interface library for **Node.js**
  stateful TUI apps.
...
* [TermDOM](https://github.com/bikeshaving/termdom) ⭐ 311 | 🐛 14 | 🌐 TypeScript | 📅 2026-09-23 A **JavaScript** library that displays HTML and CSS in the terminal, with a real DOM
...
* [Raxol](https://github.com/DROOdotFOO/raxol) ⭐ 78 | 🐛 56 | 🌐 Elixir | 📅 2026-09-23 A multi-surface runtime for **Elixir**: one application renders to the terminal, browser, SSH, and agent surfaces, with per-component crash isolation and hot reload from the BEAM.
...
* [discordo](https://github.com/ayntgl/discordo) ⭐ 5,783 | 🐛 53 | 🌐 Go | 📅 2026-09-22 A lightweight, secure, and feature-rich Discord terminal client
* [Devzat](https://github.com/quackduck/devzat) ⭐ 4,069 | 🐛 25 | 🌐 Go | 📅 2026-07-23 Chat over SSH, written in Golang with self-hosting ability.
* [nomadnet](https://github.com/markqvist/NomadNet) ⭐ 2,546 | 🐛 0 | 🌐 Python | 📅 2026-05-28 Secure messaging network built on Reticulum
* [sclack](https://github.com/haskellcamargo/sclack) ⭐ 2,478 | 🐛 44 | 🌐 Python | 📅 2022-12-08 Slack terminal client
* [instagram-cli](https://github.com/supreme-gg-gg/instagram-cli) ⭐ 2,153 | 🐛 42 | 🌐 TypeScript | 📅 2026-09-03 Use Instagram from your terminal, the end of brainrot is here
* [nchat](https://github.com/d99kris/nchat) ⭐ 1,966 | 🐛 20 | 🌐 C++ | 📅 2026-09-20 Telegram/WhatsApp/Signal client
* [gomuks](https://github.com/tulir/gomuks) ⭐ 1,727 | 🐛 80 | 🌐 Go | 📅 2026-09-23 Matrix client
...
* [basalt](https://github.com/erikjuhani/basalt) ⭐ 1,358 | 🐛 39 | 🌐 Rust | 📅 2026-09-23 TUI Application to manage Obsidian vaults and notes directly from the terminal.
...
* [matcha](https://github.com/floatpane/matcha) ⭐ 1,104 | 🐛 69 | 🌐 Go | 📅 2026-09-21 Email client
...
* [fzf](https://github.com/junegunn/fzf) ⭐ 83,221 | 🐛 330 | 🌐 Go | 📅 2026-09-21 A general-purpose command-line fuzzy finder
* [wttr.in](https://github.com/chubin/wttr.in) ⭐ 30,580 | 🐛 331 | 🌐 Go | 📅 2026-09-07 The right way to check the weather
* [oha](https://github.com/hatoo/oha) ⭐ 10,555 | 🐛 58 | 🌐 Rust | 📅 2026-09-10 HTTP load generator
* [termshark](https://github.com/gcla/termshark) ⭐ 10,019 | 🐛 51 | 🌐 Go | 📅 2024-04-30 Terminal UI for tshark
...
* [dua-cli](https://github.com/byron/dua-cli) ⭐ 6,294 | 🐛 0 | 🌐 Rust | 📅 2026-09-22 View disk space usage and delete unwanted data, fast.
* [gdu](https://github.com/dundee/gdu) ⭐ 6,003 | 🐛 45 | 🌐 Go | 📅 2026-09-23 Fast disk usage analyzer with console interface written in Go
...
* [x-cmd](https://github.com/x-cmd/x-cmd) ⭐ 4,677 | 🐛 108 | 🌐 Awk | 📅 2026-09-16 A vast and interesting collection of tools that can then bootstrap lots of other programs / functions in a consistent and structured way.
* [csvlens](https://github.com/YS-L/csvlens) ⭐ 3,983 | 🐛 59 | 🌐 Rust | 📅 2026-07-04 TUI CSV file viewer. It is like less but made for CSV.
...
* [bluetui](https://github.com/pythops/bluetui) ⭐ 3,015 | 🐛 18 | 🌐 Rust | 📅 2026-08-28 A TUI for managing bluetooth devices.
* [gif-for-cli](https://github.com/google/gif-for-cli) ⚠️ Archived Convert a gif into ASCII
* [impala](https://github.com/pythops/impala) ⭐ 2,862 | 🐛 0 | 🌐 Rust | 📅 2026-09-19 TUI for managing wifi
* [tweakcc](https://github.com/Piebald-AI/tweakcc) ⭐ 2,522 | 🐛 60 | 🌐 TypeScript | 📅 2026-09-23 TUI to customize your Claude Code themes, thinking verbs, and more.
* [Caligula](https://github.com/ifd3f/caligula) ⭐ 2,346 | 🐛 54 | 🌐 Rust | 📅 2026-09-17 A user-friendly, lightweight TUI for imaging disks.
...
* [linecast](https://github.com/ashuttl/linecast) ⭐ 520 | 🐛 19 | 🌐 Python | 📅 2026-09-23 Interactive weather, radar, tides, sun and moon views, a planetarium with stars and constellations, and maps with a rotatable globe for the terminal.
...
* [wifitui](https://github.com/shazow/wifitui) ⭐ 333 | 🐛 33 | 🌐 Go | 📅 2026-08-15 Fast featureful friendly wifi terminal UI, supports NetworkManager and iwd over dbus.
...
* [vlc](https://github.com/videolan/vlc) ⭐ 19,746 | 🐛 2 | 🌐 C | 📅 2026-09-23 VLC includes an ncurses interface, `vlc --intf ncurses`
...
* [spotify-player](https://github.com/aome510/spotify-player) ⭐ 7,233 | 🐛 154 | 🌐 Rust | 📅 2026-09-19 A Spotify player in the terminal with full feature parity
* [ncspot](https://github.com/hrkfdn/ncspot) ⭐ 6,783 | 🐛 214 | 🌐 Rust | 📅 2026-09-21 Cross-platform ncurses Spotify client written in Rust
...
* [kew](https://github.com/ravachol/kew) ⭐ 3,102 | 🐛 1 | 🌐 C | 📅 2026-09-23 A terminal music player for Linux
* [timg](https://github.com/hzeller/timg) ⭐ 2,761 | 🐛 36 | 🌐 C++ | 📅 2026-08-05 A terminal image viewer
* [termusic](https://github.com/tramhao/termusic) ⭐ 2,214 | 🐛 49 | 🌐 Rust | 📅 2026-09-22 Music Player TUI written in Rust
* [tdf](https://github.com/itsjunetime/tdf) ⭐ 1,975 | 🐛 42 | 🌐 Rust | 📅 2026-08-16 A tui-based PDF viewer
...
* [spotatui](https://github.com/LargeModGames/spotatui) ⭐ 1,379 | 🐛 33 | 🌐 Rust | 📅 2026-09-23 Spotify client with native streaming, synced lyrics, and real-time audio visualization
...
* [manga-tui](https://github.com/josueBarretogit/manga-tui) ⭐ 934 | 🐛 24 | 🌐 Rust | 📅 2026-07-13 Terminal-based manga reader and downloader with image rendering support
...
* [jellyfin-tui](https://github.com/dhonus/jellyfin-tui) ⭐ 597 | 🐛 19 | 🌐 Rust | 📅 2026-09-20 Jellyfin client
...
* [pipe-viewer](https://github.com/trizen/pipe-viewer) ⭐ 510 | 🐛 44 | 🌐 Perl | 📅 2026-07-18 A lightweight YouTube client for Linux, without requiring an API key.
...
* [waves](https://github.com/llehouerou/waves) ⭐ 174 | 🐛 2 | 🌐 Go | 📅 2026-09-23 Terminal music player with vim-style navigation and radio mode that plays similar artists from your library
...
* [mpvc](https://github.com/gmt4/mpvc) ⭐ 159 | 🐛 1 | 🌐 Shell | 📅 2026-09-23 A mpc-like control interface for mpv
...
* [tmux](https://github.com/tmux/tmux) ⭐ 49,447 | 🐛 41 | 🌐 C | 📅 2026-09-23 Terminal multiplexer
* [zellij](https://github.com/zellij-org/zellij) ⭐ 35,516 | 🐛 1,941 | 🌐 Rust | 📅 2026-09-23 A terminal workspace with batteries included
* [Glow](https://github.com/charmbracelet/glow) ⭐ 27,440 | 🐛 235 | 🌐 Go | 📅 2026-09-22 A markdown reader, designed from the ground up to showcase the elegance and capabilities of TUI.
...
* [Visidata](https://github.com/saulpw/visidata) ⭐ 9,293 | 🐛 88 | 🌐 Python | 📅 2026-09-23 A terminal spreadsheet multitool for discovering and arranging data
* [presenterm](https://github.com/mfontanini/presenterm) ⭐ 8,868 | 🐛 78 | 🌐 Rust | 📅 2026-05-22 A markdown terminal slideshow tool
...
* [television](https://github.com/alexpasmantier/television) ⭐ 6,288 | 🐛 79 | 🌐 Rust | 📅 2026-09-23 A fast and versatile fuzzy finder TUI
* [sc-im](https://github.com/andmarti1424/sc-im) ⭐ 5,696 | 🐛 117 | 🌐 C | 📅 2026-08-26 An ncurses spreadsheet program for terminal. Reignited version of sc
* [hledger-ui](https://github.com/simonmichael/hledger) ⭐ 4,728 | 🐛 326 | 🌐 Haskell | 📅 2026-09-23 A fast TUI for browsing double entry bookkeeping data
...
* [doxx](https://github.com/bgreenwell/doxx) ⭐ 3,758 | 🐛 9 | 🌐 Rust | 📅 2026-08-10 A TUI document viewer for Microsoft Word files
* [TUIOS](https://github.com/Gaurav-Gosain/tuios) ⭐ 3,711 | 🐛 20 | 🌐 Go | 📅 2026-09-23 A TUI window manager for managing multiple terminal sessions
* [Tabiew](https://github.com/shshemi/tabiew) ⭐ 3,117 | 🐛 17 | 🌐 Rust | 📅 2026-09-23 A lightweight app to view and query tabular data files, such as CSV, TSV, and parquet.
...
* [khal](https://github.com/pimutils/khal) ⭐ 3,053 | 🐛 263 | 🌐 Python | 📅 2026-09-23 A standards based CLI calendar program, able to synchronize with CalDAV servers
* [Bagels](https://github.com/EnhancedJax/Bagels) ⭐ 2,907 | 🐛 17 | 🌐 Python | 📅 2025-07-06 TUI expense tracker
...
* [calcure](https://github.com/anufrievroman/calcure) ⭐ 2,360 | 🐛 7 | 🌐 Python | 📅 2026-08-29 Modern TUI calendar and task manager with minimal and customizable UI.
...
* [sshm](https://github.com/gu1llaum-3/sshm) ⭐ 1,395 | 🐛 34 | 🌐 Go | 📅 2026-07-27 SSH made easy and fast: browse, connect, and control from your terminal with a modern TUI
...
* [clipse](https://github.com/savedra1/clipse) ⭐ 1,045 | 🐛 47 | 🌐 Go | 📅 2026-06-09 TUI-based clipboard manager application
* [longbridge-terminal](https://github.com/longbridge/longbridge-terminal) ⭐ 1,005 | 🐛 12 | 🌐 Rust | 📅 2026-09-20 AI-native TUI for Longbridge Securities: real-time quotes, portfolio management, and trading for HK/US/A-share/SG markets.
* [dvtm](https://github.com/martanne/dvtm) ⭐ 965 | 🐛 77 | 🌐 C | 📅 2024-05-18 A terminal multiplexer with dwm like window management
* [agent-deck](https://github.com/asheshgoplani/agent-deck) ⭐ 943 | 🐛 30 | 🌐 Go | 📅 2026-09-21 Terminal dashboard for managing multiple AI coding agent sessions
...
* [todoman](https://github.com/pimutils/todoman) ⭐ 596 | 🐛 113 | 🌐 Python | 📅 2026-05-25 A simple, standards-based (ics, DAV), cli task-manager
...
* [Tock](https://github.com/kriuchkov/tock) ⭐ 483 | 🐛 5 | 🌐 Go | 📅 2026-08-26 The powerful time tracking tool for the command line with a beautiful interactive TUI.
...
* [hygg](https://github.com/kruserr/hygg) ⭐ 357 | 🐛 14 | 🌐 Rust | 📅 2026-09-18 📚 Simplifying the way you read. Minimalistic Vim-like TUI document reader.
...
* [budget-tracker-tui](https://github.com/Feromond/budget-tracker-tui) ⭐ 336 | 🐛 8 | 🌐 Rust | 📅 2026-09-16 A TUI budget tracker app designed to track income, expenses, investments, budget goals and visualize / gather insights.
...
* [numr](https://github.com/nasedkinpv/numr) ⭐ 289 | 🐛 4 | 🌐 Rust | 📅 2026-07-14 A natural language calculator with unit/currency conversions and vim-style keybindings
...
* [tiki](https://github.com/boolean-maybe/tiki) ⭐ 212 | 🐛 10 | 🌐 Go | 📅 2026-08-12 Markdown-based git-versioned project and issue manager
...
* [kanban](https://github.com/fulsomenko/kanban) ⭐ 169 | 🐛 12 | 🌐 Rust | 📅 2026-09-23 TUI kanban board for projects management with sprint tracking and task prioritization.
...
* [fuzz.fish](https://github.com/jedipunkz/fuzz.fish) ⭐ 2 | 🐛 0 | 🌐 Go | 📅 2026-09-23 A fuzzy finder for the Fish shell with preview panes for command history, files, git branches, worktrees, and commits
...
* [astroterm](https://github.com/da-luce/astroterm) ⭐ 2,050 | 🐛 36 | 🌐 C | 📅 2026-09-11 A planetarium for your terminal! Explore stars, planets, constellations, and more
...
* [carbonyl](https://github.com/fathyb/carbonyl) ⭐ 19,498 | 🐛 90 | 🌐 Rust | 📅 2024-07-01 Chromium running inside your terminal
* [browsh](https://github.com/browsh-org/browsh) ⭐ 19,060 | 🐛 241 | 🌐 JavaScript | 📅 2025-07-11 A fully-modern text-based browser, rendering to TTY and browsers
* [rtorrent](https://github.com/rakshasa/rtorrent) ⭐ 4,864 | 🐛 389 | 🌐 C++ | 📅 2026-09-23 A text-based BitTorrent client written in C++
...
* [newsboat](https://github.com/newsboat/newsboat) ⭐ 3,913 | 🐛 417 | 🌐 C++ | 📅 2026-09-20 An RSS/Atom feed reader for the text console
* [surge](https://github.com/surge-downloader/surge) ⭐ 3,540 | 🐛 56 | 🌐 Go | 📅 2026-09-23 A blazing fast, beautiful TUI download manager built in Go.
...
* [eilmeldung](https://github.com/christo-auer/eilmeldung) ⭐ 1,011 | 🐛 2 | 🌐 Rust | 📅 2026-09-23 RSS reader, supporting many RSS providers, bulk-operations and configuration options.

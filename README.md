...
There's a lot of cool projects here that I have no association with. Run them at your own risk. If you have a cool tool you'd like to share please [open a PR](https://github.com/rothgar/awesome-tuis/pulls) ⭐ 20,701 | 🐛 45 | 📅 2026-09-22.
...
* [btop++](https://github.com/aristocratos/btop) ⭐ 34,711 | 🐛 545 | 🌐 C++ | 📅 2026-09-19 Resource monitor with extras
* [Glances](https://github.com/nicolargo/glances) ⭐ 33,651 | 🐛 106 | 🌐 Python | 📅 2026-09-22 Glances an Eye on your system. A top/htop alternative.
* [Goaccess](https://github.com/allinurl/goaccess) ⭐ 20,943 | 🐛 449 | 🌐 C | 📅 2026-09-19 GoAccess is a real-time web log analyzer and interactive viewer that runs in a terminal in nix systems or through your browser.
* [WTF](https://github.com/senorprogrammer/wtf) ⭐ 17,100 | 🐛 108 | 🌐 Go | 📅 2026-09-17 The personal information dashboard for your terminal.
* [bottom](https://github.com/ClementTsang/bottom) ⭐ 14,042 | 🐛 104 | 🌐 Rust | 📅 2026-09-22 A customizable graphical process/system monitor for the terminal.
* [TermUI](https://github.com/gizak/termui) ⭐ 13,587 | 🐛 106 | 🌐 Go | 📅 2025-07-10 Golang terminal dashboard
* [gping](https://github.com/orf/gping) ⭐ 12,689 | 🐛 42 | 🌐 Rust | 📅 2026-09-22 Ping, but with a graph
* [gh-dash](https://github.com/dlvhdr/gh-dash) ⭐ 12,542 | 🐛 101 | 🌐 Go | 📅 2026-09-22 A rich terminal UI for GitHub PRs and Issues
* [bandwhich](https://github.com/imsnif/bandwhich) ⭐ 11,983 | 🐛 54 | 🌐 Rust | 📅 2026-08-01 Terminal bandwidth utilization tool
* [talos linux](https://github.com/siderolabs/talos) ⭐ 11,219 | 🐛 258 | 🌐 Go | 📅 2026-09-22 A Linux distro with a TUI dashboard for local and remote usage
* [bashtop](https://github.com/aristocratos/bashtop) ⭐ 11,117 | 🐛 64 | 🌐 Shell | 📅 2023-08-21 Resource manager written in bash
* [nvtop](https://github.com/Syllo/nvtop) ⭐ 11,022 | 🐛 134 | 🌐 C | 📅 2026-09-20 GPUs process monitoring for AMD, Intel and NVIDIA
...
* [htop](https://github.com/htop-dev/htop) ⭐ 8,340 | 🐛 355 | 🌐 C | 📅 2026-09-22 Interactive text-mode process viewer for Unix systems. It aims to be a better 'top'
* [csysdig](https://github.com/draios/sysdig) ⭐ 8,296 | 🐛 116 | 🌐 C++ | 📅 2026-04-13 root level Ncurses interface for sysdig, Linux system exploration and troubleshooting tool with first class support for containers
...
* [Backlog.md](https://github.com/MrLesk/Backlog.md) ⭐ 6,813 | 🐛 70 | 🌐 TypeScript | 📅 2026-09-18 A tool for managing project collaboration between humans and AI Agents in a git ecosystem
* [ticker](https://github.com/achannarasappa/ticker) ⭐ 6,237 | 🐛 34 | 🌐 Go | 📅 2026-06-28 Track stocks, crypto, and derivatives prices and positions in real time from your terminal
...
* [rustnet](https://github.com/domcyrus/rustnet) ⭐ 5,048 | 🐛 29 | 🌐 Rust | 📅 2026-09-21 A cross-platform network monitoring tool with deep packet inspection
* [binsider](https://github.com/orhun/binsider) ⭐ 4,436 | 🐛 38 | 🌐 Rust | 📅 2026-09-20 A TUI for analyzing Linux binaries.
...
* [psmux](https://github.com/marlocarlo/psmux) ⭐ 3,535 | 🐛 41 | 🌐 PowerShell | 📅 2026-09-22 tmux-compatible terminal multiplexer for Windows built in Rust with ratatui.
...
* [gonzo](https://github.com/control-theory/gonzo) ⭐ 2,769 | 🐛 18 | 🌐 Go | 📅 2026-09-11 A powerful, real-time log analysis terminal UI inspired by k9s.
...
* [CoreFreq](https://github.com/cyring/CoreFreq) ⭐ 2,244 | 🐛 2 | 🌐 C | 📅 2026-08-16 CPU monitoring software designed for the 64-bits Processors
...
* [netscanner](https://github.com/Chleba/netscanner) ⭐ 1,857 | 🐛 6 | 🌐 Rust | 📅 2026-07-06 Network scanner
...
* [otel-tui](https://github.com/ymtdzzz/otel-tui) ⭐ 1,088 | 🐛 27 | 🌐 Go | 📅 2026-09-21 A terminal OpenTelemetry viewer
...
* [psnet](https://github.com/marlocarlo/psnet) ⭐ 148 | 🐛 4 | 🌐 Rust | 📅 2026-08-10 Real-time TUI network monitor for Windows with speed graphs, DNS resolution, and packet inspection.
...
* [ServerHub](https://github.com/nickprotop/ServerHub) ⭐ 45 | 🐛 0 | 🌐 C# | 📅 2026-07-18 A TUI server monitoring dashboard for Linux with real-time metrics, scriptable widgets, and remote management
* [trek](https://github.com/franckverrot/trek) ⭐ 32 | 🐛 1 | 🌐 Go | 📅 2023-08-30 ncurses explorer for Hashicorp Nomad clusters
* [Servonaut](https://github.com/zb-ss/servonaut) ⭐ 28 | 🐛 1 | 🌐 Python | 📅 2026-09-22 A TUI for managing AWS, Hetzner, OVH and custom SSH servers with log viewing, CloudWatch/CloudTrail browsing, IP banning, AI log analysis and a built-in MCP server
...
* [toptop](https://github.com/ur-grue/toptop) ⭐ 14 | 🐛 4 | 🌐 Rust | 📅 2026-09-21 htop/btop-class system monitor with a local-LLM view: tokens/sec, VRAM-spill and memory-bandwidth verdicts, NVIDIA + Apple Silicon
...
* [opencode](https://github.com/sst/opencode) ⭐ 209,402 | 🐛 6,127 | 🌐 TypeScript | 📅 2026-09-22 AI coding agent, built for the terminal
* [codex](https://github.com/openai/codex) ⭐ 125,960 | 🐛 18,292 | 🌐 Rust | 📅 2026-09-22 Lightweight coding agent that runs in your terminal
* [lazygit](https://github.com/jesseduffield/lazygit) ⭐ 82,581 | 🐛 1,051 | 🌐 Go | 📅 2026-09-22 Simple terminal UI for git commands
* [delta](https://github.com/dandavison/delta) ⭐ 32,305 | 🐛 447 | 🌐 Rust | 📅 2026-09-19 A syntax-highlighting pager for git, diff, and grep output
* [crush](https://github.com/charmbracelet/crush) ⭐ 28,248 | 🐛 778 | 🌐 Go | 📅 2026-09-22 The glamourous AI coding agent
* [gitui](https://github.com/extrawurst/gitui) ⭐ 22,514 | 🐛 347 | 🌐 Rust | 📅 2026-08-04 blazing fast terminal-ui for git written in rust
...
* [posting](https://github.com/darrenburns/posting) ⭐ 12,439 | 🐛 87 | 🌐 Python | 📅 2026-03-25 A powerful HTTP client that lives in your terminal
* [Claude Code Usage Monitor](https://github.com/Maciek-roboblog/Claude-Code-Usage-Monitor) ⭐ 8,716 | 🐛 38 | 🌐 Python | 📅 2026-07-05 Monitor Claude token usage
...
* [soft-serve](https://github.com/charmbracelet/soft-serve) ⭐ 7,226 | 🐛 82 | 🌐 Go | 📅 2026-09-01 A tasty, self-hostable Git server for the command lineicecream
* [harlequin](https://github.com/tconbeer/harlequin) ⭐ 6,412 | 🐛 32 | 🌐 Python | 📅 2026-09-21 The SQL IDE for Your Terminal
* [rainfrog](https://github.com/achristmascarl/rainfrog) ⭐ 5,344 | 🐛 14 | 🌐 Rust | 📅 2026-09-17 A database management TUI for Postgres, MySQL, and SQLite written in Rust
* [sqlit](https://github.com/Maxteabag/sqlit) ⭐ 4,848 | 🐛 17 | 🌐 Python | 📅 2026-09-10 A lightweight TUI for SQL databases inspired by lazygit
...
* [Claude Code Bridge](https://github.com/bfly123/claude_code_bridge) ⭐ 3,520 | 🐛 101 | 🌐 Python | 📅 2026-09-21 Real-time multi-AI collaboration between Claude, Codex and Gemini in terminal
* [Toad](https://github.com/batrachianai/toad) ⭐ 3,443 | 🐛 7 | 🌐 Python | 📅 2026-05-26 A unified interface for AI
* [pudb](https://github.com/inducer/pudb) ⭐ 3,245 | 🐛 164 | 🌐 Python | 📅 2026-09-20 A console-based visual debugger for Python
* [dblab](https://github.com/danvergara/dblab) ⭐ 3,235 | 🐛 12 | 🌐 Go | 📅 2026-09-09 The database client every command line junkie deserves
* [jqp](https://github.com/noahgorstein/jqp) ⭐ 2,844 | 🐛 24 | 🌐 Go | 📅 2026-02-06 A TUI playground to experiment with jq
* [euporie](https://github.com/joouha/euporie) ⭐ 2,657 | 🐛 15 | 🌐 Python | 📅 2026-09-18 Jupyter notebooks in the terminal
...
* [serie](https://github.com/lusingander/serie) ⭐ 2,113 | 🐛 25 | 🌐 Rust | 📅 2026-09-22 A rich git commit graph
* [resterm](https://github.com/unkn0wn-root/resterm) ⭐ 1,942 | 🐛 0 | 🌐 Go | 📅 2026-09-21 A terminal client for HTTP/GraphQL/gRPC with support for WebSockets, SSE, workflows, profiling, OpenAPI and response diffs.
...
* [snips.sh](https://github.com/robherley/snips.sh) ⭐ 1,307 | 🐛 13 | 🌐 Go | 📅 2026-09-08 ✂️ passwordless, anonymous SSH-powered pastebin with a human-friendly TUI and web UI
* [terraform-tui](https://github.com/idoavrah/terraform-tui) ⭐ 1,293 | 🐛 4 | 🌐 Python | 📅 2026-09-07 view and interact with Terraform state
* [proxelar](https://github.com/emanuele-em/proxelar) ⭐ 1,072 | 🐛 0 | 🌐 Rust | 📅 2026-09-22 Scriptable MITM proxy TUI to inspect, intercept, replay, and rewrite HTTP(S) and WebSocket traffic
...
* [VT Code](https://github.com/vinhnx/vtcode) ⭐ 853 | 🐛 1 | 🌐 Rust | 📅 2026-09-22 VT Code - Semantic Coding Agent
...
* [hcom](https://github.com/aannoo/hcom) ⭐ 512 | 🐛 36 | 🌐 Rust | 📅 2026-09-13 CLI and TUI for real-time messaging, observation, and orchestration between AI coding agents (Claude Code, Antigravity, Codex, OpenCode, Kilo, Cursor) across terminals
* [models](https://github.com/arimxyer/models) ⭐ 510 | 🐛 0 | 🌐 Rust | 📅 2026-09-22 TUI for browsing AI models and coding agents
* [Froggit](https://github.com/thewizardshell/froggit) ⭐ 484 | 🐛 3 | 🌐 Go | 📅 2026-03-20 Minimalist Git TUI with GitHub CLI integration
* [Feluda](https://github.com/anistark/feluda) ⭐ 472 | 🐛 14 | 🌐 Rust | 📅 2026-09-21 Detect restrictive and incompatible licesenses in all dependencies of your project.
...
* [git-scope](https://github.com/Bharath-code/git-scope) ⭐ 121 | 🐛 6 | 🌐 Go | 📅 2026-09-04 Terminal UI dashboard for inspecting multiple local Git repositories.
* [Quorum](https://github.com/Detrol/quorum-cli) ⭐ 117 | 🐛 1 | 🌐 Python | 📅 2026-01-01 Multi-agent AI discussion system for structured debates between LLMs
...
* [y509](https://github.com/kanywst/y509) ⭐ 32 | 🐛 1 | 🌐 Go | 📅 2026-09-21 Inspect X.509 certificate chains, catching the missing intermediates that break curl but not browsers
* [violet](https://github.com/braheezy/violet) ⭐ 31 | 🐛 4 | 🌐 Go | 📅 2026-02-16 Colorful TUI frontend to run Vagrant commands
* [DevProjex](https://github.com/Avazbek22/DevProjex) ⭐ 24 | 🐛 13 | 🌐 C# | 📅 2026-09-22 A cross-platform TUI for exploring project trees, selecting files, previewing AI-ready context, and exporting structured codebase snapshots.
...
* [dbterm](https://github.com/shreyam1008/dbterm) ⭐ 13 | 🐛 0 | 🌐 Go | 📅 2026-09-22 Terminal database workbench for PostgreSQL, MySQL, SQLite, Turso, and Cloudflare D1
...
* [lazydocker](https://github.com/jesseduffield/lazydocker) ⭐ 52,916 | 🐛 301 | 🌐 Go | 📅 2026-04-19 The lazier way to manage everything docker
* [k9s](https://github.com/derailed/k9s) ⭐ 34,649 | 🐛 81 | 🌐 Go | 📅 2026-09-22 TUI for managing a Kubernetes cluster
...
* [kdash](https://github.com/kdash-rs/kdash) ⭐ 2,540 | 🐛 3 | 🌐 Rust | 📅 2026-09-21 A simple and fast dashboard for Kubernetes
...
* [Podman-tui](https://github.com/containers/podman-tui) ⭐ 1,236 | 🐛 13 | 🌐 Go | 📅 2026-09-18 TUI for Podman containers
...
* [lazytrivy](https://github.com/owenrumney/lazytrivy) ⭐ 329 | 🐛 9 | 🌐 Go | 📅 2026-09-22 The lazier way to scan images, k8s and the filesytem with Trivy
...
* [micro](https://github.com/zyedidia/micro) ⭐ 29,622 | 🐛 912 | 🌐 Go | 📅 2026-09-22 A modern and intuitive terminal-based text editor
* [Edit](https://github.com/microsoft/edit) ⭐ 14,603 | 🐛 167 | 🌐 Rust | 📅 2026-09-21 A simple text editor. Pays homage to the classic MS-DOS Editor.
* [kilo](https://github.com/antirez/kilo) ⭐ 9,138 | 🐛 64 | 🌐 C | 📅 2025-01-04 A minimal but complete editor in \~1000 lines of C code.
* [Fresh](https://github.com/sinelaw/fresh) ⭐ 8,997 | 🐛 370 | 🌐 Rust | 📅 2026-09-22 An easy-to-use, powerful and fast terminal-based text editor.
...
* [frogmouth](https://github.com/Textualize/frogmouth) ⭐ 3,294 | 🐛 46 | 🌐 Python | 📅 2024-08-01 A Markdown browser for your terminal
* [flow-control](https://github.com/neurocyte/flow) ⭐ 2,419 | 🐛 79 | 🌐 Zig | 📅 2026-09-22 A lightning-fast, feature-rich text editor written in Zig
* [Durdraw](https://github.com/cmang/durdraw) ⭐ 1,822 | 🐛 8 | 🌐 Python | 📅 2026-09-22 An ASCII, Unicode and ANSI art editor
* [zee](https://github.com/zee-editor/zee) ⭐ 1,805 | 🐛 44 | 🌐 Rust | 📅 2025-02-06 A modern text editor for the terminal written in Rust
* [orbiton](https://github.com/xyproto/orbiton) ⭐ 703 | 🐛 0 | 🌐 Go | 📅 2026-09-22 Text editor limited by VT100, suitable for programming, writing git commit messages and editing Markdown
...
* [lazyide](https://github.com/TysonLabs/lazyide) ⭐ 92 | 🐛 3 | 🌐 Rust | 📅 2026-09-18 A lightweight terminal IDE in Rust: file tree, tabs, split panes, LSP, git diff view, minimap, 32 themes
...
* [yazi](https://github.com/sxyazi/yazi) ⭐ 42,362 | 🐛 62 | 🌐 Rust | 📅 2026-09-21 Blazing fast terminal file manager written in Rust, based on async I/O.
* [superfile](https://github.com/MHNightCat/superfile) ⭐ 23,349 | 🐛 270 | 🌐 Go | 📅 2026-09-18 Pretty fancy and modern terminal file manager.
* [nnn](https://github.com/jarun/nnn) ⭐ 21,993 | 🐛 1 | 🌐 C | 📅 2026-09-21 n³ The unorthodox terminal file manager.
* [ranger](https://github.com/ranger/ranger) ⭐ 17,409 | 🐛 897 | 🌐 Python | 📅 2026-09-09 A VIM-inspired file manager for the console.
* [broot](https://github.com/Canop/broot) ⭐ 12,956 | 🐛 100 | 🌐 Rust | 📅 2026-09-20 A new way to see and navigate directory trees
* [lf](https://github.com/gokcehan/lf) ⭐ 9,520 | 🐛 85 | 🌐 Go | 📅 2026-09-15 A terminal file manager written in Go with heavy inspiration from ranger file manager.
* [Vifm](https://github.com/vifm/vifm) ⭐ 3,273 | 🐛 146 | 🌐 C | 📅 2026-09-07 A TUI file manager with vi-keybindings and other vim like behaviour.
* [far2l](https://github.com/elfmz/far2l) ⭐ 2,218 | 🐛 482 | 🌐 C++ | 📅 2026-09-08 Linux port of Far v2 file manager
* [mc](https://github.com/MidnightCommander/mc) ⭐ 986 | 🐛 695 | 🌐 C | 📅 2026-09-16 GNU Midnight Commander. A free cross-platform orthodox file manager.
...
* [rovr](https://github.com/NSPC911/rovr) ⭐ 411 | 🐛 7 | 🌐 Python | 📅 2026-09-22 A post-modern terminal file manager.
...
* [NetHack](https://github.com/NetHack/NetHack) ⭐ 3,918 | 🐛 150 | 🌐 C | 📅 2026-09-22 Dungeon exploration game
...
* [BrogueCE](https://github.com/tmewett/BrogueCE) ⭐ 1,471 | 🐛 200 | 🌐 C | 📅 2026-09-20 Beautiful roguelike dungeon crawler
* [chess-tui](https://github.com/thomas-mauran/chess-tui) ⭐ 1,183 | 🐛 34 | 🌐 Rust | 📅 2026-09-17 Play Chess in your terminal, built in rust
...
* [LeTrain](https://github.com/antoniovazquezaraujo/LeTrain) ⭐ 19 | 🐛 34 | 🌐 Java | 📅 2026-09-22 - Open-source procedural train simulator using Java 17, LibGDX and Lanterna.
...
* [Rich](https://github.com/willmcgugan/rich) ⭐ 57,416 | 🐛 379 | 🌐 Python | 📅 2026-06-23 is a **Python** library for rich text and beautiful formatting in the terminal.
* [textual](https://github.com/willmcgugan/textual) ⭐ 37,308 | 🐛 359 | 🌐 Python | 📅 2026-07-11 is a TUI (Text User Interface) framework for **Python** inspired by modern web development.
* [Python Prompt Toolkit](https://github.com/prompt-toolkit/python-prompt-toolkit) ⭐ 10,581 | 🐛 722 | 🌐 Python | 📅 2026-07-26 Library for building powerful interactive command line applications in **Python**
* [notcurses](https://github.com/dankamongmen/notcurses) ⭐ 4,711 | 🐛 329 | 🌐 C | 📅 2026-05-18 blingful character graphics/TUI library for **C** and **Python**. definitely not curses.
* [urwid](https://github.com/urwid/urwid) ⭐ 3,020 | 🐛 119 | 🌐 Python | 📅 2026-09-21 A console user interface library for **Python** on Linux, OSX, Cygwin or other unix-like OS.
...
* [blessed](https://github.com/jquast/blessed) ⭐ 1,505 | 🐛 1 | 🌐 Python | 📅 2026-09-14 Blessed is an easy, practical library for making **Python** terminal apps
...
* [pyTermTk](https://github.com/ceccopierangiolieugenio/pyTermTk) ⭐ 918 | 🐛 56 | 🌐 Python | 📅 2026-09-22 self-contained TUI library for **Python** with a QT-like API semantics
...
* [bubbletea](https://github.com/charmbracelet/bubbletea) ⭐ 45,084 | 🐛 230 | 🌐 Go | 📅 2026-09-22 A **Go** framework based on Elm to build functional and fun terminal apps
* [tview](https://github.com/rivo/tview/) ⭐ 14,108 | 🐛 97 | 🌐 Go | 📅 2026-08-11 Terminal UI library with rich, interactive widgets — written in **Go**
* [gocui](https://github.com/jroimartin/gocui) ⭐ 10,609 | 🐛 59 | 🌐 Go | 📅 2025-05-01 Minimalist **Go** package aimed at creating Console User Interfaces
* [pterm](https://github.com/pterm/pterm/) ⭐ 5,540 | 🐛 86 | 🌐 Go | 📅 2026-07-11 A modern **Go** module to beautify console output. Featuring charts, progressbars, tables, trees, and much more! It's completely configurable and 100% cross-platform compatible.
* [tcell](https://github.com/gdamore/tcell) ⭐ 5,221 | 🐛 10 | 🌐 Go | 📅 2026-09-15 Tcell is an alternate **Go** terminal package, similar in some ways to termbox, but better in others.
...
* [libuv](https://github.com/libuv/libuv) ⭐ 27,186 | 🐛 235 | 🌐 C | 📅 2026-09-21 Cross-platform asynchronous I/O library - written in **C**
...
* [FTXUI](https://github.com/ArthurSonzogni/FTXUI) ⭐ 10,719 | 🐛 54 | 🌐 C++ | 📅 2026-09-20 💻 **C++** Functional Terminal User Interface. ❤️
* [imtui](https://github.com/ggerganov/imtui) ⭐ 3,626 | 🐛 21 | 🌐 C++ | 📅 2025-10-10 An immediate mode text-based user interface **C++** library, supporting 256 ANSI colors and mouse/keyboard input.
...
* [xtd](https://github.com/gammasoft71/xtd) ⭐ 1,164 | 🐛 98 | 🌐 C++ | 📅 2026-09-22 Free open-source modern **C++** framework to create console (CLI), forms (GUI like WinForms) and unit test (xUnit) applications and libraries on Windows, macOS, Linux, iOS, Android, FreeBSD, and Haiku.
...
* [Tui Widgets](https://github.com/tuiwidgets/tuiwidgets) ⭐ 28 | 🐛 4 | 🌐 C++ | 📅 2026-09-15 A high-level widget based toolkit for terminal applications in **C++**
...
* [Lanterna](https://github.com/mabe02/lanterna) ⭐ 2,618 | 🐛 96 | 🌐 Java | 📅 2026-07-07 A **Java** library for creating text-based UIs, very similar to the C library curses but with more functionality.
...
* [casciian](https://github.com/crramirez/casciian) ⭐ 52 | 🐛 4 | 🌐 Java | 📅 2026-09-22 A Text User Interface Library for **Java** based on "Jexer" without the AWT/Swing dependencies, tailored for GraalVM AOT native compilation with a focus on performance over remote connections and maximum terminal compatibility.
...
* [Spectre.Console](https://github.com/spectreconsole/spectre.console) ⭐ 11,634 | 🐛 184 | 🌐 C# | 📅 2026-09-19 A **.NET** library for creating beautiful console applications
* [Terminal.Gui](https://github.com/gui-cs/Terminal.Gui) ⭐ 11,219 | 🐛 46 | 🌐 C# | 📅 2026-09-21 Cross-platform terminal UI toolkit for **.NET**
* [Consolonia](https://github.com/jinek/Consolonia) ⭐ 829 | 🐛 51 | 🌐 C# | 📅 2026-09-13 A **.NET** terminal-based GUI framework with support of XAML
* [SharpConsoleUI](https://github.com/nickprotop/ConsoleEx) ⭐ 276 | 🐛 1 | 🌐 C# | 📅 2026-09-22 Multi-window TUI framework for **.NET** with overlapping windows, compositor effects, and Spectre.Console integration
* [Hex1b](https://github.com/mitchdenny/hex1b) ⭐ 175 | 🐛 123 | 🌐 C# | 📅 2026-09-22 A **.NET** library for building rich, interactive TUIs with a React-inspired declarative API
...
* [Ratatui](https://github.com/tui-rs-revival/ratatui) ⭐ 22,700 | 🐛 213 | 🌐 Rust | 📅 2026-09-21 A **Rust** crate for building Terminal UIs (actively maintained fork of tui-rs).
...
* [iocraft](https://github.com/ccbrown/iocraft) ⭐ 1,544 | 🐛 26 | 🌐 Rust | 📅 2026-09-07 **Rust** crate for beautiful, artisanally crafted TUIs and text-based IO, with a declarative, React-like API inspired by Ink.
...
* [ink](https://github.com/vadimdemedes/ink) ⭐ 39,926 | 🐛 34 | 🌐 TypeScript | 📅 2026-09-21 React for **Node.js** interactive command-line apps
* [gum](https://github.com/charmbracelet/gum) ⭐ 24,409 | 🐛 208 | 🌐 Go | 📅 2026-09-11 A tool for glamorous **shell** scripts
* [OpenTUI](https://github.com/sst/opentui) ⭐ 13,366 | 🐛 154 | 🌐 TypeScript | 📅 2026-09-22 A **TypeScript** library for building terminal user interfaces (TUIs)
...
* [TermDOM](https://github.com/bikeshaving/termdom) ⭐ 310 | 🐛 14 | 🌐 TypeScript | 📅 2026-09-22 A **JavaScript** library that displays HTML and CSS in the terminal, with a real DOM
...
* [Raxol](https://github.com/DROOdotFOO/raxol) ⭐ 78 | 🐛 67 | 🌐 Elixir | 📅 2026-09-22 A multi-surface runtime for **Elixir**: one application renders to the terminal, browser, SSH, and agent surfaces, with per-component crash isolation and hot reload from the BEAM.
...
* [discordo](https://github.com/ayntgl/discordo) ⭐ 5,782 | 🐛 53 | 🌐 Go | 📅 2026-09-22 A lightweight, secure, and feature-rich Discord terminal client
* [Devzat](https://github.com/quackduck/devzat) ⭐ 4,068 | 🐛 25 | 🌐 Go | 📅 2026-07-23 Chat over SSH, written in Golang with self-hosting ability.
* [nomadnet](https://github.com/markqvist/NomadNet) ⭐ 2,541 | 🐛 0 | 🌐 Python | 📅 2026-05-28 Secure messaging network built on Reticulum
* [sclack](https://github.com/haskellcamargo/sclack) ⭐ 2,478 | 🐛 44 | 🌐 Python | 📅 2022-12-08 Slack terminal client
* [instagram-cli](https://github.com/supreme-gg-gg/instagram-cli) ⭐ 2,152 | 🐛 42 | 🌐 TypeScript | 📅 2026-09-03 Use Instagram from your terminal, the end of brainrot is here
* [nchat](https://github.com/d99kris/nchat) ⭐ 1,967 | 🐛 20 | 🌐 C++ | 📅 2026-09-20 Telegram/WhatsApp/Signal client
* [gomuks](https://github.com/tulir/gomuks) ⭐ 1,726 | 🐛 80 | 🌐 Go | 📅 2026-09-22 Matrix client
* [concord](https://github.com/chojs23/concord) ⭐ 1,545 | 🐛 44 | 🌐 Rust | 📅 2026-09-22 A feature-rich TUI client for Discord
* [gurk-rs](https://github.com/boxdot/gurk-rs) ⭐ 1,381 | 🐛 98 | 🌐 Rust | 📅 2026-09-15 Signal Messenger client for terminal
* [basalt](https://github.com/erikjuhani/basalt) ⭐ 1,358 | 🐛 39 | 🌐 Rust | 📅 2026-09-22 TUI Application to manage Obsidian vaults and notes directly from the terminal.
...
* [matcha](https://github.com/floatpane/matcha) ⭐ 1,104 | 🐛 70 | 🌐 Go | 📅 2026-09-21 Email client
...
* [fzf](https://github.com/junegunn/fzf) ⭐ 83,198 | 🐛 330 | 🌐 Go | 📅 2026-09-21 A general-purpose command-line fuzzy finder
* [wttr.in](https://github.com/chubin/wttr.in) ⭐ 30,577 | 🐛 331 | 🌐 Go | 📅 2026-09-07 The right way to check the weather
* [oha](https://github.com/hatoo/oha) ⭐ 10,553 | 🐛 58 | 🌐 Rust | 📅 2026-09-10 HTTP load generator
* [termshark](https://github.com/gcla/termshark) ⭐ 10,018 | 🐛 51 | 🌐 Go | 📅 2024-04-30 Terminal UI for tshark
* [mapscii](https://github.com/rastapasta/mapscii) ⭐ 9,240 | 🐛 52 | 🌐 JavaScript | 📅 2024-11-03 Braille & ASCII world map renderer for your console
...
* [dua-cli](https://github.com/byron/dua-cli) ⭐ 6,291 | 🐛 0 | 🌐 Rust | 📅 2026-09-22 View disk space usage and delete unwanted data, fast.
* [gdu](https://github.com/dundee/gdu) ⭐ 5,998 | 🐛 52 | 🌐 Go | 📅 2026-09-21 Fast disk usage analyzer with console interface written in Go
...
* [x-cmd](https://github.com/x-cmd/x-cmd) ⭐ 4,673 | 🐛 108 | 🌐 Awk | 📅 2026-09-16 A vast and interesting collection of tools that can then bootstrap lots of other programs / functions in a consistent and structured way.
* [csvlens](https://github.com/YS-L/csvlens) ⭐ 3,979 | 🐛 59 | 🌐 Rust | 📅 2026-07-04 TUI CSV file viewer. It is like less but made for CSV.
* [cfdisk](https://github.com/util-linux/util-linux) ⭐ 3,232 | 🐛 434 | 🌐 C | 📅 2026-09-22 TUI partition editor included in util-linux
* [diskonaut](https://github.com/imsnif/diskonaut) ⭐ 3,132 | 🐛 45 | 🌐 Rust | 📅 2024-03-07 Terminal disk space navigator
* [bluetui](https://github.com/pythops/bluetui) ⭐ 3,012 | 🐛 18 | 🌐 Rust | 📅 2026-08-28 A TUI for managing bluetooth devices.
* [gif-for-cli](https://github.com/google/gif-for-cli) ⚠️ Archived Convert a gif into ASCII
* [impala](https://github.com/pythops/impala) ⭐ 2,861 | 🐛 0 | 🌐 Rust | 📅 2026-09-19 TUI for managing wifi
* [tweakcc](https://github.com/Piebald-AI/tweakcc) ⭐ 2,521 | 🐛 61 | 🌐 TypeScript | 📅 2026-09-22 TUI to customize your Claude Code themes, thinking verbs, and more.
* [Caligula](https://github.com/ifd3f/caligula) ⭐ 2,341 | 🐛 54 | 🌐 Rust | 📅 2026-09-17 A user-friendly, lightweight TUI for imaging disks.
* [smassh](https://github.com/kraanzu/smassh) ⭐ 2,051 | 🐛 12 | 🌐 Python | 📅 2026-08-17 A TUI based typing test application inspired by MonkeyType.
...
* [bluetuith](https://github.com/darkhz/bluetuith) ⭐ 1,410 | 🐛 13 | 🌐 Go | 📅 2026-07-01 A TUI-based bluetooth connection manager, which can interact with bluetooth adapters and devices.
...
* [linecast](https://github.com/ashuttl/linecast) ⭐ 518 | 🐛 19 | 🌐 Python | 📅 2026-09-22 Interactive weather, radar, tides, sun and moon views, a planetarium with stars and constellations, and maps with a rotatable globe for the terminal.
...
* [try-rs](https://github.com/tassiovirginio/try-rs/) ⭐ 289 | 🐛 0 | 🌐 Rust | 📅 2026-08-25 A lightning-fast TUI to manage temporary projects. Create, explore, and clone repositories instantly without cluttering your system.
...
* [redu](https://github.com/drdo/redu) ⭐ 155 | 🐛 12 | 🌐 Rust | 📅 2026-09-11 ncdu for your restic repository that manages exclusion lists to prune files from existing repos and skip new ones
...
* [dupster](https://github.com/karimz1/dupster) ⭐ 15 | 🐛 0 | 🌐 Python | 📅 2026-09-17 The lazy way to find duplicates in your Terminal. Easily find duplicates, preview them and delete them.
...
* [vlc](https://github.com/videolan/vlc) ⭐ 19,733 | 🐛 2 | 🌐 C | 📅 2026-09-22 VLC includes an ncurses interface, `vlc --intf ncurses`
...
* [spotify-player](https://github.com/aome510/spotify-player) ⭐ 7,229 | 🐛 154 | 🌐 Rust | 📅 2026-09-19 A Spotify player in the terminal with full feature parity
* [ncspot](https://github.com/hrkfdn/ncspot) ⭐ 6,779 | 🐛 213 | 🌐 Rust | 📅 2026-09-21 Cross-platform ncurses Spotify client written in Rust
...
* [kew](https://github.com/ravachol/kew) ⭐ 3,096 | 🐛 1 | 🌐 C | 📅 2026-09-22 A terminal music player for Linux
* [timg](https://github.com/hzeller/timg) ⭐ 2,760 | 🐛 36 | 🌐 C++ | 📅 2026-08-05 A terminal image viewer
* [termusic](https://github.com/tramhao/termusic) ⭐ 2,214 | 🐛 49 | 🌐 Rust | 📅 2026-09-22 Music Player TUI written in Rust
* [tdf](https://github.com/itsjunetime/tdf) ⭐ 1,973 | 🐛 42 | 🌐 Rust | 📅 2026-08-16 A tui-based PDF viewer
* [tizonia-openmax-il](https://github.com/tizonia/tizonia-openmax-il) ⭐ 1,742 | 🐛 168 | 🌐 C | 📅 2026-09-05 Command-line cloud music player for Linux with support for Spotify, Google Play Music, YouTube, SoundCloud, Dirble, Plex servers and Chromecast devices
* [soundcloud2000](https://github.com/grobie/soundcloud2000) ⚠️ Archived A terminal client for soundcloud
* [spotatui](https://github.com/LargeModGames/spotatui) ⭐ 1,375 | 🐛 35 | 🌐 Rust | 📅 2026-09-22 Spotify client with native streaming, synced lyrics, and real-time audio visualization
* [bookokrat](https://github.com/bugzmanov/bookokrat) ⭐ 1,155 | 🐛 47 | 🌐 Rust | 📅 2026-09-06 Full-featured EPUB books reader with Vim keybindings.
* [textual-paint](https://github.com/1j01/textual-paint) ⭐ 1,121 | 🐛 10 | 🌐 Python | 📅 2026-02-21 MS Paint in your terminal
* [pyradio](https://github.com/coderholic/pyradio) ⭐ 1,096 | 🐛 11 | 🌐 Python | 📅 2026-05-07 TUI web radio player with thousands of stations from around the world
...
* [manga-tui](https://github.com/josueBarretogit/manga-tui) ⭐ 932 | 🐛 24 | 🌐 Rust | 📅 2026-07-13 Terminal-based manga reader and downloader with image rendering support
...
* [xytz](https://github.com/xdagiz/xytz) ⭐ 641 | 🐛 9 | 🌐 Go | 📅 2026-09-07 Beautiful TUI for downloading YouTube videos/playlists/channels.
* [jellyfin-tui](https://github.com/dhonus/jellyfin-tui) ⭐ 595 | 🐛 19 | 🌐 Rust | 📅 2026-09-20 Jellyfin client
* [spotui](https://github.com/ceuk/spotui) ⭐ 577 | 🐛 8 | 🌐 Python | 📅 2023-07-25 Spotify client written in Python
* [fancy-cat](https://github.com/freref/fancy-cat) ⭐ 562 | 🐛 20 | 🌐 Zig | 📅 2026-08-03 A Lightweight terminal-based PDF reader with Vim keybindings
...
* [mpvc](https://github.com/gmt4/mpvc) ⭐ 159 | 🐛 1 | 🌐 Shell | 📅 2026-09-22 A mpc-like control interface for mpv
...
* [Absotui](https://github.com/pdwaldrop/absotui) ⭐ 21 | 🐛 3 | 🌐 Rust | 📅 2026-09-19 A TUI Audiobookshelf client for Linux and macOS, written in Rust
...
* [tmux](https://github.com/tmux/tmux) ⭐ 49,430 | 🐛 41 | 🌐 C | 📅 2026-09-22 Terminal multiplexer
* [zellij](https://github.com/zellij-org/zellij) ⭐ 35,509 | 🐛 1,936 | 🌐 Rust | 📅 2026-09-22 A terminal workspace with batteries included
* [Glow](https://github.com/charmbracelet/glow) ⭐ 27,431 | 🐛 235 | 🌐 Go | 📅 2026-09-22 A markdown reader, designed from the ground up to showcase the elegance and capabilities of TUI.
* [slides](https://github.com/maaslalani/slides) ⭐ 11,665 | 🐛 77 | 🌐 Go | 📅 2026-07-08 A terminal based presentation tool, supporting markdown syntax.
* [Visidata](https://github.com/saulpw/visidata) ⭐ 9,293 | 🐛 90 | 🌐 Python | 📅 2026-09-21 A terminal spreadsheet multitool for discovering and arranging data
* [presenterm](https://github.com/mfontanini/presenterm) ⭐ 8,864 | 🐛 78 | 🌐 Rust | 📅 2026-05-22 A markdown terminal slideshow tool
* [mcfly](https://github.com/cantino/mcfly) ⭐ 7,798 | 🐛 135 | 🌐 Rust | 📅 2026-09-01 Intelligent context-aware search engine for your shell history
* [television](https://github.com/alexpasmantier/television) ⭐ 6,286 | 🐛 80 | 🌐 Rust | 📅 2026-09-22 A fast and versatile fuzzy finder TUI
* [sc-im](https://github.com/andmarti1424/sc-im) ⭐ 5,695 | 🐛 117 | 🌐 C | 📅 2026-08-26 An ncurses spreadsheet program for terminal. Reignited version of sc
* [hledger-ui](https://github.com/simonmichael/hledger) ⭐ 4,723 | 🐛 326 | 🌐 Haskell | 📅 2026-09-22 A fast TUI for browsing double entry bookkeeping data
* [LazySSH](https://github.com/adembc/lazyssh) ⭐ 3,951 | 🐛 66 | 🌐 Go | 📅 2025-10-09 TUI SSH manager to browse, connect, and manage servers from ssh config files.
* [doxx](https://github.com/bgreenwell/doxx) ⭐ 3,758 | 🐛 8 | 🌐 Rust | 📅 2026-08-10 A TUI document viewer for Microsoft Word files
* [TUIOS](https://github.com/Gaurav-Gosain/tuios) ⭐ 3,704 | 🐛 20 | 🌐 Go | 📅 2026-09-22 A TUI window manager for managing multiple terminal sessions
...
* [khal](https://github.com/pimutils/khal) ⭐ 3,052 | 🐛 265 | 🌐 Python | 📅 2026-09-21 A standards based CLI calendar program, able to synchronize with CalDAV servers
...
* [clipse](https://github.com/savedra1/clipse) ⭐ 1,044 | 🐛 47 | 🌐 Go | 📅 2026-06-09 TUI-based clipboard manager application
* [longbridge-terminal](https://github.com/longbridge/longbridge-terminal) ⭐ 1,004 | 🐛 12 | 🌐 Rust | 📅 2026-09-20 AI-native TUI for Longbridge Securities: real-time quotes, portfolio management, and trading for HK/US/A-share/SG markets.
* [dvtm](https://github.com/martanne/dvtm) ⭐ 965 | 🐛 77 | 🌐 C | 📅 2024-05-18 A terminal multiplexer with dwm like window management
* [agent-deck](https://github.com/asheshgoplani/agent-deck) ⭐ 940 | 🐛 21 | 🌐 Go | 📅 2026-09-21 Terminal dashboard for managing multiple AI coding agent sessions
...
* [todoman](https://github.com/pimutils/todoman) ⭐ 595 | 🐛 113 | 🌐 Python | 📅 2026-05-25 A simple, standards-based (ics, DAV), cli task-manager
* [zeit](https://github.com/mrusme/zeit) ⭐ 590 | 🐛 0 | 🌐 Go | 📅 2026-09-09 A command line tool for tracking time spent on activities.
* [pomo](https://github.com/Bahaaio/pomo) ⭐ 514 | 🐛 4 | 🌐 Go | 📅 2026-06-06 A minimal, customizable TUI Pomodoro timer with ASCII art, progress bar, desktop notifications, and productivity statistics.
...
* [hygg](https://github.com/kruserr/hygg) ⭐ 356 | 🐛 14 | 🌐 Rust | 📅 2026-09-18 📚 Simplifying the way you read. Minimalistic Vim-like TUI document reader.
...
* [budget-tracker-tui](https://github.com/Feromond/budget-tracker-tui) ⭐ 335 | 🐛 8 | 🌐 Rust | 📅 2026-09-16 A TUI budget tracker app designed to track income, expenses, investments, budget goals and visualize / gather insights.
...
* [numr](https://github.com/nasedkinpv/numr) ⭐ 270 | 🐛 3 | 🌐 Rust | 📅 2026-07-14 A natural language calculator with unit/currency conversions and vim-style keybindings
...
* [kanban](https://github.com/fulsomenko/kanban) ⭐ 169 | 🐛 13 | 🌐 Rust | 📅 2026-09-22 TUI kanban board for projects management with sprint tracking and task prioritization.
* [helm](https://github.com/0xjuanma/helm) ⭐ 148 | 🐛 1 | 🌐 Go | 📅 2026-09-07 A minimalistic & customizable pomodoro-like timer for your terminal
...
* [ekphos](https://github.com/hanebox/ekphos) ⭐ 7 | 🐛 0 | 🌐 Rust | 📅 2026-09-20 A fast, lightweight, markdown research tool written in rust
...
* [fuzz.fish](https://github.com/jedipunkz/fuzz.fish) ⭐ 2 | 🐛 0 | 🌐 Go | 📅 2026-09-21 A fuzzy finder for the Fish shell with preview panes for command history, files, git branches, worktrees, and commits
...
* [weathr](https://github.com/veirt/weathr) ⭐ 3,058 | 🐛 20 | 🌐 Rust | 📅 2026-08-12 A terminal weather app with ASCII animations for weather visualization
* [astroterm](https://github.com/da-luce/astroterm) ⭐ 2,048 | 🐛 36 | 🌐 C | 📅 2026-09-11 A planetarium for your terminal! Explore stars, planets, constellations, and more
...
* [browsh](https://github.com/browsh-org/browsh) ⭐ 19,057 | 🐛 241 | 🌐 JavaScript | 📅 2025-07-11 A fully-modern text-based browser, rendering to TTY and browsers
* [rtorrent](https://github.com/rakshasa/rtorrent) ⭐ 4,864 | 🐛 391 | 🌐 C++ | 📅 2026-09-22 A text-based BitTorrent client written in C++
...
* [newsboat](https://github.com/newsboat/newsboat) ⭐ 3,911 | 🐛 417 | 🌐 C++ | 📅 2026-09-20 An RSS/Atom feed reader for the text console
* [surge](https://github.com/surge-downloader/surge) ⭐ 3,536 | 🐛 56 | 🌐 Go | 📅 2026-09-22 A blazing fast, beautiful TUI download manager built in Go.
...
* [cloudflare-speed-cli](https://github.com/kavehtehrani/cloudflare-speed-cli) ⭐ 1,043 | 🐛 0 | 🌐 Rust | 📅 2026-07-27 Internet speed test via Cloudflare
* [eilmeldung](https://github.com/christo-auer/eilmeldung) ⭐ 1,011 | 🐛 4 | 🌐 Rust | 📅 2026-09-22 RSS reader, supporting many RSS providers, bulk-operations and configuration options.
* [hackernews-TUI](https://github.com/aome510/hackernews-TUI) ⭐ 720 | 🐛 10 | 🌐 Rust | 📅 2026-03-29 A Terminal UI to browse Hacker News
* [nyaa](https://github.com/Beastwick18/nyaa) ⭐ 700 | 🐛 16 | 🌐 Rust | 📅 2026-02-28 A nyaa.si TUI for browsing and downloading torrents
...
* [podliner](https://github.com/timkicker/podliner) ⭐ 173 | 🐛 1 | 🌐 C# | 📅 2026-09-14 A cross-platform podcast client
